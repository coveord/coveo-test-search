...
var Triggers = /** @class */ (function (_super) {
    ...
    Triggers.prototype.handleProcessNewQueryResults = function (data) {
        ...
        this.executeTriggers(data.results.triggers, 'notify', function (trigger) {
            ...
            _this.element.appendChild(Dom_1.$$('div', { className: 'coveo-trigger-notify' }, underscore_1.escape(trigger.content)).el);
            showElement = true;
        });
...
//# sourceMappingURL=Triggers__9245cffd6a171b3d5439.js.map