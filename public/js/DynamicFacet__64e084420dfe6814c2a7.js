webpackJsonpCoveo__temporary([2,21],{
...
var DynamicFacetManager = /** @class */ (function (_super) {
    ...
    Object.defineProperty(DynamicFacetManager.prototype, "facetsWithDisplayedValues", {
        get: function () {
            return this.childrenFacets.filter(function (facet) { return facet.hasDisplayedValues; });
        },
        enumerable: true,
        configurable: true
    });
    ...
    DynamicFacetManager.prototype.respectMaximumExpandedFacetsThreshold = function () {
        ...
        var _b = underscore_1.partition(collapsableFacets, function (facet) { return facet.hasActiveValues; }), facetsWithActiveValues = _b[0], remainingFacets = _b[1];
        var numberOfFacetsLeftToExpand = this.options.maximumNumberOfExpandedFacets - uncollapsableFacets.length - facetsWithActiveValues.length;
        facetsWithActiveValues.forEach(function (dynamicFacet) { return dynamicFacet.expand(); });
        remainingFacets.forEach(function (dynamicFacet) {
...
//# sourceMappingURL=DynamicFacet__64e084420dfe6814c2a7.js.map