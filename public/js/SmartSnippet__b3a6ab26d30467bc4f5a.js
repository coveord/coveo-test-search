...
var UserFeedbackBanner_1 = __webpack_require__(699);
var AnalyticsActionListMeta_1 = __webpack_require__(9);
var HeightLimiter_1 = __webpack_require__(700);
var ExplanationModal_1 = __webpack_require__(701);
var Strings_1 = __webpack_require__(6);
...
var SmartSnippet = /** @class */ (function (_super) {
    ...
    SmartSnippet.prototype.buildHeightLimiter = function () {
        var _this = this;
        return (this.heightLimiter = new HeightLimiter_1.HeightLimiter(this.shadowContainer, this.snippetContainer, this.options.maximumSnippetHeight, function (isExpanded) { return (isExpanded ? _this.sendExpandSmartSnippetAnalytics() : _this.sendCollapseSmartSnippetAnalytics()); })).toggleButton;
    };
    ...
    SmartSnippet.prototype.buildLink = function (text, className) {
        ...
        new ResultLink_1.ResultLink(element, {}, __assign({}, this.getBindings(), { resultElement: this.element }), this.lastRenderedResult);
        return element;
    };
...
//# sourceMappingURL=SmartSnippet__b3a6ab26d30467bc4f5a.js.map