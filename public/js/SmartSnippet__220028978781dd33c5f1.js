...
var UserFeedbackBanner_1 = __webpack_require__(700);
var AnalyticsActionListMeta_1 = __webpack_require__(10);
var HeightLimiter_1 = __webpack_require__(701);
var ExplanationModal_1 = __webpack_require__(702);
var Strings_1 = __webpack_require__(6);
...
var SmartSnippet = /** @class */ (function (_super) {
    ...
    SmartSnippet.prototype.renderSourceTitle = function () {
        return this.buildLink(Utils_1.Utils.getFieldValue(this.lastRenderedResult, this.options.titleField), SOURCE_TITLE_CLASSNAME);
    };
    SmartSnippet.prototype.renderSourceUrl = function () {
        var uri = this.options.hrefTemplate
            ? Core_1.StringUtils.buildStringTemplateFromResult(this.options.hrefTemplate, this.lastRenderedResult)
            : this.lastRenderedResult.clickUri;
        return this.buildLink(uri, SOURCE_URL_CLASSNAME);
    };
    SmartSnippet.prototype.buildLink = function (text, className) {
        var element = Core_1.$$('a', { className: "CoveoResultLink " + className }).el;
        element.innerText = text;
        new ResultLink_1.ResultLink(element, { hrefTemplate: this.options.hrefTemplate }, __assign({}, this.getBindings(), { resultElement: this.element }), this.lastRenderedResult);
        return element;
    };
...
//# sourceMappingURL=SmartSnippet__220028978781dd33c5f1.js.map