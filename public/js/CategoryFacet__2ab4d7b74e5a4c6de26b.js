...
var CategoryFacetTemplates_1 = __webpack_require__(454);
var CategoryValueRoot_1 = __webpack_require__(455);
var CategoryFacetQueryController_1 = __webpack_require__(457);
...
var CategoryFacetSearch_1 = __webpack_require__(459);
var KeyboardUtils_1 = __webpack_require__(20);
var BreadcrumbEvents_1 = __webpack_require__(35);
var CategoryFacetBreadcrumb_1 = __webpack_require__(461);
var AnalyticsActionListMeta_1 = __webpack_require__(9);
var CategoryFacetDebug_1 = __webpack_require__(462);
...
var CategoryFacet = /** @class */ (function (_super) {
    ...
    CategoryFacet.prototype.handleQuerySuccess = function (args) {
        if (Utils_1.Utils.isNullOrUndefined(args.results.categoryFacets) ||
            Utils_1.Utils.isNullOrUndefined(args.results.categoryFacets[this.positionInQuery])) {
    ...
    CategoryFacet.prototype.addEllipsis = function (parentValue, pathOfLastTruncatedParentValue, valueToAddToPath) {
        this.categoryValueRoot.listRoot.append(this.categoryFacetTemplates.buildEllipsis().el);
        parentValue.path = pathOfLastTruncatedParentValue.concat([valueToAddToPath]);
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var CategoryValue_1 = __webpack_require__(456);
var underscore_1 = __webpack_require__(0);
...
Object.defineProperty(exports, "__esModule", { value: true });
var CategoryValueChildrenRenderer_1 = __webpack_require__(335);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        results = _a.sent();
                        return [2 /*return*/, results.groupByResults[0].values];
                }
            });
        });
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var CategoryFacet_1 = __webpack_require__(141);
var QueryEvents_1 = __webpack_require__(10);
var underscore_1 = __webpack_require__(0);
...
//# sourceMappingURL=CategoryFacet__2ab4d7b74e5a4c6de26b.js.map