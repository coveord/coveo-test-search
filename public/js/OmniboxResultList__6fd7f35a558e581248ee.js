webpackJsonpCoveo__temporary([7,8,20],{
    ...
    ResultList.prototype.showWaitingAnimation = function () {
        switch (this.options.waitAnimation.toLowerCase()) {
            case 'fade':
                ...
                break;
            case 'spinner':
                underscore_1.each(this.options.resultContainer.children, function (child) {
                    Dom_1.$$(child).hide();
                });
...
//# sourceMappingURL=OmniboxResultList__6fd7f35a558e581248ee.js.map