webpackJsonpCoveo__temporary([25,33,81],{
...
var SortCriteria_1 = __webpack_require__(485);
...
var SortDropdown = /** @class */ (function (_super) {
    ...
    SortDropdown.prototype.getSortComponents = function () {
        var _this = this;
        var sortComponents = Dom_1.$$(this.element)
            ...
            .filter(function (sortCmp) { return sortCmp; });
    ...
    SortDropdown.prototype.handleQuerySuccess = function (data) {
        ...
        var _a = underscore_1.partition(this.sortComponents, function (sortComponent) { return sortComponent.disabled; }), hiddenSorts = _a[0], visibleSorts = _a[1];
        hiddenSorts.forEach(function (hiddenSort) { return _this.dropdown.hideValue(hiddenSort.options.sortCriteria.toString()); });
        visibleSorts.forEach(function (visibleSorts) { return _this.dropdown.showValue(visibleSorts.options.sortCriteria.toString()); });
...
//# sourceMappingURL=SortDropdown__7cfa116e647fd00e32fd.js.map