...
exports.authProviderAccessToken = 'coveo-auth-provider-access-token';
/**
...
var AuthenticationProvider = /** @class */ (function (_super) {
    ...
    AuthenticationProvider.prototype.getHandshakeTokenFromUrl = function () {
        ...
        var tokenParam = _.find(params, function (param) {
    ...
    AuthenticationProvider.prototype.exchangeHandshakeToken = function (token) {
    ...
    AuthenticationProvider.prototype.storeAccessToken = function (accessToken) {
        localStorage.setItem(exports.authProviderAccessToken, accessToken);
    };
    AuthenticationProvider.prototype.loadAccessTokenFromStorage = function () {
        var token = localStorage.getItem(exports.authProviderAccessToken);
...
//# sourceMappingURL=AuthenticationProvider__538c2c79e3652667ef21.js.map