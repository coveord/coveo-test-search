webpackJsonpCoveo__temporary([21,37,81],{
...
var SortCriteria_1 = __webpack_require__(488);
...
var Sort = /** @class */ (function (_super) {
    ...
    Sort.prototype.updateAccessibleSelectedState = function () {
        this.element.setAttribute('aria-pressed', this.isSelected().toString());
    };
    Sort.prototype.updateAccessibleLabel = function () {
        this.element.setAttribute('aria-label', this.getAccessibleLabel());
    };
    Sort.prototype.getAccessibleLabel = function () {
        return this.isToggle() ? this.getAccessibleLabelWithSort() : this.getAccessibleLabelWithoutSort();
    };
    Sort.prototype.getAccessibleLabelWithSort = function () {
        var localizedCaption = Strings_1.l(this.displayedSortText);
        if (this.isSelected()) {
            if (this.currentDirection === 'ascending') {
                return Strings_1.l('SortResultsByDescending', localizedCaption);
            }
            else {
                return Strings_1.l('SortResultsByAscending', localizedCaption);
            }
        }
        if (this.currentDirection === 'ascending') {
            return Strings_1.l('SortResultsByAscending', localizedCaption);
    ...
    Sort.prototype.getAccessibleLabelWithoutSort = function () {
        var localizedCaption = Strings_1.l(this.displayedSortText);
...
var Sort_1 = __webpack_require__(189);
...
//# sourceMappingURL=SortDropdown__f94647741462cdadce8f.js.map