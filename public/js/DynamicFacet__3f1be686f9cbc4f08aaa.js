webpackJsonpCoveo__temporary([2,20],{
...
var DynamicFacetManager = /** @class */ (function (_super) {
    ...
    Object.defineProperty(DynamicFacetManager.prototype, "facetsWithDisplayedValues", {
        get: function () {
            return this.childrenFacets.filter(function (facet) { return facet.values.hasDisplayedValues; });
        },
        enumerable: true,
        configurable: true
    });
    ...
    DynamicFacetManager.prototype.isDynamicFacet = function (component) {
        return component instanceof DynamicFacet_1.DynamicFacet;
    };
    Object.defineProperty(DynamicFacetManager.prototype, "allDynamicFacets", {
        get: function () {
            var allFacetsInComponent = ComponentsTypes_1.ComponentsTypes.getAllFacetsInstance(this.element);
    ...
    DynamicFacetManager.prototype.handleAfterComponentsInitialization = function () {
        ...
        this.childrenFacets.forEach(function (dynamicFacet) { return (dynamicFacet.dynamicFacetManager = _this); });
    ...
    DynamicFacetManager.prototype.mapResponseToComponents = function (facetsResponse) {
        ...
        facetsInResponse.forEach(function (facet) { return facet.enable(); });
    ...
    DynamicFacetManager.prototype.reorderDynamicFacetsInDom = function () {
        ...
        this.childrenFacets.forEach(function (dynamicFacet, index) {
    ...
    DynamicFacetManager.prototype.respectMaximumExpandedFacetsThreshold = function () {
        ...
        var _a = underscore_1.partition(this.facetsWithDisplayedValues, function (facet) { return facet.options.enableCollapse; }), collapsableFacets = _a[0], uncollapsableFacets = _a[1];
        var _b = underscore_1.partition(collapsableFacets, function (facet) { return facet.values.hasActiveValues; }), facetsWithActiveValues = _b[0], remainingFacets = _b[1];
        var indexOfFirstFacetToCollapse = this.options.maximumNumberOfExpandedFacets - uncollapsableFacets.length - facetsWithActiveValues.length;
        facetsWithActiveValues.forEach(function (dynamicFacet) { return dynamicFacet.expand(); });
        remainingFacets.forEach(function (dynamicFacet, index) {
    ...
    DynamicFacetManager.prototype.getFacetComponentById = function (id) {
        var facet = underscore_1.find(this.childrenFacets, function (facet) { return facet.options.id === id; });
        if (!facet) {
...
//# sourceMappingURL=DynamicFacet__3f1be686f9cbc4f08aaa.js.map