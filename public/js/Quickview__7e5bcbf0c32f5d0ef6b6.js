...
Object.defineProperty(exports, "__esModule", { value: true });
var QuickviewEvents_1 = __webpack_require__(220);
...
var QuickviewDocumentIframe_1 = __webpack_require__(621);
var QuickviewDocumentHeader_1 = __webpack_require__(622);
var QuickviewDocumentWords_1 = __webpack_require__(623);
var underscore_1 = __webpack_require__(0);
var QuickviewDocumentWordButton_1 = __webpack_require__(626);
var QuickviewDocumentPreviewBar_1 = __webpack_require__(627);
...
var DefaultQuickviewTemplate_1 = __webpack_require__(620);
var QuickviewDocument_1 = __webpack_require__(226);
var AccessibleModal_1 = __webpack_require__(499);
/**
...
var Quickview = /** @class */ (function (_super) {
    ...
    function Quickview(element, options, bindings, result, ModalBox) {
        ...
        _this.modalbox = new AccessibleModal_1.AccessibleModal('coveo-quick-view', element.ownerDocument.body, ModalBox);
        return _this;
    }
    ...
    Quickview.prototype.buildCaption = function () {
        return Dom_1.$$('div', { className: 'coveo-caption-for-icon', tabindex: 0 }, 'Quickview'.toLocaleString()).el;
    };
    ...
    Quickview.prototype.createModalBox = function (openerObject) {
        ...
        return openerObject.content.then(function (builtContent) {
            ...
            _this.modalbox.openResult(_this.result, {
                showDate: _this.options.showDate,
                title: _this.options.title
            }, _this.bindings, computedModalBoxContent.el, function () {
...
var AccessibleModal = /** @class */ (function () {
    ...
    AccessibleModal.prototype.openResult = function (result, options, bindings, content, validation) {
        if (this.isOpen) {
            return;
        }
        this.openModalAndTrap(Core_1.DomUtils.getQuickviewHeader(result, options, bindings).el, content, validation);
        this.makeAccessible(options.title || result.title);
    };
    AccessibleModal.prototype.open = function (title, content, validation) {
        if (this.isOpen) {
            return;
        }
    ...
    AccessibleModal.prototype.openModalAndTrap = function (title, content, validation) {
        var _this = this;
...
var Dom_1 = __webpack_require__(1);
var underscore_1 = __webpack_require__(0);
var QuickviewDocumentWord_1 = __webpack_require__(624);
var QuickviewDocument_1 = __webpack_require__(226);
...
var Dom_1 = __webpack_require__(1);
var QuickviewDocument_1 = __webpack_require__(226);
var QuickviewDocumentWordColor_1 = __webpack_require__(625);
...
//# sourceMappingURL=Quickview__7e5bcbf0c32f5d0ef6b6.js.map