...
var IE8_DOM_DEFINE = __webpack_require__(564);
var toPrimitive = __webpack_require__(565);
...
var shared = __webpack_require__(402)('keys');
...
var XRegExp = __webpack_require__(557);
/**
...
var MissingTerms = /** @class */ (function (_super) {
    ...
    function MissingTerms(element, options, bindings, result) {
        ...
        _this.wordBoundary = '(([\\p{Han}])?([^(\\p{Latin}-)])|^|$)';
    ...
    Object.defineProperty(MissingTerms.prototype, "missingTerms", {
        ...
        get: function () {
            var _this = this;
            return this.result.absentTerms.filter(function (term) {
                var regex = _this.createWordBoundaryDelimitedRegex(term);
                return regex.test(_this.queryStateModel.get('q'));
            });
        },
        enumerable: true,
        configurable: true
    ...
    MissingTerms.prototype.addTermForcedToAppear = function (term) {
        ...
        this.queryStateModel.set('missingTerm', this.termForcedToAppear.slice());
    };
    MissingTerms.prototype.updateTermForcedToAppear = function () {
        this.termForcedToAppear = this.queryStateModel.get('missingTerm').slice();
    };
    ...
    MissingTerms.prototype.buildMissingTerms = function () {
        var _this = this;
        var terms = this.missingTerms.map(function (term) {
            if (_this.containsFeaturedResults(term) || _this.containsWildcard(term)) {
                return;
            }
    ...
    MissingTerms.prototype.executeNewQuery = function (missingTerm) {
        ...
        this.usageAnalytics.logSearchEvent(AnalyticsActionListMeta_1.analyticsActionCauseList.missingTermClick, {
    ...
    MissingTerms.prototype.containsWildcard = function (term) {
        var query = this.queryStateModel.get('q');
        var regxStarWildcard = XRegExp("(\\*" + term + ")|" + term + "\\*");
        var regxQuestionMarkWildcard = XRegExp("(\\?" + term + ")|" + term + "\\?");
        var foundStar = this.queryController.getLastQuery().wildcards && regxStarWildcard.test(query);
        var foundQuestionMark = this.queryController.getLastQuery().questionMark && regxQuestionMarkWildcard.test(query);
    ...
    MissingTerms.options = {
         ...
         */
        caption: ComponentOptions_1.ComponentOptions.buildLocalizedStringOption({ defaultValue: 'Missing' }),
        /**
...
var anObject = __webpack_require__(145);
var dPs = __webpack_require__(566);
var enumBugKeys = __webpack_require__(405);
...
var createDict = function () {
  ...
  var iframe = __webpack_require__(399)('iframe');
  var i = enumBugKeys.length;
  var lt = '<';
  var gt = '>';
  var iframeDocument;
  iframe.style.display = 'none';
  __webpack_require__(573).appendChild(iframe);
...
(module.exports = function (key, value) {
  ...
  mode: __webpack_require__(403) ? 'pure' : 'global',
...
var LIBRARY = __webpack_require__(403);
var $export = __webpack_require__(111);
var redefine = __webpack_require__(586);
var hide = __webpack_require__(112);
var Iterators = __webpack_require__(149);
var $iterCreate = __webpack_require__(587);
var setToStringTag = __webpack_require__(407);
...
var _xregexp = _interopRequireDefault(__webpack_require__(558));

var _build = _interopRequireDefault(__webpack_require__(601));

var _matchrecursive = _interopRequireDefault(__webpack_require__(602));

var _unicodeBase = _interopRequireDefault(__webpack_require__(603));

var _unicodeBlocks = _interopRequireDefault(__webpack_require__(604));

var _unicodeCategories = _interopRequireDefault(__webpack_require__(606));

var _unicodeProperties = _interopRequireDefault(__webpack_require__(608));

var _unicodeScripts = _interopRequireDefault(__webpack_require__(610));
...
var _create = _interopRequireDefault(__webpack_require__(559));

var _slicedToArray2 = _interopRequireDefault(__webpack_require__(574));

var _getIterator2 = _interopRequireDefault(__webpack_require__(198));

var _parseInt2 = _interopRequireDefault(__webpack_require__(596));
...
var $export = __webpack_require__(111);
// 19.1.2.2 / 15.2.3.5 Object.create(O [, Properties])
$export($export.S, 'Object', { create: __webpack_require__(401) });
...
module.exports = !__webpack_require__(146) && !__webpack_require__(193)(function () {
  return Object.defineProperty(__webpack_require__(399)('div'), 'a', { get: function () { return 7; } }).a != 7;
});
...
var dP = __webpack_require__(191);
var anObject = __webpack_require__(145);
var getKeys = __webpack_require__(567);
...
var $keys = __webpack_require__(568);
var enumBugKeys = __webpack_require__(405);
...
// true  -> Array#includes
var toIObject = __webpack_require__(194);
var toLength = __webpack_require__(571);
var toAbsoluteIndex = __webpack_require__(572);
...
var iterableToArrayLimit = __webpack_require__(580);

var nonIterableRest = __webpack_require__(595);
...
var _Array$isArray = __webpack_require__(576);
...
module.exports = __webpack_require__(77).Array.isArray;
...
var _getIterator = __webpack_require__(198);
...
var addToUnscopables = __webpack_require__(584);
var step = __webpack_require__(585);
var Iterators = __webpack_require__(149);
var toIObject = __webpack_require__(194);
...
var create = __webpack_require__(401);
...
var has = __webpack_require__(147);
var toObject = __webpack_require__(589);
var IE_PROTO = __webpack_require__(197)('IE_PROTO');
...
var anObject = __webpack_require__(145);
var get = __webpack_require__(593);
module.exports = __webpack_require__(77).getIterator = function (it) {
  var iterFn = get(it);
...
var classof = __webpack_require__(594);
var ITERATOR = __webpack_require__(93)('iterator');
var Iterators = __webpack_require__(149);
...
module.exports = __webpack_require__(77).parseInt;
...
var $export = __webpack_require__(111);
var $parseInt = __webpack_require__(599);
...
var $trim = __webpack_require__(600).trim;
...
var $export = __webpack_require__(111);
var defined = __webpack_require__(148);
var fails = __webpack_require__(193);
...
var _blocks = _interopRequireDefault(__webpack_require__(605));
...
var _categories = _interopRequireDefault(__webpack_require__(607));
...
var _properties = _interopRequireDefault(__webpack_require__(609));
...
var _scripts = _interopRequireDefault(__webpack_require__(611));
...
//# sourceMappingURL=MissingTerms__81aae50cb303a2414fea.js.map