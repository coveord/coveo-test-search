...
exports.accessTokenStorageKey = 'coveo-auth-provider-access-token';
/**
...
var AuthenticationProvider = /** @class */ (function (_super) {
    ...
    AuthenticationProvider.prototype.getHandshakeTokenFromUrl = function () {
        ...
        var token = HashUtils_1.HashUtils.getValue('handshake_token', hash);
    ...
    AuthenticationProvider.prototype.exchangeHandshakeToken = function (handshakeToken) {
        var accessToken = localStorage.getItem(exports.accessTokenStorageKey);
    ...
    AuthenticationProvider.prototype.storeAccessToken = function (accessToken) {
        localStorage.setItem(exports.accessTokenStorageKey, accessToken);
    };
    AuthenticationProvider.prototype.loadAccessTokenFromStorage = function () {
        var token = localStorage.getItem(exports.accessTokenStorageKey);
...
//# sourceMappingURL=AuthenticationProvider__fd0f3fc3c92d039f107f.js.map