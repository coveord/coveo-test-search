webpackJsonpCoveo__temporary([21,63],{
...
var SmartSnippetCollapsibleSuggestion_1 = __webpack_require__(709);
var Strings_1 = __webpack_require__(6);
var Initialization_1 = __webpack_require__(2);
var Utils_1 = __webpack_require__(4);
var SmartSnippetCommon_1 = __webpack_require__(522);
    ...
    SmartSnippetSuggestions.prototype.buildQuestionAnswers = function (questionAnswers) {
        ...
        var answers = questionAnswers.map(function (questionAnswer) {
            return new SmartSnippetCollapsibleSuggestion_1.SmartSnippetCollapsibleSuggestion(questionAnswer, _this.getBindings(), Utils_1.Utils.isNullOrUndefined(innerCSS)
                ...
                : innerCSS, _this.searchUid, _this.getCorrespondingResult(questionAnswer), _this.options.useIFrame);
        });
...
function attachShadow(element, options) {
    return __awaiter(this, void 0, void 0, function () {
        var autoUpdateContainer, contentBody, iframe_1, onLoad, shadowRootContainer;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!options.useIFrame) return [3 /*break*/, 2];
                    iframe_1 = Dom_1.$$('iframe', { className: 'coveo-shadow-iframe', scrolling: 'no', title: options.title }).el;
                    onLoad = new Promise(function (resolve) { return iframe_1.addEventListener('load', function () { return resolve(); }); });
                    element.appendChild(iframe_1);
                    return [4 /*yield*/, onLoad];
                case 1:
                    _a.sent();
                    contentBody = iframe_1.contentDocument.body;
                    autoUpdateContainer = iframe_1;
                    return [3 /*break*/, 3];
                case 2:
                    autoUpdateContainer = Dom_1.$$('div', { className: 'coveo-shadow-iframe', scrolling: 'no', title: options.title }).el;
...
var AttachShadowPolyfill_1 = __webpack_require__(521);
var Dom_1 = __webpack_require__(1);
var Strings_1 = __webpack_require__(6);
var AnalyticsActionListMeta_1 = __webpack_require__(10);
...
var SmartSnippetCollapsibleSuggestion = /** @class */ (function () {
    function SmartSnippetCollapsibleSuggestion(questionAnswer, bindings, innerCSS, searchUid, source, useIFrame) {
    ...
    SmartSnippetCollapsibleSuggestion.prototype.buildLink = function (text, className) {
        ...
        new ResultLink_1.ResultLink(element, { logAnalytics: function (href) { return _this.sendOpenSourceAnalytics(element, href); } }, __assign({}, this.bindings, { resultElement: this.collapsibleContainer.el }), this.source);
        return element;
    };
    ...
    SmartSnippetCollapsibleSuggestion.prototype.sendOpenSourceAnalytics = function (element, href) {
        return this.bindings.usageAnalytics.logCustomEvent(AnalyticsActionListMeta_1.analyticsActionCauseList.openSmartSnippetSuggestionSource, {
            searchQueryUid: this.searchUid,
            documentTitle: this.source.title,
            author: Utils_1.Utils.getFieldValue(this.source, 'author'),
            documentURL: href,
            documentId: this.questionAnswer.documentId
        }, element);
    };
...
//# sourceMappingURL=SmartSnippetSuggestions__6329ae6e0c7211699615.js.map