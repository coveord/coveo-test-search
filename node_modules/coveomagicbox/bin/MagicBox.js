...
(function (Coveo) {
    ...
    (function (MagicBox) {
        var InputManager = (function () {
            function InputManager(element, onchange) {
        ...
        var SuggestionsManager = (function () {
            function SuggestionsManager(element, options) {
                ...
                this.element.onmouseover = function (e) {
                    if (MagicBox.$$(e.target).hasClass(_this.options.selectableClass)) {
                        var selected = _this.element.getElementsByClassName(_this.options.selectedClass);
                        for (var i = 0; i < selected.length; i++) {
                            var elem = selected.item(i);
                            MagicBox.$$(elem).removeClass(_this.options.selectedClass);
                        }
                        MagicBox.$$(e.target).addClass(_this.options.selectedClass);
                    }
                };
                this.element.onmouseout = function (e) {
                    if (MagicBox.$$(e.target).hasClass(_this.options.selectableClass)) {
                        MagicBox.$$(e.target).removeClass(_this.options.selectedClass);
                    }
                };
            }
...
(function (Coveo) {
    ...
    (function (MagicBox) {
         ...
         */
        MagicBox.$$ = function (el) { return new MagicBox.Utils.Dom(el); };
    })(MagicBox = Coveo.MagicBox || (Coveo.MagicBox = {}));
})(Coveo || (Coveo = {}));
