...
declare module Coveo {
	...
	export class LazyTemplate extends Template {
	    ...
	    private option;
	    private template;
	    constructor(element: HTMLElement, attrName: string, option: IComponentOptionsTemplateOption);
	    instantiateToString(object?: any, checkCondition?: boolean): string;
	    getType(): string;
	}
...
declare module Coveo {
	...
	export class SearchInterface extends RootComponent {
	     ...
	     */
	    isNewDesign(): boolean;
	    isSmallInterface(): boolean;
	    setSmallInterface(): void;
	    unsetSmallInterface(): void;
...
declare module Coveo {
	...
	export class ResponsiveTabs implements IResponsiveComponent {
	    ...
	    static init(root: HTMLElement, ID: string, component: any): void;
...
declare module Coveo {
	...
	export class ResponsiveComponentsManager {
	    ...
	    private tabSection;
	    private searchBoxElement;
	    private isTabActivated;
	    private isFacetActivated;
	    private responsiveFacets;
	    static register(responsiveComponentConstructor: IResponsiveComponentConstructor, root: Dom, ID: string, component: IComponentDefinition): void;
	    private static resizeAllComponentsManager();
	    constructor(root: Dom);
	    register(responsiveComponentConstructor: IResponsiveComponentConstructor, root: Dom, ID: string, component: any): void;
...
declare module Coveo {
	...
	export class ResponsiveFacets implements IResponsiveComponent {
	    ...
	    private searchInterface;
	    static init(root: HTMLElement, component: any): void;
	    constructor(root: Dom, ID: string);
	    needSmallMode(): boolean;
	    changeToSmallMode(): void;
	    changeToLargeMode(): void;
...
declare module Coveo {
	export var underscoreInstance: any;
...
/// <reference path="../lib/MagicBox.d.ts" />
/// <reference path="../lib/coveoanalytics.d.ts" />
