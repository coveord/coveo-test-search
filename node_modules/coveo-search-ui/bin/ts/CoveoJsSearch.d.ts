...
declare module Coveo {
	class QueryUtils {
	    ...
	    static getUniqueId(result: IQueryResult): {
	        fieldValue: string;
	        fieldUsed: string;
	    };
...
declare module Coveo {
	 ...
	 */
	interface IRevealQuerySuggestCompletion {
	    /**
	 ...
	 */
	interface IRevealQuerySuggestResponse {
	    /**
	 ...
	 */
	interface IRevealQuerySuggestRequest {
	    /**
...
declare module Coveo {
	...
	class KeyboardUtils {
	    ...
	    static keypressAction(keyCode: KEYBOARD | KEYBOARD[], action: Function): (e: KeyboardEvent, ...data: any[]) => boolean;
	}
...
declare module Coveo {
	const MEDIUM_SCREEN_WIDTH : any;
	const SMALL_SCREEN_WIDTH : any;
	/**
...
declare module Coveo {
	class ResponsiveFacets implements IResponsiveComponent {
	    coveoRoot: Dom;
	    ID: string;
...
declare module Coveo {
	...
	const defaultLayout: ValidLayout;
	/**
...
declare module Coveo {
	...
	class Debug extends RootComponent {
	    ...
	    constructor(element: HTMLElement, queryController: QueryController, options?: IDebugOptions, modalBox?: any);
	    buildFieldsSection(result: IQueryResult): Promise<{}>;
...
declare module Coveo {
	...
	class NumericSpinner {
	     ...
	     */
	    constructor(onChange?: () => void, min?: number, max?: number);
	    /**
	     * Reset the spinner
	     */
	    reset(): void;
...
declare module Coveo {
	...
	class Dropdown {
	     ...
	     */
	    constructor(onChange: () => void, listOfValues: string[], getDisplayValue?: (string) => string, label?: string);
	    /**
	     * Reset the dropdown
	     */
	    reset(): void;
...
declare module Coveo {
	...
	class TextInput {
	     ...
	     * @param name
	     */
	    constructor(onChange?: () => void, name?: string);
	    /**
	     * Return the element on which the dropdown is bound.
	     * @returns {HTMLElement}
	     */
...
declare module Coveo {
	...
	class RadioButton {
	     ...
	     */
	    constructor(onChange: () => void, label: string);
	    /**
...
declare module Coveo {
	interface ICompletedImageResultsLayoutEventArgs {
	}
...
declare module Coveo {
	...
	class DefaultMailToOptions implements IMailToOptions {
	    currentUserEmail: string;
	    originalFrom: string;
	    to: string;
	    subject: string;
...
declare module Coveo {
	 ...
	 */
	function init(element: HTMLElement, options?: any): void;
	/**
	 ...
	 * @param options JSON options for the framework (e.g.: <code>{Searchbox : {enableSearchAsYouType : true}}</code>).
	 */
	function initSearchbox(element: HTMLElement, searchPageUri: string, options?: any): void;
	/**
...
declare module Coveo {
	interface IPrintableUriOptions {
	}
	/**
...
declare module Coveo {
	interface IPreferencePanelInputToBuild {
	    label: string;
	    placeholder?: string;
	    tab?: string[];
	    expression?: string;
...
declare module Coveo {
	interface IImageResultListOptions extends IResultListOptions {
	    layoutType?: string;
	 ...
	 */
	class ImageResultList extends ResultList implements IComponentBindings {
	    element: HTMLElement;
...
declare module Coveo {
	class DateInput implements IAdvancedSearchInput {
	    inputName: string;
	    protected element: HTMLElement;
	    constructor(inputName: string);
	    reset(): void;
...
declare module Coveo {
	class SimpleFieldInput extends DocumentInput {
	    ...
	    protected element: HTMLElement;
	    dropDown: Dropdown;
	    constructor(inputName: string, fieldName: string, endpoint: ISearchEndpoint);
	    reset(): void;
	    build(): HTMLElement;
	    getValue(): string;
	}
...
declare module Coveo {
	class AdvancedFieldInput extends DocumentInput {
	    ...
	    mode: Dropdown;
	    input: TextInput;
	    constructor(inputName: string, fieldName: string);
	    reset(): void;
	    build(): HTMLElement;
	    getValue(): string;
	}
...
declare module Coveo {
	class AdvancedSearchInputFactory {
	    constructor(endpoint: ISearchEndpoint);
...
declare module Coveo {
	...
	class AdvancedSearch extends Component {
	     ...
	     * automatically resolved (with a slower execution time).
	     */
	    constructor(element: HTMLElement, options?: IAdvancedSearchOptions, bindings?: IComponentBindings);
	    /**
...
declare module Coveo {
	...
	class Backdrop extends Component {
	     ...
	     */
	    constructor(element: HTMLElement, options?: IBackdropOptions, bindings?: IComponentBindings, result?: IQueryResult, _window?: Window);
	}
