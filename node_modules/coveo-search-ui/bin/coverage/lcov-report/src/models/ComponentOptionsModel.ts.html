...
<html lang="en">
<head>
    <title>Code coverage report for src/models/ComponentOptionsModel.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/models/ComponentOptionsModel.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/models/</a> &#187; ComponentOptionsModel.ts</div>
</div>
<div class="body">
...
&nbsp;
  constructor(element: HTMLElement, attributes?: IComponentOptionsAttributes) {
    ...
    super(element, ComponentOptionsModel.ID, merged)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
  }
}
&nbsp;</pre></td></tr>
</table></pre>
