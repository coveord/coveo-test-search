...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1399</span>
...
export function setState(model: Model, args: any[]): any {
  Assert.exists(model);
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (args.length == 0 || args[0] == undefined) {
