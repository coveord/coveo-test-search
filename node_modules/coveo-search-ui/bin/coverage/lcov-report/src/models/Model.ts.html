...
<div class="header high">
    ...
    <h2>
        ...
        Branches: <span class="metric">61.29% <small>(38 / 62)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">85.19% <small>(23 / 27)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">86.49% <small>(96 / 111)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1735</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">56</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  public setDefault(attribute: string, options?: IModelSetOptions)</span> {
...
<span class="cstat-no" title="statement not covered" >        Assert.check(_.isBoolean(value) || Utils.parseBooleanIfNotUndefined(value) !== undefined, 'Non-matching type');</span>
      } else {
