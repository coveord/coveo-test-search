...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">90.63% <small>(145 / 160)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">81.32% <small>(74 / 91)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">86.36% <small>(19 / 22)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">90.26% <small>(139 / 154)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
    ...
    if (filter != undefined) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (basicGroupByRequestForGraph.queryOverride == undefined) {
...
<span class="cstat-no" title="statement not covered" >      this.facet.options.graph.steps = 10;</span>
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.facet.options.dateField &amp;&amp; isNaN(this.facet.options.start)) {
<span class="cstat-no" title="statement not covered" >      this.facet.options.start = new Date(this.facet.options.start).getTime();</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.facet.options.dateField &amp;&amp; isNaN(this.facet.options.end)) {
...
<span class="cstat-no" title="statement not covered" >      return this.usePrebuiltRange(oneRange);</span>
    } else {
