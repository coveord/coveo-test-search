...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">82.82% <small>(135 / 163)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">67.78% <small>(61 / 90)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">80% <small>(24 / 30)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">82.24% <small>(125 / 152)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
    ...
    if (!Utils.isNullOrUndefined(queryOverrideObject)) {
      ...
      this.basicExpressionToUseForFacetSearch = parts.basic == null ? '@uri' : <span class="branch-1 cbranch-no" title="branch not covered" >parts.basic;</span>
...
&nbsp;
      searchPromise.then(<span class="fstat-no" title="function not covered" >(queryResults: IQueryResults)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >        if (this.currentSearchPromise == searchPromise) {</span>
...
<span class="cstat-no" title="statement not covered" >      facetValues = this.facet.values.getAll();</span>
    }
    return facetValues;
  }
&nbsp;
...
&nbsp;
  protected createBasicGroupByRequest(allowedValues?: string[], <span class="missing-if-branch" title="else path not taken" >E</span>addComputedField: boolean = true): IGroupByRequest {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (allowedValues != null) {
