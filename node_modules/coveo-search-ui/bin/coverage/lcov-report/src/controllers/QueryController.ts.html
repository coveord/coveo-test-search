...
<html lang="en">
<head>
    <title>Code coverage report for src/controllers/QueryController.ts</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">src/controllers/QueryController.ts</span></h1>
    <h2>
        Statements: <span class="metric">72.1% <small>(199 / 276)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">47.3% <small>(35 / 74)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">63.27% <small>(31 / 49)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">73% <small>(192 / 263)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/controllers/</a> &#187; QueryController.ts</div>
</div>
<div class="body">
...
623
624
625</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { RootComponent } from '../ui/Base/RootComponent';
...
&nbsp;
  ...
  constructor(element: HTMLElement, public options: ISearchInterfaceOptions, public usageAnalytics, public searchInterface) {
    super(element, QueryController.ID)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
&nbsp;
   ...
   */
  public getLastQuery() {
    return this.lastQuery || <span class="branch-1 cbranch-no" title="branch not covered" >new QueryBuilder().build();</span>
  }
&nbsp;
  /**
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (options.closeModalBox) {
      ModalBox.close(true);
    }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.beforeExecuteQuery != null) {
<span class="cstat-no" title="statement not covered" >      options.beforeExecuteQuery();</span>
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!options.ignoreWarningSearchEvent) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!queryBuilder) {
...
&nbsp;
    ...
    promise.then((queryResults) =&gt; {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.firstQuery) {
        this.firstQuery = false;
      }
      // If our promise is no longer the current one, then the query
      // has been cancel. We should do nothing here.
      <span class="missing-if-branch" title="if path not taken" >I</span>if (promise !== this.currentPendingQuery) {
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if ((!firstQuery || enableHistory) &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >this.keepLastSearchUid(query, queryResults))</span> {
<span class="cstat-no" title="statement not covered" >        queryResults.searchUid = this.getLastSearchUid();</span>
<span class="cstat-no" title="statement not covered" >        queryResults._reusedSearchUid = true;</span>
<span class="cstat-no" title="statement not covered" >        QueryUtils.setPropertyOnResults(queryResults, 'queryUid', this.getLastSearchUid());</span>
      } else {
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (dataToSendOnNoResult.retryTheQuery) {
...
<span class="cstat-no" title="statement not covered" >        return this.executeQuery();</span>
      } else {
...
&nbsp;
  ...
  public fetchMore(count: number): Promise&lt;IQueryResults&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.currentPendingQuery != undefined) {
...
&nbsp;
    ...
    this.lastQueryBuilder = queryBuilder;
    this.lastQuery = query;
    promise.then(<span class="fstat-no" title="function not covered" >(results?: IQueryResults)</span> =&gt; {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.currentPendingQuery = undefined;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (this.lastQueryResults == null) {</span>
<span class="cstat-no" title="statement not covered" >        this.lastQueryResults = results;</span>
      } else {
<span class="cstat-no" title="statement not covered" >        _.forEach(results.results, <span class="fstat-no" title="function not covered" >(result)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          this.lastQueryResults.results.push(result);</span>
        });
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      let dataToSendOnPreprocessResult: IPreprocessResultsEventArgs = {</span>
        queryBuilder: queryBuilder,
        query: query,
        results: results,
        searchAsYouType: false
      };
<span class="cstat-no" title="statement not covered" >      this.preprocessResultsEvent(dataToSendOnPreprocessResult);</span>
<span class="cstat-no" title="statement not covered" >      QueryUtils.setIndexAndUidOnQueryResults(query, results, this.getLastSearchUid(), results.pipeline, results.splitTestRun);</span>
<span class="cstat-no" title="statement not covered" >      let dataToSendOnFetchMoreSuccess: IFetchMoreSuccessEventArgs = {</span>
        query: query,
        results: results,
        queryBuilder: queryBuilder,
        searchAsYouType: false
      };
<span class="cstat-no" title="statement not covered" >      this.fetchMoreSuccessEvent(dataToSendOnFetchMoreSuccess);</span>
    });
    return this.currentPendingQuery;
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  public deferExecuteQuery(options?: IQueryOptions)</span> {</span>
<span class="cstat-no" title="statement not covered" >    this.showExecutingQueryAnimation();</span>
<span class="cstat-no" title="statement not covered" >    Defer.defer(<span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.executeQuery(options))</span>;</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  public ensureCreatedQueryBuilder() {</span>
<span class="cstat-no" title="statement not covered" >    if (!this.createdOneQueryBuilder) {</span>
<span class="cstat-no" title="statement not covered" >      this.createQueryBuilder(new DefaultQueryOptions());</span>
    }
  }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (dataToSendDuringBuildingQuery.cancel || dataToSendDuringDoneBuildingQuery.cancel) {
<span class="cstat-no" title="statement not covered" >      this.cancelQuery();</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
    let pipeline = this.getPipelineInUrl();
    <span class="missing-if-branch" title="if path not taken" >I</span>if (pipeline) {
<span class="cstat-no" title="statement not covered" >      queryBuilder.pipeline = pipeline;</span>
    }
&nbsp;
    return queryBuilder;
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  public isStandaloneSearchbox(): boolean {</span>
<span class="cstat-no" title="statement not covered" >    return Utils.isNonEmptyString(this.options.searchPageUri);</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  public saveLastQuery() {</span>
<span class="cstat-no" title="statement not covered" >    this.localStorage.save({</span>
...
<span class="fstat-no" title="function not covered" >  public getLastQueryHash(): string {</span>
<span class="cstat-no" title="statement not covered" >    if (this.lastQueryHash != null) {</span>
<span class="cstat-no" title="statement not covered" >      return this.lastQueryHash;</span>
    }
<span class="cstat-no" title="statement not covered" >    this.loadLastQueryHash();</span>
<span class="cstat-no" title="statement not covered" >    return this.lastQueryHash || this.queryHash(new QueryBuilder().build());</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private getLastSearchUid(): string {</span>
<span class="cstat-no" title="statement not covered" >    if (this.lastSearchUid != null) {</span>
<span class="cstat-no" title="statement not covered" >      return this.lastSearchUid;</span>
    }
<span class="cstat-no" title="statement not covered" >    this.loadLastQueryHash();</span>
<span class="cstat-no" title="statement not covered" >    return this.lastSearchUid;</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private loadLastQueryHash() {</span>
<span class="cstat-no" title="statement not covered" >    let lastQuery = this.localStorage.load();</span>
<span class="cstat-no" title="statement not covered" >    if (lastQuery != null &amp;&amp; new Date().getTime() &lt;= lastQuery.expire) {</span>
<span class="cstat-no" title="statement not covered" >      this.lastQueryHash = lastQuery.hash;</span>
<span class="cstat-no" title="statement not covered" >      this.lastSearchUid = lastQuery.uid;</span>
<span class="cstat-no" title="statement not covered" >      this.localStorage.remove();</span>
    }
  }
&nbsp;
...
&nbsp;
  private cancelAnyCurrentPendingQuery() {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Utils.exists(this.currentPendingQuery)) {
<span class="cstat-no" title="statement not covered" >      this.logger.debug('Cancelling current pending query');</span>
<span class="cstat-no" title="statement not covered" >      Promise.reject(this.currentPendingQuery);</span>
<span class="cstat-no" title="statement not covered" >      this.currentPendingQuery = undefined;</span>
...
&nbsp;
  private showExecutingQueryAnimation() {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.showingExecutingQueryAnimation) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private keepLastSearchUid(query: IQuery, queryResults: IQueryResults)</span> {
<span class="cstat-no" title="statement not covered" >    return this.getLastQueryHash() == this.queryHash(query, queryResults);</span>
  }
&nbsp;
  private queryHash(query: IQuery, queryResults?: IQueryResults): string {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (queryResults != null) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private fetchMoreSuccessEvent(args)</span> {
<span class="cstat-no" title="statement not covered" >    $$(this.element).trigger(QueryEvents.fetchMoreSuccess, args);</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  public debugInfo() {</span></span>
<span class="cstat-no" title="statement not covered" >    let info: any = {</span>
      'query': this.lastQuery,
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.lastQueryResults != null) {</span>
<span class="cstat-no" title="statement not covered" >      info.queryDuration = <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.buildQueryDurationSection(this.lastQueryResults);</span></span>
<span class="cstat-no" title="statement not covered" >      info.results = <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>_.omit(this.lastQueryResults, 'results');</span></span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.currentError != null) {</span>
<span class="cstat-no" title="statement not covered" >      info.error = <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.currentError;</span></span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return info;</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private buildQueryDurationSection(queryResults: IQueryResults)</span> {
<span class="cstat-no" title="statement not covered" >    let dom = Dom.createElement('div', { className: 'coveo-debug-queryDuration' });</span>
<span class="cstat-no" title="statement not covered" >    let graph = Dom.createElement('div', { className: 'coveo-debug-durations' });</span>
<span class="cstat-no" title="statement not covered" >    let debugRef = BaseComponent.getComponentRef('Debug');</span>
<span class="cstat-no" title="statement not covered" >    dom.appendChild(graph);</span>
<span class="cstat-no" title="statement not covered" >    _.forEach(debugRef.durationKeys, <span class="fstat-no" title="function not covered" >(key: string)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      let duration = queryResults[key];</span>
<span class="cstat-no" title="statement not covered" >      if (duration != null) {</span>
<span class="cstat-no" title="statement not covered" >        graph.appendChild(Dom.createElement('div', {</span>
          className: 'coveo-debug-duration',
          style: `width:${duration}px`,
          'data-id': key
        }));
<span class="cstat-no" title="statement not covered" >        let legend = Dom.createElement('div', { className: 'coveo-debug-duration-legend', 'data-id': key });</span>
<span class="cstat-no" title="statement not covered" >        dom.appendChild(legend);</span>
<span class="cstat-no" title="statement not covered" >        let keyDom = Dom.createElement('span', { className: 'coveo-debug-duration-label' });</span>
<span class="cstat-no" title="statement not covered" >        keyDom.appendChild(document.createTextNode(key));</span>
<span class="cstat-no" title="statement not covered" >        legend.appendChild(keyDom);</span>
<span class="cstat-no" title="statement not covered" >        let durationDom = Dom.createElement('span', { className: 'coveo-debug-duration-value' });</span>
<span class="cstat-no" title="statement not covered" >        durationDom.appendChild(document.createTextNode(duration));</span>
<span class="cstat-no" title="statement not covered" >        legend.appendChild(durationDom);</span>
      }
    });
