...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">84.38% <small>(81 / 96)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">45% <small>(9 / 20)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">66.67% <small>(10 / 15)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">83.91% <small>(73 / 87)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
  ...
  constructor(element: HTMLElement, public windoh: Window, public model: Model, public queryController: QueryController, private hashUtils: typeof HashUtils = HashUtils) {
    super(element, HistoryController.ID)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    let diff = this.updateModelFromHash();</span>
&nbsp;
...
&nbsp;
    ...
    _.each(&lt;_.Dictionary&lt;any&gt;&gt;this.model.attributes, (value, key?, obj?) =&gt; {
      ...
      toSet[key] = valToSet;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.model.get(key) != valToSet) {
        diff.push(key);
      }
    });
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (Utils.isUndefined(value)) {
