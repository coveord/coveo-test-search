...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">85.44% <small>(88 / 103)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">79.31% <small>(46 / 58)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">68.75% <small>(11 / 16)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">85% <small>(85 / 100)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
export class DateUtils {
  ...
  static convertFromJsonDateIfNeeded(date: any): Date {
    ...
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (_.isString(date)) {
...
&nbsp;
  private static padNumber(num: string, <span class="missing-if-branch" title="else path not taken" >E</span>length: number = 2): string {
