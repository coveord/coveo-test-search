...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">93.8% <small>(121 / 129)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">84.38% <small>(54 / 64)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">96.3% <small>(26 / 27)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">93.65% <small>(118 / 126)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
  private static getAjaxcrawlableHash(hash: string) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (hash[1] != undefined &amp;&amp; hash[1] == '!') {
...
&nbsp;
  private static isArray(value: string) {
    ...
    let isArrayEnd = HashUtils.isArrayEndNotEncoded(value) || <span class="branch-1 cbranch-no" title="branch not covered" >HashUtils.isArrayEndEncoded(value);</span>
...
&nbsp;
  private static encodeValue(val: any) {
    let encodedValue = '';
    <span class="missing-if-branch" title="if path not taken" >I</span>if (_.isArray(val)) {
<span class="cstat-no" title="statement not covered" >      encodedValue = HashUtils.encodeArray(val);</span>
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (_.isObject(val)) {
...
&nbsp;
  private static decodeObject(obj: string): Object {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (HashUtils.isObjectStartEncoded(obj) &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >HashUtils.isObjectEndEncoded(obj))</span> {
...
&nbsp;
  private static decodeArray(value: string): any[] {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (HashUtils.isArrayStartEncoded(value) &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >HashUtils.isArrayEndEncoded(value))</span> {
