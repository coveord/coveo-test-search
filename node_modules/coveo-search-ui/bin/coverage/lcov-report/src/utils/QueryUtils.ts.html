...
<html lang="en">
<head>
    <title>Code coverage report for src/utils/QueryUtils.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/utils/QueryUtils.ts</span></h1>
    <h2>
        Statements: <span class="metric">86.96% <small>(100 / 115)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">74.29% <small>(26 / 35)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">80% <small>(28 / 35)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">86.36% <small>(95 / 110)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/utils/</a> &#187; QueryUtils.ts</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">11164</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-yes">11164</span>
<span class="cline-any cline-yes">11164</span>
<span class="cline-any cline-yes">89312</span>
<span class="cline-any cline-yes">89312</span>
<span class="cline-any cline-yes">5877</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">89312</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">11164</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {IQueryResults} from '../rest/QueryResults';
...
export class QueryUtils {
  static createGuid(): string {
    return (typeof (crypto) != 'undefined' &amp;&amp; typeof (crypto.getRandomValues) != 'undefined') ? QueryUtils.generateWithCrypto() : <span class="branch-1 cbranch-no" title="branch not covered" >QueryUtils.generateWithRandom();</span>
  }
&nbsp;
  // This method is a fallback as it's generate a lot of collisions in Chrome.
<span class="fstat-no" title="function not covered" >  static generateWithRandom(): string {</span>
    // http://stackoverflow.com/a/2117523
<span class="cstat-no" title="statement not covered" >    return 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(/[xy]/g, <span class="fstat-no" title="function not covered" >function (c)</span> {</span>
<span class="cstat-no" title="statement not covered" >      let r = Math.random() * 16 | 0, v = c == 'x' ? r : (r &amp; 0x3 | 0x8);</span>
<span class="cstat-no" title="statement not covered" >      return v.toString(16);</span>
    });
  }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  static setStateObjectOnQueryResults(state: any, results: IQueryResults)</span> {
<span class="cstat-no" title="statement not covered" >    QueryUtils.setPropertyOnResults(results, 'state', state);</span>
  }
&nbsp;
...
&nbsp;
  static splitFlags(flags: string, <span class="missing-if-branch" title="else path not taken" >E</span>delimiter: string = ';') {
    Assert.exists(flags);
    return flags.split(delimiter)
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  static isAttachment(result: IQueryResult)</span> {
<span class="cstat-no" title="statement not covered" >    return _.contains(QueryUtils.splitFlags(result.flags), 'IsAttachment');</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  static containsAttachment(result: IQueryResult)</span> {
<span class="cstat-no" title="statement not covered" >    return _.contains(QueryUtils.splitFlags(result.flags), 'ContainsAttachment');</span>
  }
&nbsp;
...
&nbsp;
    let filter: string;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (values.length == 1) {
<span class="cstat-no" title="statement not covered" >      filter = field + '==' + QueryUtils.quoteAndEscapeIfNeeded(values[0]);</span>
    } else {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  static mergeQueryString(url: string, queryString: string)</span> {
<span class="cstat-no" title="statement not covered" >    let queryStringPosition = url.indexOf('?');</span>
<span class="cstat-no" title="statement not covered" >    if (queryStringPosition != -1) {</span>
<span class="cstat-no" title="statement not covered" >      url += '&amp;' + queryString;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      url += '?' + queryString;</span>
    }
...
&nbsp;
  public static setPropertyOnResult(result: IQueryResult, property: string, value: any) {
    ...
    _.each(result.childResults, <span class="fstat-no" title="function not covered" >(child: IQueryResult)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      child[property] = value;</span>
    })
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!Utils.isNullOrUndefined(result.parentResult)) {
<span class="cstat-no" title="statement not covered" >      result.parentResult[property] = value;</span>
    }
  }
&nbsp;
...
&nbsp;
  public static isStratusAgnosticField(fieldToVerify: string, fieldToMatch: string): boolean {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (matchFieldToVerify &amp;&amp; matchFieldToMatch) {
