...
&nbsp;
  static removeMiddle(value: string, length: number, toAdd: string): string {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (value.length &lt; length) {
...
<span class="cstat-no" title="statement not covered" >        let regexp = _.find(StringUtils.accented, <span class="fstat-no" title="function not covered" >(regexp: RegExp)</span> =&gt; <span class="cstat-no" title="statement not covered" >char.match(regexp) != null)</span>;</span>
