...
<div class="header medium">
    ...
    <h2>
        Statements: <span class="metric">66.67% <small>(22 / 33)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (expiration) {
<span class="cstat-no" title="statement not covered" >      date = new Date();</span>
<span class="cstat-no" title="statement not covered" >      date.setTime(date.getTime() + expiration);</span>
<span class="cstat-no" title="statement not covered" >      expires = '; expires=' + date.toGMTString();</span>
    } else {
      expires = '';
    }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  static erase(name: string)</span> {
<span class="cstat-no" title="statement not covered" >    Cookie.set(name, '', -1);</span>
  }
}
&nbsp;</pre></td></tr>
</table></pre>
