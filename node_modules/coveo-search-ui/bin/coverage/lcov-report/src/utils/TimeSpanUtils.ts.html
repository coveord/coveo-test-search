...
&nbsp;
  getHHMMSS(): string {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (hours == 0) {
      hoursString = '';
    } else {
<span class="cstat-no" title="statement not covered" >      hoursString = hours &lt; 10 ? '0' + hours.toString() : hours.toString();</span>
    ...
    var hhmmss = (hoursString != '' ? <span class="branch-0 cbranch-no" title="branch not covered" >hoursString + ':' </span>: '') + minutesString + ':' + secondsString;
    return hhmmss;
  }
&nbsp;
