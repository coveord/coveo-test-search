...
<html lang="en">
<head>
    <title>Code coverage report for src/utils/HighlightUtils.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/utils/HighlightUtils.ts</span></h1>
    <h2>
        Statements: <span class="metric">81.82% <small>(135 / 165)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">76.19% <small>(64 / 84)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">75% <small>(6 / 8)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">81.37% <small>(131 / 161)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/utils/</a> &#187; HighlightUtils.ts</div>
</div>
<div class="body">
...
298
299
300</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  static replace(str: string, find: string, replace: string)</span>: StringAndHoles {
<span class="cstat-no" title="statement not covered" >    let strAndHoles = new StringAndHoles();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (Utils.isNullOrEmptyString(str)) {</span>
<span class="cstat-no" title="statement not covered" >      return strAndHoles;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    let index = str.lastIndexOf(find);</span>
<span class="cstat-no" title="statement not covered" >    if (index == -1) {</span>
<span class="cstat-no" title="statement not covered" >      strAndHoles.value = str;</span>
<span class="cstat-no" title="statement not covered" >      return strAndHoles;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    let holes: IStringHole[] = [];</span>
<span class="cstat-no" title="statement not covered" >    while (index &gt;= 0) {</span>
<span class="cstat-no" title="statement not covered" >      let hole = &lt;IStringHole&gt;{</span>
        begin: index,
        size: find.length,
        replacementSize: replace.length
      };
<span class="cstat-no" title="statement not covered" >      holes.push(hole);</span>
<span class="cstat-no" title="statement not covered" >      str = str.slice(0, index) + replace + str.slice(index + find.length);</span>
<span class="cstat-no" title="statement not covered" >      index = str.lastIndexOf(find);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    strAndHoles.holes = holes;</span>
<span class="cstat-no" title="statement not covered" >    strAndHoles.value = str;</span>
<span class="cstat-no" title="statement not covered" >    return strAndHoles;</span>
  }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Utils.isNullOrEmptyString(uri) || (uri.length &lt;= length)) {
<span class="cstat-no" title="statement not covered" >      strAndHoles.value = uri;</span>
<span class="cstat-no" title="statement not covered" >      return strAndHoles;</span>
    }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (first !== -1) {
      let removed = 0;
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (removed &gt; 0) {
...
&nbsp;
   ...
   */
  static shortenString(toShortenOrig: string, <span class="missing-if-branch" title="if path not taken" >I</span>length: number = 200, toAppend?: string): StringAndHoles {
    let toShorten = toShortenOrig
    toAppend = Utils.toNotNullString(toAppend);
    let strAndHoles = new StringAndHoles();
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Utils.isNullOrEmptyString(toShorten) || length &lt;= toAppend.length) {
<span class="cstat-no" title="statement not covered" >      strAndHoles.value = toShorten;</span>
<span class="cstat-no" title="statement not covered" >      return strAndHoles;</span>
    }
&nbsp;
...
&nbsp;
    if (toShorten.charAt(str.length) !== ' ') {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (pos !== -1 &amp;&amp; str.length - pos &lt; StringAndHoles.WORD_SHORTER) {
        str = str.slice(0, pos);
      }
    }
    let holes: IStringHole[] = [];
...
export class HighlightUtils {
  ...
  static highlightString(content: string, highlights: IHighlight[], holes: IStringHole[], cssClass: string): string {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Utils.isNullOrEmptyString(content)) {
...
&nbsp;
      if (holes !== null) {
        ...
        for (let j = 0; j &lt; holes.length; j++) {
          ...
          } else <span class="missing-if-branch" title="if path not taken" >I</span>if (start &lt; holeBegin &amp;&amp; end &gt;= holeEnd) {
<span class="cstat-no" title="statement not covered" >            end -= hole.size - hole.replacementSize;</span>
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (highlight.dataHighlightGroup) {
<span class="cstat-no" title="statement not covered" >        highlighted += ` data-highlight-group="${highlight.dataHighlightGroup.toString()}"`;</span>
      }
      <span class="missing-if-branch" title="if path not taken" >I</span>if (highlight.dataHighlightGroupTerm) {
<span class="cstat-no" title="statement not covered" >        highlighted += ` data-highlight-group-term="${highlight.dataHighlightGroupTerm}"`;</span>
      }
      highlighted += '&gt;';
...
&nbsp;
&nbsp;
<span class="fstat-no" title="function not covered" >export function highlightString(value: string, search: string)</span> {
<span class="cstat-no" title="statement not covered" >  let hightlightTemplate = _.template('&lt;% var i = 0; var lowercaseValue = value.toLowerCase(); while(i &lt; value.length) { %&gt;' +</span>
    ...
    '&lt;% } %&gt;' +
    '&lt;% } %&gt;');
<span class="cstat-no" title="statement not covered" >  if (_.isEmpty(search)) {</span>
<span class="cstat-no" title="statement not covered" >    return value;</span>
  }
<span class="cstat-no" title="statement not covered" >  return hightlightTemplate({ value: value, search: search.toLowerCase() });</span>
};
&nbsp;</pre></td></tr>
</table></pre>
