...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/Index.ts</span></h1>
    <h2>
        Statements: <span class="metric">97.27% <small>(214 / 220)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; Index.ts</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">export * from './BaseModules';
...
<span class="cstat-no" title="statement not covered" >    window['Coveo'] = this;</span>
  } else {
