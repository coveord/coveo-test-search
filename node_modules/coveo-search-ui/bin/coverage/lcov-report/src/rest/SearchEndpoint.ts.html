...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">87.56% <small>(359 / 410)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">64.29% <small>(63 / 98)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">82.42% <small>(75 / 91)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">87.47% <small>(342 / 391)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
1038
1039
1040</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  ...
  @method('POST')
  @responseType('text')
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  public batchFieldValues(request: IListFieldValuesRequest, callOptions?: IEndpointCallOptions, callParams?: IEndpointCallParameters)</span>: Promise&lt;IIndexFieldValue[]&gt; {</span>
...
<span class="cstat-no" title="statement not covered" >          this.renewAccessToken()</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  private renewAccessToken(): Promise&lt;string&gt; | Promise&lt;any&gt; {</span></span>
...
<span class="cstat-no" title="statement not covered" >      return token;</span>
      ...
      .catch(<span class="fstat-no" title="function not covered" >(e: any)</span> =&gt; {
