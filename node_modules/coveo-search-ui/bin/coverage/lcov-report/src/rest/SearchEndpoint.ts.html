...
<html lang="en">
<head>
    <title>Code coverage report for src/rest/SearchEndpoint.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/rest/SearchEndpoint.ts</span></h1>
    <h2>
        Statements: <span class="metric">86.08% <small>(371 / 431)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">61.68% <small>(66 / 107)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">78.57% <small>(77 / 98)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">85.53% <small>(337 / 394)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/rest/</a> &#187; SearchEndpoint.ts</div>
</div>
<div class="body">
...
1073
1074
1075</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { ISearchEndpointOptions, ISearchEndpoint, IViewAsHtmlOptions } from './SearchEndpointInterface';
...
&nbsp;
  ...
  static configureSampleEndpoint(otherOptions?: ISearchEndpointOptions) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (SearchEndpoint.isUseLocalArgumentPresent()) {
      // This is a handy flag to quickly test a local search API and alerts
<span class="cstat-no" title="statement not covered" >      SearchEndpoint.endpoints['default'] = new SearchEndpoint(_.extend({</span>
...
&nbsp;
   ...
   * @param otherOptions A set of additional options to use when configuring this endpoint
   */
<span class="fstat-no" title="function not covered" >  static configureSampleEndpointV2(optionsOPtions?: ISearchEndpointOptions)</span> {
<span class="cstat-no" title="statement not covered" >    SearchEndpoint.endpoints['default'] = new SearchEndpoint(_.extend({</span>
...
&nbsp;
   ...
   * @param otherOptions A set of additional options to use when configuring this endpoint
   */
  static configureCloudEndpoint(organization?: string, token?: string, <span class="missing-if-branch" title="else path not taken" >E</span>uri: string = 'https://cloudplatform.coveo.com/rest/search', otherOptions?: ISearchEndpointOptions) {
...
&nbsp;
   ...
   * @param otherOptions A set of additional options to use when configuring this endpoint
   */
<span class="fstat-no" title="function not covered" >  static configureCloudV2Endpoint(organization?: string, token?: string, <span class="cstat-no" title="statement not covered" >uri: string = 'https://platform.cloud.coveo.com/rest/search',</span> otherOptions?: ISearchEndpointOptions)</span> {
<span class="cstat-no" title="statement not covered" >    return SearchEndpoint.configureCloudEndpoint(organization, token, uri, otherOptions);</span>
  }
&nbsp;
  /**
...
&nbsp;
    ...
    defaultOptions.anonymous = window.location.href.indexOf('file://') == 0 &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >Utils.isNonEmptyString(options.accessToken);</span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (SearchEndpoint.isDebugArgumentPresent()) {
<span class="cstat-no" title="statement not covered" >      this.options.queryStringArguments['debug'] = 1;</span>
    }
    this.onUnload = <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      this.handleUnload();</span>
    };
...
&nbsp;
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (results.apiVersion == null) {
        results.apiVersion = 1;
      }
      <span class="missing-if-branch" title="else path not taken" >E</span>if (results.apiVersion &lt; version.supportedApiVersion) {
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (Utils.isNullOrEmptyString(results.searchUid)) {
<span class="cstat-no" title="statement not covered" >        results.searchUid = QueryUtils.createGuid();</span>
      }
...
&nbsp;
    ...
    callParams.queryString = callParams.queryString.concat(queryString);
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (numberOfResults != null) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  @path('/values')</span>
  @method('POST')
  @responseType('text')
<span class="fstat-no" title="function not covered" >  public batchFieldValues(request: IListFieldValuesRequest, callOptions?: IEndpointCallOptions, callParams?: IEndpointCallParameters)</span>: Promise&lt;IIndexFieldValue[]&gt; {
<span class="cstat-no" title="statement not covered" >    Assert.exists(request);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.performOneCall&lt;any&gt;(callParams)</span>
      .then(<span class="fstat-no" title="function not covered" >(data)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >        this.logger.info('REST list field values successful', data.values, request);</span>
<span class="cstat-no" title="statement not covered" >        return data.values;</span>
      });
  }
&nbsp;
  /**
...
&nbsp;
  ...
  public listSubscriptions(page: number, callOptions?: IEndpointCallOptions, callParams?: IEndpointCallParameters) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.isGuestUser) {
...
<span class="cstat-no" title="statement not covered" >        reject();</span>
    ...
    if (this.currentListSubscriptions == null) {
      callParams.queryString.push('page=' + (page || <span class="branch-1 cbranch-no" title="branch not covered" >0)</span>);
&nbsp;
      ...
      this.currentListSubscriptions.then((data: any) =&gt; {
        ...
        return data;
      }).catch(<span class="fstat-no" title="function not covered" >(e: AjaxError)</span> =&gt; {
...
<span class="cstat-no" title="statement not covered" >        if (e.status != 503) {</span>
...
&nbsp;
  @path('/log')
  @method('POST')
<span class="fstat-no" title="function not covered" >  public logError(sentryLog: ISentryLog, callOptions?: IEndpointCallOptions, callParams?: IEndpointCallParameters)</span> {
<span class="cstat-no" title="statement not covered" >    callParams.requestData = sentryLog;</span>
<span class="cstat-no" title="statement not covered" >    return this.performOneCall(callParams, callOptions)</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  public nuke() {</span>
<span class="cstat-no" title="statement not covered" >    window.removeEventListener('beforeunload', this.onUnload);</span>
  }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private handleUnload() {</span>
<span class="cstat-no" title="statement not covered" >    this.isRedirecting = true;</span>
  }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (Utils.isNonEmptyString(this.options.version)) {
...
&nbsp;
  public buildSearchAlertsUri(path: string): string {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (uri == null) {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (callOptions &amp;&amp; _.isArray(callOptions.authentication) &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >callOptions.authentication.length != 0)</span> {
<span class="cstat-no" title="statement not covered" >      queryString.push('authentication=' + callOptions.authentication.join(','));</span>
    }
&nbsp;
    return queryString;
  }
...
&nbsp;
      _.each(queryObject.context, <span class="fstat-no" title="function not covered" >(value, key)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >        queryString.push('context[' + key + ']=' + encodeURIComponent(value));</span>
      });
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (queryObject.fieldsToInclude) {
<span class="cstat-no" title="statement not covered" >        queryString.push(`fieldsToInclude=[${_.map(queryObject.fieldsToInclude, <span class="fstat-no" title="function not covered" >(field)</span> =&gt; <span class="cstat-no" title="statement not covered" >'"' + encodeURIComponent(field.replace('@', '')) + '"')</span>.join(',')}]`);</span>
      }
&nbsp;
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (query) {
<span class="cstat-no" title="statement not covered" >      queryString.push('q=' + encodeURIComponent(query));</span>
    }
&nbsp;
    return queryString;
  }
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (callOptions.query || callOptions.queryObject) {
<span class="cstat-no" title="statement not covered" >      queryString.push('enableNavigation=true');</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (callOptions.requestedOutputSize) {
<span class="cstat-no" title="statement not covered" >      queryString.push('requestedOutputSize=' + encodeURIComponent(callOptions.requestedOutputSize.toString()));</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (callOptions.contentType) {
<span class="cstat-no" title="statement not covered" >      queryString.push('contentType=' + encodeURIComponent(callOptions.contentType));</span>
    }
    return queryString;
  }
&nbsp;
  private performOneCall&lt;T&gt;(params: IEndpointCallParameters, callOptions?: IEndpointCallOptions, <span class="missing-if-branch" title="else path not taken" >E</span>autoRenewToken = true): Promise&lt;T&gt; {
    let queryString = this.buildBaseQueryString(callOptions);
...
&nbsp;
    return this.caller.call(params)
      .then((response?: ISuccessResponse&lt;T&gt;) =&gt; {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (autoRenewToken &amp;&amp; this.canRenewAccessToken() &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >this.isAccessTokenExpiredStatus(error.statusCode))</span> {
<span class="cstat-no" title="statement not covered" >          this.renewAccessToken().then(<span class="fstat-no" title="function not covered" >() =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >            return this.performOneCall(params, callOptions, autoRenewToken);</span>
          })
            .catch(<span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >              return Promise.reject(this.handleErrorResponse(error));</span>
            });
        } else <span class="missing-if-branch" title="if path not taken" >I</span>if (error.statusCode == 0 &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.isRedirecting)</span> {
          // The page is getting redirected
          // Set timeout on return with empty string, since it does not really matter
<span class="cstat-no" title="statement not covered" >          _.defer(<span class="fstat-no" title="function not covered" >function () {</span></span>
...
&nbsp;
  private handleErrorResponse(errorResponse: IErrorResponse): Error {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.isMissingAuthenticationProviderStatus(errorResponse.statusCode)) {
<span class="cstat-no" title="statement not covered" >      return new MissingAuthenticationError(errorResponse.data['provider']);</span>
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (errorResponse.data &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >errorResponse.data.message </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >errorResponse.data.type)</span> {
<span class="cstat-no" title="statement not covered" >      return new QueryError(errorResponse);</span>
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (errorResponse.data &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >errorResponse.data.message)</span> {
<span class="cstat-no" title="statement not covered" >      return new AjaxError(`Request Error : ${errorResponse.data.message}`, errorResponse.statusCode);</span>
    } else {
...
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  private renewAccessToken(): Promise&lt;string&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >    this.logger.info('Renewing expired access token');</span>
<span class="cstat-no" title="statement not covered" >    return this.options.renewAccessToken().then(<span class="fstat-no" title="function not covered" >(token: string)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      Assert.isNonEmptyString(token);</span>
<span class="cstat-no" title="statement not covered" >      this.options.accessToken = token;</span>
<span class="cstat-no" title="statement not covered" >      this.createEndpointCaller();</span>
<span class="cstat-no" title="statement not covered" >      return token;</span>
    }).catch(<span class="fstat-no" title="function not covered" >(e: string)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      this.logger.error('Failed to renew access token', e);</span>
<span class="cstat-no" title="statement not covered" >      return e;</span>
    });
  }
&nbsp;
  private removeTrailingSlash(uri: string) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.hasTrailingSlash(uri)) {
<span class="cstat-no" title="statement not covered" >      uri = uri.substr(0, uri.length - 1);</span>
    }
    return uri;
  }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private isAccessTokenExpiredStatus(status: number)</span>: boolean {
<span class="cstat-no" title="statement not covered" >    return status == 419;</span>
  }
}
&nbsp;
&nbsp;
...
&nbsp;
    descriptor.value = function (...args: any[]) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (args[nbParams - 1]) {
<span class="cstat-no" title="statement not covered" >        args[nbParams - 1].url = uri;</span>
      } else {
...
&nbsp;
    descriptor.value = function (...args: any[]) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (args[nbParams - 1]) {
        args[nbParams - 1].requestDataType = type;
      } else {
<span class="cstat-no" title="statement not covered" >        let params: IEndpointCallParameters = {</span>
          url: '',
          queryString: [],
          requestData: {},
...
<span class="cstat-no" title="statement not covered" >        args[nbParams - 1] = params;</span>
      }
      let result = originalMethod.apply(this, args);
      return result;
    };
