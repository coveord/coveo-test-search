...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/Breadcrumb/Breadcrumb.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/Breadcrumb/Breadcrumb.ts</span></h1>
    <h2>
        Statements: <span class="metric">94.52% <small>(69 / 73)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/Breadcrumb/</a> &#187; Breadcrumb.ts</div>
</div>
<div class="body">
...
&nbsp;
  ...
  constructor(public element: HTMLElement, public options?: IBreadcrumbOptions, bindings?: IComponentBindings) {
    super(element, Breadcrumb.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
&nbsp;
...
&nbsp;
    ...
    this.bind.onRootElement(BreadcrumbEvents.redrawBreadcrumb, <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.redrawBreadcrumb())</span>;
...
<span class="cstat-no" title="statement not covered" >      this.element.insertBefore(clear, this.element.firstChild);</span>
    }
&nbsp;
    const clearAction = <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.clearBreadcrumbs();</span>
    this.bind.on(clear, 'click', clearAction);
    this.bind.on(clear, 'keyup', KeyboardUtils.keypressAction(KEYBOARD.ENTER, clearAction));
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private redrawBreadcrumb() {</span>
<span class="cstat-no" title="statement not covered" >    this.lastBreadcrumbs ? this.drawBreadcrumb(this.lastBreadcrumbs) : this.drawBreadcrumb(this.getBreadcrumbs());</span>
  }
&nbsp;
