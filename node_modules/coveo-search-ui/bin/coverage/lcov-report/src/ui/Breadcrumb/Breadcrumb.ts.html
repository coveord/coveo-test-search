...
&nbsp;
    this.bind.on(clear, 'click', <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      this.clearBreadcrumbs();</span>
    })
  }
&nbsp;
