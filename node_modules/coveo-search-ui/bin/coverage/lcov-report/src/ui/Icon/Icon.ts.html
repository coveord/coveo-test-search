...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">84.62% <small>(55 / 65)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">69.23% <small>(27 / 39)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
  ...
  constructor(public element: HTMLElement, public options?: IIconOptions, bindings?: IComponentBindings, public result?: IQueryResult) {
    super(element, Icon.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
&nbsp;
...
&nbsp;
  static createIcon(result: IQueryResult, <span class="missing-if-branch" title="if path not taken" >I</span>options: IIconOptions = {}, element: HTMLElement = $$('div').el, bindings?: IComponentBindings) {
...
&nbsp;
    if (options.value != undefined) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (options.small === true) {
<span class="cstat-no" title="statement not covered" >        if (options.value.indexOf('-small') == -1) {</span>
<span class="cstat-no" title="statement not covered" >          info.icon += '-small';</span>
        }
      }
      <span class="missing-if-branch" title="if path not taken" >I</span>if (options.small === false) {
<span class="cstat-no" title="statement not covered" >        if (options.value.indexOf('-small') != -1) {</span>
<span class="cstat-no" title="statement not covered" >          info.icon = info.icon.replace('-small', '');</span>
        }
      }
    }
