...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/PreferencesPanel/PreferencesPanel.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/PreferencesPanel/PreferencesPanel.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/PreferencesPanel/</a> &#187; PreferencesPanel.ts</div>
</div>
<div class="body">
...
&nbsp;
  ...
  constructor(public element: HTMLElement, public options: IPreferencesPanelOptions, bindings?: IComponentBindings) {
    super(element, PreferencesPanel.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
