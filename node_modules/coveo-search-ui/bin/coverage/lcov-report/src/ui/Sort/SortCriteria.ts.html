...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/Sort/SortCriteria.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/Sort/SortCriteria.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/Sort/</a> &#187; SortCriteria.ts</div>
</div>
<div class="body">
...
&nbsp;
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (this.sort == 'date') {
      return result.raw['date'];
    } else {
<span class="cstat-no" title="statement not covered" >      Assert.fail('Cannot retrieve value: ' + this.sort);</span>
    }
  }
&nbsp;
  /**
