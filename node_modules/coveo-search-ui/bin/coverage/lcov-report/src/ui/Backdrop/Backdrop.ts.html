...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/Backdrop/Backdrop.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/Backdrop/Backdrop.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/Backdrop/</a> &#187; Backdrop.ts</div>
</div>
<div class="body">
...
&nbsp;
  ...
  constructor(public element: HTMLElement, public options?: IBackdropOptions, bindings?: IComponentBindings, public result?: IQueryResult, public _window?: Window, public ModalBox = ModalBoxModule) {
    super(element, Backdrop.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
&nbsp;
      $$(this.element).on('click', (e: MouseEvent) =&gt; {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!$$(&lt;HTMLElement&gt;e.target).hasClass('CoveoResultLink')) {
