...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/ChatterLikedBy/ChatterLikedBy.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/ChatterLikedBy/ChatterLikedBy.ts</span></h1>
    <h2>
        Statements: <span class="metric">94.83% <small>(55 / 58)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">86.36% <small>(19 / 22)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">80% <small>(4 / 5)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">94.12% <small>(48 / 51)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/ChatterLikedBy/</a> &#187; ChatterLikedBy.ts</div>
</div>
<div class="body">
...
&nbsp;
  constructor(public element: HTMLElement, public options?: IChatterLikedByOptions, public bindings?: IComponentBindings, public result?: IQueryResult) {
    super(element, ChatterLikedBy.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
&nbsp;
      ...
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (i &lt; likeIds.length - 1) {
...
&nbsp;
    if (nbLikesToRender == 0 || likeIds.length &lt;= nbLikesToRender) {
      ...
      clickableLink.on('click', <span class="fstat-no" title="function not covered" >(e: Event)</span> =&gt; {
...
<span class="cstat-no" title="statement not covered" >        this.renderLikesList(element, result, likeNames, likeIds, 0);</span>
      });
      tempElement.append(clickableLink.el);
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (likeIds.length &gt; 0) {
      let name = $$('span');
