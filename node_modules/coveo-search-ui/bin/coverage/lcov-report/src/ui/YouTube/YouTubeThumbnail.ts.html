...
&nbsp;
  constructor(public element: HTMLElement, public options?: IYouTubeThumbnailOptions, public bindings?: IResultsComponentBindings, public result?: IQueryResult, public ModalBox = ModalBoxModule) {
    super(element, YouTubeThumbnail.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
&nbsp;
    $$($$(this.modalbox.wrapper).find('.coveo-quickview-close-button')).on('click', <span class="fstat-no" title="function not covered" >() =&gt; {</span>
