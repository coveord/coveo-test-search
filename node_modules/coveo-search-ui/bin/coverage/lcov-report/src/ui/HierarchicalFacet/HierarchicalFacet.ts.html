...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/HierarchicalFacet/HierarchicalFacet.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/HierarchicalFacet/HierarchicalFacet.ts</span></h1>
    <h2>
        Statements: <span class="metric">82.37% <small>(397 / 482)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">65.8% <small>(127 / 193)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">80.91% <small>(89 / 110)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">81.92% <small>(367 / 448)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/HierarchicalFacet/</a> &#187; HierarchicalFacet.ts</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">734</span>
<span class="cline-any cline-yes">734</span>
<span class="cline-any cline-yes">734</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
...
<span class="cline-any cline-yes">3928</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1326</span>
<span class="cline-any cline-yes">1326</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">6256</span>
<span class="cline-any cline-yes">6256</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">3601</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">7394</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">7394</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  ...
  public constructor(public element: HTMLElement, options: IHierarchicalFacetOptions, public bindings: IComponentBindings) {
    super(element, options, bindings, HierarchicalFacet.ID)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
    this.options = ComponentOptions.initComponentOptions(element, HierarchicalFacet, this.options);
    this.numberOfValuesToShow = this.originalNumberOfValuesToShow = (this.options.numberOfValues || <span class="branch-1 cbranch-no" title="branch not covered" >5)</span>;
...
&nbsp;
  ...
  public selectValue(value: any, <span class="missing-if-branch" title="else path not taken" >E</span>selectChildren = !this.options.useAnd) {
    this.ensureDom();
    this.ensureValueHierarchyExists([value]);
    let valueHierarchy = this.getValueFromHierarchy(value);
    <span class="missing-if-branch" title="else path not taken" >E</span>if (selectChildren) {
...
&nbsp;
  ...
  public selectMultipleValues(values: any[], <span class="missing-if-branch" title="else path not taken" >E</span>selectChildren = !this.options.useAnd): void {
    this.ensureDom();
...
&nbsp;
  ...
  public deselectValue(value: any, deselectChildren = true) {
    ...
    if (deselectChildren) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (hasChilds) {
        let activeChilds = _.filter&lt;IValueHierarchy&gt;(valueHierarchy.childs, (child) =&gt; {
          ...
          return valueToCompare.selected || <span class="branch-1 cbranch-no" title="branch not covered" >valueToCompare.excluded;</span>
        });
        valueHierarchy.hasChildSelected = false;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (activeChilds.length == valueHierarchy.childs.length) {
...
<span class="fstat-no" title="function not covered" >  public excludeValue(value: any, <span class="cstat-no" title="statement not covered" >excludeChildren = !this.options.useAnd)</span></span>: void {
<span class="cstat-no" title="statement not covered" >    this.ensureDom();</span>
<span class="cstat-no" title="statement not covered" >    this.ensureValueHierarchyExists([value]);</span>
<span class="cstat-no" title="statement not covered" >    let valueHierarchy = this.getValueFromHierarchy(value);</span>
<span class="cstat-no" title="statement not covered" >    if (excludeChildren) {</span>
<span class="cstat-no" title="statement not covered" >      this.excludeChilds(valueHierarchy.childs);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      this.deselectChilds(valueHierarchy, valueHierarchy.childs);</span>
<span class="cstat-no" title="statement not covered" >      this.close(valueHierarchy);</span>
    }
<span class="cstat-no" title="statement not covered" >    this.flagParentForSelection(valueHierarchy);</span>
<span class="cstat-no" title="statement not covered" >    super.excludeValue(value);</span>
  }
&nbsp;
  /**
...
<span class="fstat-no" title="function not covered" >  public unexcludeValue(value: any, <span class="cstat-no" title="statement not covered" >unexludeChildren = !this.options.useAnd)</span></span>: void {
<span class="cstat-no" title="statement not covered" >    this.ensureDom();</span>
<span class="cstat-no" title="statement not covered" >    this.ensureValueHierarchyExists([value]);</span>
<span class="cstat-no" title="statement not covered" >    let valueHierarchy = this.getValueFromHierarchy(value);</span>
<span class="cstat-no" title="statement not covered" >    if (unexludeChildren) {</span>
<span class="cstat-no" title="statement not covered" >      this.unexcludeChilds(valueHierarchy.childs);</span>
    }
<span class="cstat-no" title="statement not covered" >    this.unflagParentForSelection(valueHierarchy);</span>
<span class="cstat-no" title="statement not covered" >    super.unexcludeValue(value);</span>
  }
&nbsp;
  /**
  ...
  public deselectMultipleValues(values: any[], <span class="missing-if-branch" title="else path not taken" >E</span>deselectChildren = !this.options.useAnd): void {
    this.ensureDom();
    this.ensureValueHierarchyExists(values);
    _.each(values, (value) =&gt; {
      let valueHierarchy = this.getValueFromHierarchy(value);
      valueHierarchy.hasChildSelected = false;
      this.unflagParentForSelection(valueHierarchy);
      <span class="missing-if-branch" title="else path not taken" >E</span>if (deselectChildren) {
        _.each(valueHierarchy.childs, (child) =&gt; {
...
<span class="fstat-no" title="function not covered" >  public toggleSelectValue(value: any)</span>: void {
<span class="cstat-no" title="statement not covered" >    this.ensureDom();</span>
<span class="cstat-no" title="statement not covered" >    this.ensureValueHierarchyExists([value]);</span>
<span class="cstat-no" title="statement not covered" >    if (this.getFacetValueFromHierarchy(value).selected == false) {</span>
<span class="cstat-no" title="statement not covered" >      this.selectValue(value);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      this.deselectValue(value);</span>
    }
  }
&nbsp;
  /**
...
<span class="fstat-no" title="function not covered" >  public toggleExcludeValue(value: any)</span>: void {
<span class="cstat-no" title="statement not covered" >    this.ensureDom();</span>
<span class="cstat-no" title="statement not covered" >    this.ensureValueHierarchyExists([value]);</span>
<span class="cstat-no" title="statement not covered" >    if (this.getFacetValueFromHierarchy(value).excluded == false) {</span>
<span class="cstat-no" title="statement not covered" >      this.excludeValue(value);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      this.unexcludeValue(value);</span>
    }
  }
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered" >        ret = this.options.valueCaption[stringValue] || ret;</span>
      }
<span class="cstat-no" title="statement not covered" >      if (typeof this.options.valueCaption == 'function') {</span>
<span class="cstat-no" title="statement not covered" >        ret = this.options.valueCaption.call(this, facetValue);</span>
      }
    }
    return ret;
  }
&nbsp;
   ...
   */
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  public getDisplayedValues(): string[] {</span></span>
<span class="cstat-no" title="statement not covered" >    let displayed = _.filter(this.values.getAll(), <span class="fstat-no" title="function not covered" >(v)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      let valFromHierarchy = this.getValueFromHierarchy(v);</span>
<span class="cstat-no" title="statement not covered" >      if (valFromHierarchy) {</span>
<span class="cstat-no" title="statement not covered" >        let elem = this.getElementFromFacetValueList(v);</span>
<span class="cstat-no" title="statement not covered" >        return !$$(elem).hasClass('coveo-inactive');</span>
      }
<span class="cstat-no" title="statement not covered" >      return false;</span>
    });
<span class="cstat-no" title="statement not covered" >    return _.pluck(displayed, 'value');</span>
  }
&nbsp;
  /**
   ...
   */
<span class="fstat-no" title="function not covered" >  public updateSort(criteria: string)</span> {
<span class="cstat-no" title="statement not covered" >    this.firstPlacement = true;</span>
<span class="cstat-no" title="statement not covered" >    super.updateSort(criteria);</span>
  }
&nbsp;
  /**
  ...
  public open(value: any) {
    ...
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (value instanceof FacetValue) {
<span class="cstat-no" title="statement not covered" >      getter = this.getValueHierarchy(value.value);</span>
    } else {
      getter = value;
    }
    if (getter != undefined) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (getter.parent != undefined) {
<span class="cstat-no" title="statement not covered" >        this.open(this.getValueHierarchy(getter.facetValue.value).parent);</span>
      }
...
<span class="cstat-no" title="statement not covered" >      getter = this.getValueHierarchy(value.value);</span>
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (getter != undefined) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  public processFacetSearchAllResultsSelected(facetValues: FacetValue[])</span>: void {
<span class="cstat-no" title="statement not covered" >    this.selectMultipleValues(facetValues);</span>
<span class="cstat-no" title="statement not covered" >    this.triggerNewQuery();</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  protected triggerUpdateDeltaQuery(facetValues: FacetValue[])</span> {
<span class="cstat-no" title="statement not covered" >    this.shouldReshuffleFacetValuesClientSide = this.keepDisplayedValuesNextTime;</span>
<span class="cstat-no" title="statement not covered" >    super.triggerUpdateDeltaQuery(facetValues);</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      args.text.push(new HierarchicalBreadcrumbValuesList(this, this.values.getSelected().concat(this.values.getExcluded()), this.getAllValueHierarchy()).buildAsString());</span>
    }
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  protected handleOmniboxWithStaticValue(eventArg: IPopulateOmniboxEventArgs)</span> {</span>
<span class="cstat-no" title="statement not covered" >    let regex = eventArg.completeQueryExpression.regex;</span>
<span class="cstat-no" title="statement not covered" >    let match = _.first(_.filter&lt;IValueHierarchy&gt;(this.getAllValueHierarchy(), <span class="fstat-no" title="function not covered" >(existingValue)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      return regex.test(this.getValueCaption(existingValue.facetValue));</span>
    }), this.options.numberOfValuesInOmnibox);
<span class="cstat-no" title="statement not covered" >    let facetValues = _.compact(_.map(match, <span class="fstat-no" title="function not covered" >(gotAMatch)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      let fromList = this.getFromFacetValueList(gotAMatch.facetValue);</span>
<span class="cstat-no" title="statement not covered" >      return fromList ? fromList.facetValue : undefined;</span>
    }));
<span class="cstat-no" title="statement not covered" >    let element = new OmniboxHierarchicalValuesList(this, facetValues, eventArg).build();</span>
<span class="cstat-no" title="statement not covered" >    eventArg.rows.push({</span>
      element: element,
...
<span class="cstat-no" title="statement not covered" >    this.numberOfValuesToShow += this.originalNumberOfValuesToShow;</span>
<span class="cstat-no" title="statement not covered" >    this.numberOfValuesToShow = Math.min(this.numberOfValuesToShow, this.values.size());</span>
<span class="cstat-no" title="statement not covered" >    this.crop();</span>
...
&nbsp;
  private placeChildsUnderTheirParent(hierarchy: IValueHierarchy, hierarchyElement: HTMLElement) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (toIterateOver) {
      ...
      _.each(toIterateOverSorted, (child) =&gt; {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (childFromHierarchy) {
...
&nbsp;
    $$(openAndCloseChilds).on('click', <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      $$(hierarchyElement).hasClass('coveo-open') ? this.close(hierarchy) : this.open(hierarchy);</span>
    });
&nbsp;
...
&nbsp;
  private setValueListContent() {
    this.facetValuesList.hierarchyFacetValues = _.map(this.correctLevels, (hierarchy) =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.values.contains(hierarchy.facetValue.value)) {
<span class="cstat-no" title="statement not covered" >        hierarchy.facetValue.occurrences = 0;</span>
<span class="cstat-no" title="statement not covered" >        this.values.add(hierarchy.facetValue);</span>
      }
...
&nbsp;
  private createHierarchy(valuesToBuildWith: FacetValue[]) {
    let flatHierarchy = _.map(valuesToBuildWith, (value: FacetValue) =&gt; {
      ...
      let self = value.lookupValue || <span class="branch-1 cbranch-no" title="branch not covered" >value.value;</span>
      return {
        facetValue: value,
...
&nbsp;
  private setInHierarchy(flatHierarchy: IFlatHierarchy[]) {
    this.correctLevels = _.filter&lt;IFlatHierarchy&gt;(flatHierarchy, (hierarchy) =&gt; {
      ...
      let isCorrectMaximumLevel = this.options.levelEnd == undefined || <span class="branch-1 cbranch-no" title="branch not covered" >hierarchy.level &lt; this.options.levelEnd;</span>
...
&nbsp;
      ...
      this.setValueHierarchy(hierarchy.facetValue.value, {
        ...
        parent: parent == undefined ? undefined : {
          ...
          level: parent.level,
          keepOpened: hierarchyThatAlreadyExistsAtParent ? hierarchyThatAlreadyExistsAtParent.keepOpened : <span class="branch-1 cbranch-no" title="branch not covered" >false,</span>
          hasChildSelected: hierarchyThatAlreadyExistsAtParent ? hierarchyThatAlreadyExistsAtParent.hasChildSelected : <span class="branch-1 cbranch-no" title="branch not covered" >false,</span>
          originalPosition: hierarchyThatAlreadyExistsAtParent ? hierarchyThatAlreadyExistsAtParent.originalPosition : <span class="branch-1 cbranch-no" title="branch not covered" >undefined,</span>
          allChildShouldBeSelected: hierarchyThatAlreadyExistsAtParent ? hierarchyThatAlreadyExistsAtParent.allChildShouldBeSelected : <span class="branch-1 cbranch-no" title="branch not covered" >false</span>
        },
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private excludeChilds(children: IValueHierarchy[])</span> {
<span class="cstat-no" title="statement not covered" >    this.excludeMultipleValues(_.map(children, <span class="fstat-no" title="function not covered" >(child)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      return child.facetValue;</span>
    }));
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private unexcludeChilds(children: IValueHierarchy[])</span> {
<span class="cstat-no" title="statement not covered" >    this.unexcludeMultipleValues(_.map(children, <span class="fstat-no" title="function not covered" >(child)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      return child.facetValue;</span>
    }));
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private selectParent(parent: IValueHierarchy)</span> {
<span class="cstat-no" title="statement not covered" >    if (parent != undefined) {</span>
<span class="cstat-no" title="statement not covered" >      this.selectValue(parent.facetValue);</span>
<span class="cstat-no" title="statement not covered" >      if (parent.parent) {</span>
<span class="cstat-no" title="statement not covered" >        this.selectParent(this.getValueHierarchy(parent.parent.facetValue.value));</span>
      }
    }
  }
&nbsp;
  ...
  private unflagParentForSelection(valueHierarchy: IValueHierarchy) {
    ...
    while (parent) {
      ...
      let otherSelectedChilds = _.filter&lt;IValueHierarchy&gt;(parentInHierarchy.childs, (child) =&gt; {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (childInHierarchy != undefined) {
...
&nbsp;
  private getLookupOrValue(value: FacetValue) {
    return value.lookupValue || <span class="branch-1 cbranch-no" title="branch not covered" >value.value;</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return $$('div').el;</span>
    }
  }
&nbsp;
  private getFromFacetValueList(value: any) {
    let fromHierarchy = this.getValueFromHierarchy(value);
    <span class="missing-if-branch" title="else path not taken" >E</span>if (fromHierarchy != undefined) {
...
&nbsp;
  private deleteValueHierarchy(key: string) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.valueHierarchy != null) {
      delete this.valueHierarchy[key.toLowerCase()];
    }
  }
&nbsp;
  private getValueHierarchy(key: string): IValueHierarchy {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.valueHierarchy == null) {
<span class="cstat-no" title="statement not covered" >      return undefined;</span>
    }
...
&nbsp;
  private setValueHierarchy(key: string, value: IValueHierarchy) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.valueHierarchy == null) {
<span class="cstat-no" title="statement not covered" >      this.valueHierarchy = {};</span>
    }
  ...
  private checkForNewUnselectedChild() {
    ...
    _.each(this.valueHierarchy, (v: IValueHierarchy) =&gt; {
      if (v.allChildShouldBeSelected) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (notAlreadySelected) {
<span class="cstat-no" title="statement not covered" >          this.selectValue(v.facetValue, true);</span>
<span class="cstat-no" title="statement not covered" >          this.logger.info('Re-executing query with new facet values returned by index');</span>
