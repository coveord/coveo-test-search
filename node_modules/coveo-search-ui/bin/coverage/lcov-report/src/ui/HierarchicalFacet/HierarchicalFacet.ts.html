...
<div class="header medium">
    ...
    <h2>
        Statements: <span class="metric">79.04% <small>(347 / 439)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">62.2% <small>(102 / 164)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">75.96% <small>(79 / 104)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">78.33% <small>(318 / 406)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
877
878
879</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1717</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1717</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  ...
  public selectValue(value: any, <span class="missing-if-branch" title="else path not taken" >E</span>selectChilds = !this.options.useAnd) {
    this.ensureDom();
    this.ensureValueHierarchyExists([value]);
    let valueHierarchy = this.getValueFromHierarchy(value);
    <span class="missing-if-branch" title="else path not taken" >E</span>if (selectChilds) {
...
&nbsp;
  ...
  public selectMultipleValues(values: any[], <span class="missing-if-branch" title="else path not taken" >E</span>selectChilds = !this.options.useAnd): void {
    this.ensureDom();
    ...
    _.each(values, (value) =&gt; {
      ...
      this.flagParentForSelection(valueHierarchy);
      <span class="missing-if-branch" title="else path not taken" >E</span>if (selectChilds) {
        _.each(valueHierarchy.childs, <span class="fstat-no" title="function not covered" >(child)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >          this.selectValue(child.facetValue);</span>
        })
      }
    })
  ...
  public deselectValue(value: any, deselectChilds = true) {
    ...
    if (deselectChilds) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (hasChilds) {
        let activeChilds = _.filter&lt;IValueHierarchy&gt;(valueHierarchy.childs, <span class="fstat-no" title="function not covered" >(child)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >          let valueToCompare = this.getFacetValueFromHierarchy(child.facetValue)</span>
<span class="cstat-no" title="statement not covered" >          return valueToCompare.selected || valueToCompare.excluded;</span>
        })
...
<span class="fstat-no" title="function not covered" >  public excludeValue(value: any, <span class="cstat-no" title="statement not covered" >excludeChilds = !this.options.useAnd)</span></span>: void {
...
<span class="cstat-no" title="statement not covered" >    if (excludeChilds) {</span>
...
<span class="fstat-no" title="function not covered" >  public unexcludeValue(value: any, <span class="cstat-no" title="statement not covered" >unexludeChilds = !this.options.useAnd)</span></span>: void {
<span class="cstat-no" title="statement not covered" >    this.ensureDom();</span>
<span class="cstat-no" title="statement not covered" >    this.ensureValueHierarchyExists([value]);</span>
<span class="cstat-no" title="statement not covered" >    let valueHierarchy = this.getValueFromHierarchy(value);</span>
<span class="cstat-no" title="statement not covered" >    if (unexludeChilds) {</span>
...
&nbsp;
  ...
  public deselectMultipleValues(values: any[], <span class="missing-if-branch" title="else path not taken" >E</span>deselectChilds = !this.options.useAnd): void {
    this.ensureDom();
    this.ensureValueHierarchyExists(values);
    _.each(values, <span class="fstat-no" title="function not covered" >(value)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      let valueHierarchy = this.getValueFromHierarchy(value);</span>
<span class="cstat-no" title="statement not covered" >      valueHierarchy.hasChildSelected = false;</span>
<span class="cstat-no" title="statement not covered" >      this.unflagParentForSelection(valueHierarchy);</span>
<span class="cstat-no" title="statement not covered" >      if (deselectChilds) {</span>
<span class="cstat-no" title="statement not covered" >        _.each(valueHierarchy.childs, <span class="fstat-no" title="function not covered" >(child)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          let childInHierarchy = this.getValueFromHierarchy(child.facetValue)</span>
<span class="cstat-no" title="statement not covered" >          childInHierarchy.hasChildSelected = false;</span>
<span class="cstat-no" title="statement not covered" >          this.deselectValue(child.facetValue);</span>
        })
      }
    })
...
&nbsp;
  private placeChildsUnderTheirParent(hierarchy: IValueHierarchy, hierarchyElement: HTMLElement) {
    _.each(hierarchy.childs.reverse(), (child) =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.getValueHierarchy(child.facetValue.value)) {
...
&nbsp;
    this.topLevelHierarchy = _.chain(this.values.getAll())
      .filter((value: FacetValue) =&gt; {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (fromHierarchy) {
...
&nbsp;
  private deselectChilds(parent: IValueHierarchy, children: IValueHierarchy[]) {
    ...
    this.deselectMultipleValues(_.map(children, <span class="fstat-no" title="function not covered" >(child)</span> =&gt; {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private getFacetValueFromHierarchy(value: any)</span>: FacetValue {
<span class="cstat-no" title="statement not covered" >    return this.getValueFromHierarchy(value).facetValue;</span>
  }
&nbsp;
