...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/CardActionBar/CardActionBar.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/CardActionBar/CardActionBar.ts</span></h1>
    <h2>
        ...
        Lines: <span class="metric">88.89% <small>(40 / 45)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/CardActionBar/</a> &#187; CardActionBar.ts</div>
</div>
<div class="body">
...
&nbsp;
  ...
  constructor(public element: HTMLElement, public options?: ICardActionBarOptions, bindings?: IComponentBindings, public result?: IQueryResult) {
    super(element, CardActionBar.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
&nbsp;
    if (this.options.hidden) {
      ...
      this.bindEvents();
&nbsp;
      _.forEach($$(this.element).findAll('*'), <span class="fstat-no" title="function not covered" >(elem: HTMLElement)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >        if (elem.hasAttribute('tabindex') &amp;&amp; elem.getAttribute('tabindex') == '0') {</span>
<span class="cstat-no" title="statement not covered" >          this.removedTabIndexElements.push(elem);</span>
<span class="cstat-no" title="statement not covered" >          elem.removeAttribute('tabindex');</span>
        }
      });
&nbsp;
    } else {
...
&nbsp;
  ...
  public show() {
    ...
    _.forEach(this.removedTabIndexElements, <span class="fstat-no" title="function not covered" >(e: Element)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      e.setAttribute('tabindex', '0');</span>
    });
  }
&nbsp;
  /**
  ...
  public hide() {
    ...
    _.forEach(this.removedTabIndexElements, <span class="fstat-no" title="function not covered" >(e: Element)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      e.removeAttribute('tabindex');</span>
    });
  }
&nbsp;
  private bindEvents() {
...
&nbsp;
  private appendArrow() {
    ...
    this.bind.on(this.arrowContainer, 'keyup', KeyboardUtils.keypressAction(KEYBOARD.ENTER, <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.show())</span>);
