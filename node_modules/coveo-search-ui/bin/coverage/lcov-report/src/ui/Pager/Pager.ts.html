...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">90.3% <small>(149 / 165)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">82.86% <small>(29 / 35)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">68.75% <small>(22 / 32)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">91.95% <small>(137 / 149)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
          ((pageNumber: number) =&gt; {
            $$(listItem).on('click', <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >              this.handleClickPage(pageNumber);</span>
            })
          })(i);
&nbsp;
