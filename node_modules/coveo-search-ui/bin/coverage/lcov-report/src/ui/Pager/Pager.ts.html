...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/Pager/Pager.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/Pager/Pager.ts</span></h1>
    <h2>
        Statements: <span class="metric">90.36% <small>(150 / 166)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">81.08% <small>(30 / 37)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">68.75% <small>(22 / 32)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">92.62% <small>(138 / 149)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/Pager/</a> &#187; Pager.ts</div>
</div>
<div class="body">
...
319
320
321</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
&nbsp;
  ...
  constructor(public element: HTMLElement, public options?: IPagerOptions, bindings?: IComponentBindings) {
    super(element, Pager.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
&nbsp;
    if (this.options.maxNumberOfPages == null) {
      this.options.maxNumberOfPages = 1000 /
        (this.queryController.options.resultsPerPage &gt; 0 ? this.queryController.options.resultsPerPage : <span class="branch-1 cbranch-no" title="branch not covered" >10)</span>;
    }
&nbsp;
    ...
    this.bind.onRootElement(QueryEvents.queryError, <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.handleQueryError())</span>;
    this.bind.onRootElement(QueryEvents.noResults, <span class="fstat-no" title="function not covered" >(args: INoResultsEventArgs)</span> =&gt; <span class="cstat-no" title="statement not covered" >this.handleNoResults(args))</span>;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private handleQueryError() {</span>
<span class="cstat-no" title="statement not covered" >    this.reset();</span>
  }
&nbsp;
  private handleQuerySuccess(data: IQuerySuccessEventArgs) {
    this.reset();
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.ignoreNextQuerySuccess) {
<span class="cstat-no" title="statement not covered" >      this.ignoreNextQuerySuccess = false;</span>
    } else {
...
&nbsp;
          ((pageNumber: number) =&gt; {
            let clickAction = <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.handleClickPage(pageNumber);</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private handleNoResults(data: INoResultsEventArgs)</span> {
<span class="cstat-no" title="statement not covered" >    var lastValidPage = this.computePagerBoundary(data.results.totalCountFiltered, data.results.totalCount).lastResultPage;</span>
<span class="cstat-no" title="statement not covered" >    if (this.currentPage &gt; lastValidPage) {</span>
<span class="cstat-no" title="statement not covered" >      this.ignoreNextQuerySuccess = true;</span>
<span class="cstat-no" title="statement not covered" >      this.setPage(lastValidPage);</span>
    }
  }
&nbsp;
  private reset() {
...
&nbsp;
  private renderNavigationButton(pagerBoundary: { start: number; end: number; lastResultPage: number; currentPage: number; }, list: HTMLElement) {
    if (this.currentPage &gt; 1) {
      ...
      $$(previous).on('click', <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.handleClickPrevious())</span>;
      this.list.insertBefore(previous, this.list.firstChild);
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.currentPage &lt; pagerBoundary.lastResultPage) {
      ...
      $$(next).on('click', <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.handleClickNext())</span>;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private handleClickPage(pageNumber: number)</span> {
<span class="cstat-no" title="statement not covered" >    Assert.exists(pageNumber);</span>
<span class="cstat-no" title="statement not covered" >    this.setPage(pageNumber);</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private handleClickPrevious() {</span>
<span class="cstat-no" title="statement not covered" >    this.previousPage();</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private handleClickNext() {</span>
<span class="cstat-no" title="statement not covered" >    this.nextPage();</span>
  }
&nbsp;
