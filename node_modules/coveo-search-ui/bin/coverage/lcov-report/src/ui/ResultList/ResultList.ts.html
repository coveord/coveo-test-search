...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">93.21% <small>(302 / 324)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">79.79% <small>(75 / 94)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">91.55% <small>(65 / 71)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">93.29% <small>(278 / 298)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
712
713
714</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  private static getDefaultTemplate(e: HTMLElement): Template {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (template != null) {
...
&nbsp;
  private static loadTemplatesFromCache(): Template {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (pageTemplateNames.length &gt; 0) {
<span class="cstat-no" title="statement not covered" >      return new TemplateList(_.compact(_.map(pageTemplateNames, <span class="fstat-no" title="function not covered" >(templateName)</span> =&gt; <span class="cstat-no" title="statement not covered" >TemplateCache.getTemplate(templateName))</span>));</span>
    }
&nbsp;
    return null;
  }
...
&nbsp;
  ...
  constructor(public element: HTMLElement, public options?: IResultListOptions, public bindings?: IComponentBindings, elementClassId: string = ResultList.ID) {
    super(element, elementClassId, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
&nbsp;
    if (this.options.enableInfiniteScroll) {
      ...
      this.bind.on(&lt;HTMLElement&gt;this.options.infiniteScrollContainer, 'scroll', <span class="fstat-no" title="function not covered" >(e: Event)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >        this.successiveScrollCount = 0;</span>
<span class="cstat-no" title="statement not covered" >        this.handleScrollOfResultList();</span>
      });
    }
...
&nbsp;
    ...
    if (this.options.resultTemplate instanceof TemplateList) {
      _.each((&lt;TemplateList&gt;this.options.resultTemplate).templates, (tmpl: Template) =&gt; {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!tmpl.layout) {
...
&nbsp;
  private scrollBackToTop() {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.options.infiniteScrollContainer instanceof Window) {
      let win = &lt;Window&gt;this.options.infiniteScrollContainer;
      win.scrollTo(0, 0);
    } else {
<span class="cstat-no" title="statement not covered" >      let el = &lt;HTMLElement&gt;this.options.infiniteScrollContainer;</span>
<span class="cstat-no" title="statement not covered" >      el.scrollTop = 0;</span>
    }
  }
&nbsp;
...
&nbsp;
  private handleBuildingQuery(args: IBuildingQueryEventArgs) {
    ...
    if (this.options.autoSelectFieldsToInclude) {
      ...
      const otherFields = _.flatten(_.map(otherResultListsElements, <span class="fstat-no" title="function not covered" >(otherResultListElement)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >        return (&lt;ResultList&gt;get(otherResultListElement)).getAutoSelectedFieldsToInclude();</span>
      }));
&nbsp;
...
&nbsp;
  private handleChangeLayout(args: IChangeLayoutEventArgs) {
    if (args.layout === this.options.layout) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (args.results) {
        Defer.defer(() =&gt; {
...
<span class="cstat-no" title="statement not covered" >    let el = &lt;HTMLElement&gt;this.options.infiniteScrollContainer;</span>
<span class="cstat-no" title="statement not covered" >    let elementHeight = el.clientHeight;</span>
<span class="cstat-no" title="statement not covered" >    let scrollHeight = el.scrollHeight;</span>
<span class="cstat-no" title="statement not covered" >    let bottomPosition = el.scrollTop + elementHeight;</span>
...
&nbsp;
  private hideWaitingAnimationForInfiniteScrolling() {
    let spinner = $$(this.options.waitAnimationContainer).find('.coveo-loading-spinner');
    <span class="missing-if-branch" title="else path not taken" >E</span>if (spinner) {
      $$(spinner).detach();
    }
  }
}
