...
<div class="header high">
    ...
    <h2>
        ...
        Lines: <span class="metric">95.24% <small>(60 / 63)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
  private static isPartialMatch(suggestion: IRevealQuerySuggestCompletion) {
    ...
    return _.every(_.last(parts, _.indexOf(parts, firstFail) - parts.length), <span class="fstat-no" title="function not covered" >(part: string[])</span> =&gt; <span class="cstat-no" title="statement not covered" >part[1] != null)</span>;
  }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (text.length == 0) {
<span class="cstat-no" title="statement not covered" >      return null;</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.cache[text] != null) {
...
&nbsp;
    ...
    promise.catch(<span class="fstat-no" title="function not covered" >() =&gt; {</span>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (language) {
