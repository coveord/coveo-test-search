...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/Analytics/LiveAnalyticsClient.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/Analytics/LiveAnalyticsClient.ts</span></h1>
    <h2>
        Statements: <span class="metric">85.71% <small>(162 / 189)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">48.33% <small>(29 / 60)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">80.56% <small>(29 / 36)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">84.66% <small>(149 / 176)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/Analytics/</a> &#187; LiveAnalyticsClient.ts</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    return this.endpoint.getCurrentVisitId();</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  public getCurrentVisitIdPromise(): Promise&lt;string&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return this.endpoint.getCurrentVisitIdPromise();</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  public getCurrentEventCause() {</span>
<span class="cstat-no" title="statement not covered" >    if (this.pendingSearchEvent != null) {</span>
<span class="cstat-no" title="statement not covered" >      return this.pendingSearchEvent.getEventCause();</span>
    }
<span class="cstat-no" title="statement not covered" >    if (this.pendingSearchAsYouTypeSearchEvent != null) {</span>
<span class="cstat-no" title="statement not covered" >      return this.pendingSearchAsYouTypeSearchEvent.getEventCause();</span>
    }
<span class="cstat-no" title="statement not covered" >    return null;</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  public getCurrentEventMeta() {</span>
<span class="cstat-no" title="statement not covered" >    if (this.pendingSearchEvent != null) {</span>
<span class="cstat-no" title="statement not covered" >      return this.pendingSearchEvent.getEventMeta();</span>
    }
<span class="cstat-no" title="statement not covered" >    if (this.pendingSearchAsYouTypeSearchEvent != null) {</span>
<span class="cstat-no" title="statement not covered" >      return this.pendingSearchAsYouTypeSearchEvent.getEventMeta();</span>
    }
<span class="cstat-no" title="statement not covered" >    return null;</span>
  }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  public getTopQueries(params: ITopQueries)</span>: Promise&lt;string[]&gt; {
<span class="cstat-no" title="statement not covered" >    return this.endpoint.getTopQueries(params);</span>
  }
&nbsp;
...
&nbsp;
  public cancelAllPendingEvents() {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.pendingSearchAsYouTypeSearchEvent) {
<span class="cstat-no" title="statement not covered" >      this.pendingSearchAsYouTypeSearchEvent.cancel();</span>
<span class="cstat-no" title="statement not covered" >      this.pendingSearchAsYouTypeSearchEvent = null;</span>
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.pendingSearchEvent) {
...
&nbsp;
  public getPendingSearchEvent(): PendingSearchEvent {
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (this.pendingSearchAsYouTypeSearchEvent) {
      return this.pendingSearchAsYouTypeSearchEvent;
    }
<span class="cstat-no" title="statement not covered" >    return null;</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  public warnAboutSearchEvent() {</span>
<span class="cstat-no" title="statement not covered" >    if (_.isUndefined(this.pendingSearchEvent) &amp;&amp; _.isUndefined(this.pendingSearchAsYouTypeSearchEvent)) {</span>
<span class="cstat-no" title="statement not covered" >      this.logger.warn('A search was triggered, but no analytics event was logged. If you wish to have consistent analytics data, consider logging a search event using the methods provided by the framework', 'https://developers.coveo.com/x/TwA5');</span>
<span class="cstat-no" title="statement not covered" >      if (window['console'] &amp;&amp; console.trace) {</span>
...
&nbsp;
  private pushCustomEvent(actionCause: IAnalyticsActionCause, metaObject: IChangeableAnalyticsMetaObject, element?: HTMLElement) {
    ...
    Defer.defer(() =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.sendToCloud) {
...
&nbsp;
  private pushSearchEvent(actionCause: IAnalyticsActionCause, metaObject: IChangeableAnalyticsMetaObject) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.pendingSearchEvent &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.pendingSearchEvent.getEventCause() !== actionCause.name)</span> {
<span class="cstat-no" title="statement not covered" >      this.pendingSearchEvent.stopRecording();</span>
<span class="cstat-no" title="statement not covered" >      this.pendingSearchEvent = null;</span>
    }
    this.checkToSendAnyPendingSearchAsYouType(actionCause);
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.pendingSearchEvent) {
...
&nbsp;
  private buildAnalyticsEvent(actionCause: IAnalyticsActionCause, metaObject: IChangeableAnalyticsMetaObject): IAnalyticsEvent {
    return {
      ...
      customData: _.keys(metaObject).length &gt; 0 ? metaObject : <span class="branch-1 cbranch-no" title="branch not covered" >undefined,</span>
...
&nbsp;
  private buildClickEvent(actionCause: IAnalyticsActionCause, metaObject: IChangeableAnalyticsMetaObject, result: IQueryResult, element: HTMLElement): IClickEvent {
    return this.merge&lt;IClickEvent&gt;(this.buildAnalyticsEvent(actionCause, metaObject), {
      ...
      splitTestRunName: this.splitTestRunName || <span class="branch-1 cbranch-no" title="branch not covered" >result.splitTestRun,</span>
      splitTestRunVersion: this.splitTestRunVersion || (<span class="branch-1 cbranch-no" title="branch not covered" >result.splitTestRun != undefined ? result.pipeline : undefined)</span>,
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (_.keys(metaDataAsString).length &gt; 0) {
<span class="cstat-no" title="statement not covered" >      this.logger.warn('Using deprecated \'metaDataAsString\' key to log custom analytics data. Custom meta should now be put at the root of the object.');</span>
<span class="cstat-no" title="statement not covered" >      _.extend(event.customData, metaDataAsString);</span>
    }
    delete event.customData['metaDataAsString'];
&nbsp;
    var metaDataAsNumber = event.customData['metaDataAsNumber'];
    <span class="missing-if-branch" title="if path not taken" >I</span>if (_.keys(metaDataAsNumber).length &gt; 0) {
<span class="cstat-no" title="statement not covered" >      this.logger.warn('Using deprecated \'metaDataAsNumber\' key to log custom analytics data. Custom meta should now be put at the root of the object.');</span>
<span class="cstat-no" title="statement not covered" >      _.extend(event.customData, metaDataAsNumber);</span>
    }
