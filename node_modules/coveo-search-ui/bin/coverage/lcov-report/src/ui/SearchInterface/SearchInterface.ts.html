...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/SearchInterface/SearchInterface.ts</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">src/ui/SearchInterface/SearchInterface.ts</span></h1>
    <h2>
        Statements: <span class="metric">69.97% <small>(212 / 303)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">45.57% <small>(72 / 158)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">60.34% <small>(35 / 58)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">73% <small>(192 / 263)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/SearchInterface/</a> &#187; SearchInterface.ts</div>
</div>
<div class="body">
...
639
640
641</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {SearchEndpoint} from '../../rest/SearchEndpoint';
...
export class SearchInterface extends RootComponent {
  ...
  static options: ISearchInterfaceOptions = {
    ...
    endpoint: ComponentOptions.buildCustomOption(<span class="fstat-no" title="function not covered" >(endpoint)</span> =&gt; <span class="cstat-no" title="statement not covered" >endpoint != null &amp;&amp; endpoint in SearchEndpoint.endpoints ? SearchEndpoint.endpoints[endpoint] : null,</span> { defaultFunction: () =&gt; SearchEndpoint.endpoints['default'] }),
    /**
...
<span class="cstat-no" title="statement not covered" >      $$(document.body).addClass('coveo-mobile-device');</span>
    }
&nbsp;
...
&nbsp;
    ...
    $$(this.element).on(eventNameQuickview, <span class="fstat-no" title="function not covered" >(e, args)</span> =&gt; <span class="cstat-no" title="statement not covered" >this.handleQuickviewChanged(args))</span>;
...
&nbsp;
  protected initializeAnalytics(): IAnalyticsClient {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (analyticsRef) {
      return analyticsRef.create(this.element, this.analyticsOptions);
    }
<span class="cstat-no" title="statement not covered" >    return new NoopAnalyticsClient();</span>
  }
&nbsp;
...
&nbsp;
    ...
    if (args.tg !== undefined) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (tg != args.tg) {
<span class="cstat-no" title="statement not covered" >        args.t = args.t || QueryStateModel.defaultAttributes.t;</span>
<span class="cstat-no" title="statement not covered" >        args.sort = args.sort || QueryStateModel.defaultAttributes.sort;</span>
<span class="cstat-no" title="statement not covered" >        tg = args.tg;</span>
      }
    }
&nbsp;
    if (args.t !== undefined) {
      args.t = this.getTabId(tg, args.t);
      <span class="missing-if-branch" title="if path not taken" >I</span>if (t != args.t) {
<span class="cstat-no" title="statement not covered" >        args.sort = args.sort || QueryStateModel.defaultAttributes.sort;</span>
<span class="cstat-no" title="statement not covered" >        t = args.t;</span>
      }
    }
&nbsp;
...
&nbsp;
  private getTabGroupId(tabGroupId: string) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (tabGroupRef) {
<span class="cstat-no" title="statement not covered" >      let tabGroups = this.getComponents&lt;any&gt;(tabGroupRef.ID);</span>
      // check if the tabgroup is correct
<span class="cstat-no" title="statement not covered" >      if (tabGroupId != QueryStateModel.defaultAttributes.tg &amp;&amp; _.any(tabGroups, <span class="fstat-no" title="function not covered" >(tabGroup: any)</span> =&gt; <span class="cstat-no" title="statement not covered" >!tabGroup.disabled &amp;&amp; tabGroupId == tabGroup.options.id)</span>) {</span>
<span class="cstat-no" title="statement not covered" >        return tabGroupId;</span>
      }
      // select the first tabGroup
<span class="cstat-no" title="statement not covered" >      if (tabGroups.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >        return tabGroups[0].options.id</span>
      }
    }
...
&nbsp;
  private getTabId(tabGroupId: string, tabId: string) {
    ...
    let tabGroupRef = BaseComponent.getComponentRef('TabGroup');
    <span class="missing-if-branch" title="else path not taken" >E</span>if (tabRef) {
      let tabs = this.getComponents&lt;any&gt;(tabRef.ID);
      <span class="missing-if-branch" title="if path not taken" >I</span>if (tabGroupRef) {
        // if has a tabGroup
<span class="cstat-no" title="statement not covered" >        if (tabGroupId != QueryStateModel.defaultAttributes.tg) {</span>
<span class="cstat-no" title="statement not covered" >          let tabGroups = this.getComponents&lt;any&gt;(tabGroupRef.ID);</span>
<span class="cstat-no" title="statement not covered" >          let tabGroup = _.find(tabGroups, <span class="fstat-no" title="function not covered" >(tabGroup: any)</span> =&gt; <span class="cstat-no" title="statement not covered" >tabGroupId == tabGroup.options.id)</span>;</span>
          // check if the tabgroup contain this tab
<span class="cstat-no" title="statement not covered" >          if (tabId != QueryStateModel.defaultAttributes.t &amp;&amp; _.any(tabs, <span class="fstat-no" title="function not covered" >(tab: any)</span> =&gt; <span class="cstat-no" title="statement not covered" >tabId == tab.options.id &amp;&amp; tabGroup.isElementIncludedInTabGroup(tab.element))</span>) {</span>
<span class="cstat-no" title="statement not covered" >            return tabId;</span>
          }
          // select the first tab in the tabGroup
<span class="cstat-no" title="statement not covered" >          let tab = _.find(tabs, <span class="fstat-no" title="function not covered" >(tab: any)</span> =&gt; <span class="cstat-no" title="statement not covered" >tabGroup.isElementIncludedInTabGroup(tab.element))</span>;</span>
<span class="cstat-no" title="statement not covered" >          if (tab != null) {</span>
<span class="cstat-no" title="statement not covered" >            return tab.options.id;</span>
          }
<span class="cstat-no" title="statement not covered" >          return QueryStateModel.defaultAttributes.t;</span>
        }
      }
      // check if the tab is correct
      <span class="missing-if-branch" title="if path not taken" >I</span>if (tabId != QueryStateModel.defaultAttributes.t &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >_.any(tabs, <span class="fstat-no" title="function not covered" >(tab: any)</span> =&gt; <span class="cstat-no" title="statement not covered" >tabId == tab.options.id)</span>)</span> {
<span class="cstat-no" title="statement not covered" >        return tabId;</span>
      }
      // select the first tab
      <span class="missing-if-branch" title="if path not taken" >I</span>if (tabs.length &gt; 0) {
<span class="cstat-no" title="statement not covered" >        return tabs[0].options.id</span>
      }
    }
...
&nbsp;
  private getSort(tabId: string, sortId: string) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (sortRef) {
      let sorts = this.getComponents&lt;any&gt;(sortRef.ID);
      // if has a selected tab
      let tabRef = BaseComponent.getComponentRef('Tab');
      <span class="missing-if-branch" title="else path not taken" >E</span>if (tabRef) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (tabId != QueryStateModel.defaultAttributes.t) {
<span class="cstat-no" title="statement not covered" >          let tabs = this.getComponents&lt;any&gt;(tabRef.ID);</span>
<span class="cstat-no" title="statement not covered" >          let tab = _.find(tabs, <span class="fstat-no" title="function not covered" >(tab: any)</span> =&gt; <span class="cstat-no" title="statement not covered" >tabId == tab.options.id)</span>;</span>
<span class="cstat-no" title="statement not covered" >          let sortCriteria = tab.options.sort;</span>
&nbsp;
          // check if the tab contain this sort
<span class="cstat-no" title="statement not covered" >          if (sortId != QueryStateModel.defaultAttributes.sort &amp;&amp; _.any(sorts, <span class="fstat-no" title="function not covered" >(sort: any)</span> =&gt; <span class="cstat-no" title="statement not covered" >tab.isElementIncludedInTab(sort.element) &amp;&amp; sort.match(sortId))</span>) {</span>
<span class="cstat-no" title="statement not covered" >            return sortId;</span>
          } else <span class="cstat-no" title="statement not covered" >if (sortCriteria != null) {</span>
            // if not and tab.options.sort is set apply it
<span class="cstat-no" title="statement not covered" >            return sortCriteria.toString();</span>
          }
          // select the first sort in the tab
<span class="cstat-no" title="statement not covered" >          let sort = _.find(sorts, <span class="fstat-no" title="function not covered" >(sort: any)</span> =&gt; <span class="cstat-no" title="statement not covered" >tab.isElementIncludedInTab(sort.element))</span>;</span>
<span class="cstat-no" title="statement not covered" >          if (sort != null) {</span>
<span class="cstat-no" title="statement not covered" >            return sort.options.sortCriteria[0].toString();</span>
          }
<span class="cstat-no" title="statement not covered" >          return QueryStateModel.defaultAttributes.sort;</span>
        }
      }
      // check if the sort is correct
      <span class="missing-if-branch" title="if path not taken" >I</span>if (sortId != QueryStateModel.defaultAttributes.sort &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >_.any(sorts, <span class="fstat-no" title="function not covered" >(sort: any)</span> =&gt; <span class="cstat-no" title="statement not covered" >sort.match(sortId))</span>)</span> {
<span class="cstat-no" title="statement not covered" >        return sortId;</span>
      }
      // select the first sort
      <span class="missing-if-branch" title="if path not taken" >I</span>if (sorts.length &gt; 0) {
<span class="cstat-no" title="statement not covered" >        return sorts[0].options.sortCriteria[0].toString();</span>
      }
    }
...
&nbsp;
  private getQuickview(quickviewId: string) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (quickviewRef) {
      let quickviews = this.getComponents&lt;any&gt;(quickviewRef.ID);
      <span class="missing-if-branch" title="if path not taken" >I</span>if (_.any(quickviews, <span class="fstat-no" title="function not covered" >(quickview: any)</span> =&gt; <span class="cstat-no" title="statement not covered" >quickview.getHashId() == quickviewId)</span>) {
<span class="cstat-no" title="statement not covered" >        return quickviewId;</span>
      }
    }
    return QueryStateModel.defaultAttributes.quickview;
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private handleQuickviewChanged(args: IAttributeChangedEventArg)</span> {
<span class="cstat-no" title="statement not covered" >    let quickviewRef = BaseComponent.getComponentRef('Quickview');</span>
<span class="cstat-no" title="statement not covered" >    if (quickviewRef) {</span>
<span class="cstat-no" title="statement not covered" >      let quickviews = this.getComponents&lt;any&gt;(quickviewRef.ID);</span>
<span class="cstat-no" title="statement not covered" >      if (args.value != '') {</span>
<span class="cstat-no" title="statement not covered" >        let quickviewsPartition = _.partition(quickviews, <span class="fstat-no" title="function not covered" >(quickview)</span> =&gt; <span class="cstat-no" title="statement not covered" >quickview.getHashId() == args.value)</span></span>
<span class="cstat-no" title="statement not covered" >        if (quickviewsPartition[0].length != 0) {</span>
<span class="cstat-no" title="statement not covered" >          _.first(quickviewsPartition[0]).open();</span>
<span class="cstat-no" title="statement not covered" >          _.forEach(_.tail(quickviewsPartition[0]), <span class="fstat-no" title="function not covered" >(quickview)</span> =&gt; <span class="cstat-no" title="statement not covered" >quickview.close())</span>;</span>
        }
<span class="cstat-no" title="statement not covered" >        _.forEach(quickviewsPartition[1], <span class="fstat-no" title="function not covered" >(quickview)</span> =&gt; <span class="cstat-no" title="statement not covered" >quickview.close())</span>;</span>
      } else {
<span class="cstat-no" title="statement not covered" >        _.forEach(quickviews, <span class="fstat-no" title="function not covered" >(quickview)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          quickview.close()</span>
        });
      }
    }
  }
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!Utils.isNullOrUndefined(this.options.resultsPerPage)) {
      data.queryBuilder.numberOfResults = this.options.resultsPerPage;
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!Utils.isNullOrUndefined(this.options.excerptLength)) {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (Utils.isNonEmptyString(this.options.timezone)) {
...
&nbsp;
  private handleQuerySuccess(data: IQuerySuccessEventArgs) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (resultsHeader) {
<span class="cstat-no" title="statement not covered" >      $$(resultsHeader).removeClass('coveo-query-error');</span>
    }
  }
&nbsp;
  private handleQueryError(data: IQueryErrorEventArgs) {
    ...
    let resultsHeader = $$(this.element).find('.coveo-results-header');
    <span class="missing-if-branch" title="if path not taken" >I</span>if (resultsHeader) {
<span class="cstat-no" title="statement not covered" >      $$(resultsHeader).addClass('coveo-query-error');</span>
    }
  }
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (resultsHeader) {
<span class="cstat-no" title="statement not covered" >      $$(resultsHeader).toggleClass(cssClass, toggle &amp;&amp; !this.queryStateModel.atLeastOneFacetIsActive());</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (facetSearchs &amp;&amp; facetSearchs.length &gt; 0) {
<span class="cstat-no" title="statement not covered" >      _.each(facetSearchs, <span class="fstat-no" title="function not covered" >(facetSearch)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        $$(facetSearch).toggleClass(cssClass, toggle &amp;&amp; !this.queryStateModel.atLeastOneFacetIsActive());</span>
      })
    }
  }
}
...
&nbsp;
<span class="fstat-no" title="function not covered" >  constructor(public <span class="cstat-no" title="statement not covered" >element: HTMLElement,</span> public <span class="cstat-no" title="statement not covered" >options?: IStandaloneSearchInterfaceOptions,</span> public <span class="cstat-no" title="statement not covered" >analyticsOptions?,</span> <span class="cstat-no" title="statement not covered" >_window = window)</span></span> {
<span class="cstat-no" title="statement not covered" >    super(element, ComponentOptions.initComponentOptions(element, StandaloneSearchInterface, options), analyticsOptions, _window);</span>
<span class="cstat-no" title="statement not covered" >    $$(this.root).on(QueryEvents.newQuery, <span class="fstat-no" title="function not covered" >(e: Event, args: INewQueryEventArgs)</span> =&gt; <span class="cstat-no" title="statement not covered" >this.handleRedirect(e, args))</span>;</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  public handleRedirect(e: Event, data: INewQueryEventArgs)</span> {
&nbsp;
<span class="cstat-no" title="statement not covered" >    let dataToSendOnBeforeRedirect: IBeforeRedirectEventArgs = {</span>
      searchPageUri: this.options.searchPageUri,
      cancel: false
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    $$(this.root).trigger(StandaloneSearchInterfaceEvents.beforeRedirect, dataToSendOnBeforeRedirect);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (dataToSendOnBeforeRedirect.cancel) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    data.cancel = true;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!this.searchboxIsEmpty() || this.options.redirectIfEmpty) {</span>
<span class="cstat-no" title="statement not covered" >      this.redirectToSearchPage(dataToSendOnBeforeRedirect.searchPageUri);</span>
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  public redirectToSearchPage(searchPage: string)</span> {
<span class="cstat-no" title="statement not covered" >    let stateValues = this.queryStateModel.getAttributes();</span>
<span class="cstat-no" title="statement not covered" >    let uaCausedBy = this.usageAnalytics.getCurrentEventCause();</span>
<span class="cstat-no" title="statement not covered" >    if (uaCausedBy != null) {</span>
<span class="cstat-no" title="statement not covered" >      stateValues['firstQueryCause'] = uaCausedBy;</span>
    }
<span class="cstat-no" title="statement not covered" >    let uaMeta = this.usageAnalytics.getCurrentEventMeta();</span>
<span class="cstat-no" title="statement not covered" >    if (uaMeta != null) {</span>
<span class="cstat-no" title="statement not covered" >      stateValues['firstQueryMeta'] = uaMeta;</span>
    }
<span class="cstat-no" title="statement not covered" >    window.location.href = searchPage + '#' + HashUtils.encodeValues(stateValues);</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private searchboxIsEmpty(): boolean {</span>
<span class="cstat-no" title="statement not covered" >    return Utils.isEmptyString(this.queryStateModel.get(QueryStateModel.attributesEnum.q))</span>
  }
}
&nbsp;</pre></td></tr>
</table></pre>
