...
<div class="header medium">
    ...
    <h2>
        Statements: <span class="metric">78.03% <small>(245 / 314)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">52.98% <small>(89 / 168)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">69.49% <small>(41 / 59)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">80.22% <small>(219 / 273)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
866
867
868</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
&nbsp;
  ...
  constructor(public element: HTMLElement, public options?: ISearchInterfaceOptions, public analyticsOptions?, _window = window) {
    super(element, SearchInterface.ID)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if ((&lt;any&gt;fastclick).attach) {
...
&nbsp;
  constructor(public element: HTMLElement, public options?: IStandaloneSearchInterfaceOptions, public analyticsOptions?, public _window = window) {
    super(element, ComponentOptions.initComponentOptions(element, StandaloneSearchInterface, options), analyticsOptions, _window)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (dataToSendOnBeforeRedirect.cancel) {
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
    data.cancel = true;
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.searchboxIsEmpty() || this.options.redirectIfEmpty) {
