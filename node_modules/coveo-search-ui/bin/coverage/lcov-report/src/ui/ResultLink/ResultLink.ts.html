...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/ResultLink/ResultLink.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/ResultLink/ResultLink.ts</span></h1>
    <h2>
        Statements: <span class="metric">86.06% <small>(142 / 165)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">68.47% <small>(76 / 111)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">83.33% <small>(25 / 30)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">86% <small>(129 / 150)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/ResultLink/</a> &#187; ResultLink.ts</div>
</div>
<div class="body">
...
498
499
500</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">615</span>
<span class="cline-any cline-yes">598</span>
...
&nbsp;
     ...
     * ```
     */
    onClick: ComponentOptions.buildCustomOption&lt;(e: Event, result: IQueryResult) =&gt; any&gt;(<span class="fstat-no" title="function not covered" >() =&gt; {</span>
...
&nbsp;
  ...
  constructor(public element: HTMLElement, public options: IResultLinkOptions, public bindings?: IResultsComponentBindings, public result?: IQueryResult, public os?: OS_NAME) {
    super(element, ResultLink.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
    ...
    this.result = result || <span class="branch-1 cbranch-no" title="branch not covered" >this.resolveResult();</span>
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.openQuickview == null) {
<span class="cstat-no" title="statement not covered" >      this.options.openQuickview = result.raw['connectortype'] == 'ExchangeCrawler' &amp;&amp; DeviceUtils.isMobileDevice();</span>
    }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.quickviewShouldBeOpened()) {
...
&nbsp;
    ...
    if (/^\s*$/.test(this.element.innerHTML)) {
      if (!this.options.titleTemplate) {
        ...
        this.element.innerHTML = newTitle ? StreamHighlightUtils.highlightStreamText(newTitle, this.result.termsToHighlight, this.result.phrasesToHighlight) : <span class="branch-1 cbranch-no" title="branch not covered" >this.result.clickUri;</span>
      }
    }
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  public openLink(<span class="cstat-no" title="statement not covered" >logAnalytics = true)</span></span> {
<span class="cstat-no" title="statement not covered" >    if (logAnalytics) {</span>
<span class="cstat-no" title="statement not covered" >      this.logOpenDocument();</span>
    }
<span class="cstat-no" title="statement not covered" >    window.location.href = this.getResultUri();</span>
  }
&nbsp;
  /**
   ...
   * @param logAnalytics If true, the method will take care of logging an analytic event.
   */
  public openLinkInNewWindow(<span class="missing-if-branch" title="else path not taken" >E</span>logAnalytics = true) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (logAnalytics) {
      this.logOpenDocument();
    }
...
&nbsp;
   ...
   * @param logAnalytics If true, the method will take care of logging an analytic event.
   */
<span class="fstat-no" title="function not covered" >  public openLinkInOutlook(<span class="cstat-no" title="statement not covered" >logAnalytics = true)</span></span> {
<span class="cstat-no" title="statement not covered" >    if (this.hasOutlookField()) {</span>
<span class="cstat-no" title="statement not covered" >      if (logAnalytics) {</span>
<span class="cstat-no" title="statement not covered" >        this.logOpenDocument();</span>
      }
<span class="cstat-no" title="statement not covered" >      this.openLink();</span>
    }
  }
&nbsp;
  /**
   ...
   * @param logAnalytics If true, the method will take care of logging an analytic event.
   */
  public openLinkAsConfigured(<span class="missing-if-branch" title="else path not taken" >E</span>logAnalytics = true) {
...
&nbsp;
  private bindOpenQuickviewIfNotUndefined() {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.quickviewShouldBeOpened()) {
<span class="cstat-no" title="statement not covered" >      this.toExecuteOnOpen = <span class="fstat-no" title="function not covered" >() =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >        $$(this.bindings.resultElement).trigger(ResultListEvents.openQuickview);</span>
      };
&nbsp;
<span class="cstat-no" title="statement not covered" >      $$(this.element).on('click', <span class="fstat-no" title="function not covered" >(e: Event)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        e.preventDefault();</span>
<span class="cstat-no" title="statement not covered" >        this.toExecuteOnOpen();</span>
      });
&nbsp;
...
&nbsp;
  private openLinkThatIsNotAnAnchor() {
    if (!this.elementIsAnAnchor()) {
      this.toExecuteOnOpen = () =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.alwaysOpenInNewWindow) {
<span class="cstat-no" title="statement not covered" >          if (this.options.openInOutlook) {</span>
<span class="cstat-no" title="statement not covered" >            this.openLinkInOutlook();</span>
          } else {
<span class="cstat-no" title="statement not covered" >            this.openLinkInNewWindow();</span>
          }
        } else {
          this.openLink();
        }
...
&nbsp;
  private setHrefIfNotAlready() {
    ...
    if (this.elementIsAnAnchor() &amp;&amp; !Utils.isNonEmptyString($$(this.element).getAttribute('href'))) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.alwaysOpenInNewWindow &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!(this.options.openInOutlook &amp;&amp; this.hasOutlookField()))</span> {
<span class="cstat-no" title="statement not covered" >        $$(this.element).setAttribute('target', '_blank');</span>
      }
      return true;
    } else {
      return false;
...
&nbsp;
  private setField() {
    let os = Utils.exists(this.os) ? this.os : <span class="branch-1 cbranch-no" title="branch not covered" >OSUtils.get();</span>
    if (os == OS_NAME.MACOSX &amp;&amp; this.hasOutlookField()) {
      this.options.field = '@outlookformacuri';
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (os == OS_NAME.WINDOWS &amp;&amp; this.hasOutlookField()) {
...
&nbsp;
  private hasOutlookField() {
    ...
    if (os == OS_NAME.MACOSX &amp;&amp; this.result.raw['outlookformacuri'] != undefined) {
      return true;
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (os == OS_NAME.WINDOWS &amp;&amp; this.result.raw['outlookuri'] != undefined) {
      return true;
    }
...
&nbsp;
  private quickviewShouldBeOpened() {
    return (this.options.openQuickview || this.isUriThatMustBeOpenedInQuickview()) &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >QueryUtils.hasHTMLVersion(this.result);</span>
  }
&nbsp;
  private parseStringTemplate(template: string): string {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!template) {
