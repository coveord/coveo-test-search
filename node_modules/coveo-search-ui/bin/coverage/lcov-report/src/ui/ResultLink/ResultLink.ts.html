...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">90.37% <small>(122 / 135)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">74.7% <small>(62 / 83)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">84.62% <small>(22 / 26)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">89.52% <small>(111 / 124)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.options.openQuickview == null) {
      this.options.openQuickview = result.raw['connectortype'] == 'ExchangeCrawler' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >DeviceUtils.isMobileDevice();</span>
    }
&nbsp;
...
&nbsp;
   ...
   * Opens the result
   */
<span class="fstat-no" title="function not covered" >  public openLink() {</span>
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  public openLinkInOutlook() {</span>
...
&nbsp;
  private parseHrefTemplate(): string {
    return this.options.hrefTemplate.replace(/\$\{(.*?)\}/g, (value: string) =&gt; {
      ...
      return newValue || <span class="branch-1 cbranch-no" title="branch not covered" >value;</span>
    });
  }
&nbsp;
