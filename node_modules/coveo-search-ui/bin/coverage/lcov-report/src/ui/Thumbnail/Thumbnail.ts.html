...
<div class="header high">
    ...
    <h2>
        ...
        Lines: <span class="metric">94.74% <small>(36 / 38)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.clickable) {
<span class="cstat-no" title="statement not covered" >      new ResultLink(this.element, this.options, this.bindings, this.result);</span>
    }
&nbsp;
&nbsp;
