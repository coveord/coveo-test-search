...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/Thumbnail/Thumbnail.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/Thumbnail/Thumbnail.ts</span></h1>
    <h2>
        Statements: <span class="metric">95.31% <small>(61 / 64)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">87.5% <small>(14 / 16)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">88.89% <small>(8 / 9)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">94.74% <small>(54 / 57)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/Thumbnail/</a> &#187; Thumbnail.ts</div>
</div>
<div class="body">
...
&nbsp;
  ...
  constructor(public element: HTMLElement, public options?: IThumbnailOptions, public bindings?: IResultsComponentBindings, public result?: IQueryResult) {
    super(element, Thumbnail.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        this.setEmptyThumbnailClass();</span>
      });
  }
&nbsp;
  private resizeContainingFieldTable() {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (closestFieldTableElement != null) {
<span class="cstat-no" title="statement not covered" >      let fieldTable = &lt;FieldTable&gt;get(closestFieldTableElement);</span>
<span class="cstat-no" title="statement not covered" >      fieldTable.updateToggleHeight();</span>
    }
  }
&nbsp;
