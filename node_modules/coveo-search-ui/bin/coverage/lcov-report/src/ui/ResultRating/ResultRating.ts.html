...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/ResultRating/ResultRating.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/ResultRating/ResultRating.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/ResultRating/</a> &#187; ResultRating.ts</div>
</div>
<div class="body">
...
&nbsp;
  ...
  constructor(public element: HTMLElement, public options?: IResultRatingOptions, public bindings?: IComponentBindings, public result?: IQueryResult) {
    super(element, ResultRating.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
&nbsp;
      if (this.bindings.searchInterface.options.enableCollaborativeRating) {
        star.on('click', <span class="fstat-no" title="function not covered" >(e)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >          let targetElement: HTMLElement = &lt;HTMLElement&gt;e.currentTarget;</span>
<span class="cstat-no" title="statement not covered" >          this.rateDocument(parseInt(targetElement.getAttribute('rating-value')));</span>
        });
&nbsp;
        star.on('mouseover', (e) =&gt; {
...
<span class="cstat-no" title="statement not covered" >        this.logger.error('An error occurred while rating the document');</span>
      });
  }
}
&nbsp;
