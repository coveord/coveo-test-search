...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/Base/QueryBuilder.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/Base/QueryBuilder.ts</span></h1>
    <h2>
        Statements: <span class="metric">100% <small>(61 / 61)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/Base/</a> &#187; QueryBuilder.ts</div>
</div>
<div class="body">
...
391
392
393</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {ExpressionBuilder} from './ExpressionBuilder';
...
&nbsp;
  public computeFieldsToInclude() {
    if (this.includeRequiredFields || this.fieldsToInclude != null) {
      return this.requiredFields.concat(this.fieldsToInclude || <span class="branch-1 cbranch-no" title="branch not covered" >[])</span>;
    } else {
      return null;
    }
  }
&nbsp;
  ...
  public addContextValue(key: string, value: any) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.context == null) {
      this.context = {};
    }
