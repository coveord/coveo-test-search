...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/Base/Component.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/Base/Component.ts</span></h1>
    <h2>
        Statements: <span class="metric">92.45% <small>(147 / 159)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">87.5% <small>(70 / 80)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">91.18% <small>(31 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">91.84% <small>(135 / 147)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/Base/</a> &#187; Component.ts</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1779</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1779</span>
<span class="cline-any cline-yes">1778</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1779</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">625</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1111</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1111</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">3974</span>
<span class="cline-any cline-yes">3974</span>
<span class="cline-any cline-yes">3974</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">3575</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4303</span>
<span class="cline-any cline-yes">4303</span>
<span class="cline-any cline-yes">892</span>
<span class="cline-any cline-yes">887</span>
...
&nbsp;
  public resolveUA(): IAnalyticsClient {
    ...
    return (searchInterface &amp;&amp; searchInterface.usageAnalytics) ? <span class="branch-0 cbranch-no" title="branch not covered" >searchInterface.usageAnalytics </span>: new NoopAnalyticsClient();
  }
&nbsp;
...
&nbsp;
  private initDebugInfo() {
    $$(this.element).on('dblclick', <span class="fstat-no" title="function not covered" >(e: MouseEvent)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      if (e.altKey) {</span>
<span class="cstat-no" title="statement not covered" >        var debugInfo = this.debugInfo();</span>
<span class="cstat-no" title="statement not covered" >        if (debugInfo != null) {</span>
<span class="cstat-no" title="statement not covered" >          $$(this.root).trigger(DebugEvents.showDebugPanel, this.debugInfo());</span>
        }
      }
    });
  }
...
&nbsp;
  static getResult(element: HTMLElement, <span class="missing-if-branch" title="else path not taken" >E</span>noThrow: boolean = false): IQueryResult {
...
&nbsp;
  ...
  public on(arg: any, event: string, handler: Function) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!JQueryUtils.getJQuery() || !JQueryUtils.isInstanceOfJQuery(arg)) {
      var htmlEl: HTMLElement = arg;
      $$(htmlEl).on(event, this.wrapToCallIfEnabled(handler));
    } else {
<span class="cstat-no" title="statement not covered" >      var jq: Dom = arg;</span>
<span class="cstat-no" title="statement not covered" >      jq.on(event, this.wrapToCallIfEnabled(handler));</span>
    }
  }
&nbsp;
  /**
  ...
  public one(arg: any, event: string, handler: Function) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (arg instanceof HTMLElement) {
      var htmlEl: HTMLElement = arg;
      $$(htmlEl).one(event, this.wrapToCallIfEnabled(handler));
    } else {
<span class="cstat-no" title="statement not covered" >      var jq: Dom = arg;</span>
<span class="cstat-no" title="statement not covered" >      jq.one(event, this.wrapToCallIfEnabled(handler));</span>
    }
  }
&nbsp;
  /**
...
&nbsp;
   ...
   * @param handler The handler to execute when the query state event is triggered.
   */
<span class="fstat-no" title="function not covered" >  public oneQueryState&lt;T&gt;(eventType: string, attribute?: string, handler?: (args: T) =&gt; any)</span> {
<span class="cstat-no" title="statement not covered" >    this.oneRootElement(this.getQueryStateEventName(eventType, attribute), handler);</span>
  }
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered" >        var jq: Dom = arg;</span>
<span class="cstat-no" title="statement not covered" >        jq.trigger(event, args);</span>
      }
    })(args);
  }
&nbsp;
    ...
    return (...args: any[]) =&gt; {
      if (!this.owner.disabled) {
        if (args &amp;&amp; args[0] instanceof CustomEvent) {
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (args[1] != undefined) {
            args = [args[1]];
          } else {
