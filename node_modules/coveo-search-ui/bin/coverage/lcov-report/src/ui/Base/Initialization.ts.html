...
<div class="header medium">
    ...
    <h2>
        Statements: <span class="metric">73.11% <small>(174 / 238)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">41.89% <small>(31 / 74)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">70.59% <small>(24 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">73.91% <small>(170 / 230)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">306</span>
<span class="cline-any cline-yes">19171</span>
<span class="cline-any cline-yes">19161</span>
<span class="cline-any cline-yes">19161</span>
<span class="cline-any cline-yes">19161</span>
<span class="cline-any cline-yes">19161</span>
...
<span class="cline-any cline-yes">521</span>
<span class="cline-any cline-yes">521</span>
<span class="cline-any cline-yes">3966</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">521</span>
<span class="cline-any cline-yes">521</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (searchInterface.options.autoTriggerQuery) {
...
&nbsp;
   ...
   * @param options
   */
<span class="fstat-no" title="function not covered" >  public static initStandaloneSearchInterface(element: HTMLElement, <span class="cstat-no" title="statement not covered" >options: any = {})</span></span> {
<span class="cstat-no" title="statement not covered" >    options = Initialization.resolveDefaultOptions(element, options);</span>
<span class="cstat-no" title="statement not covered" >    let searchInterface = new StandaloneSearchInterface(element, options.StandaloneSearchInterface, options.Analytics);</span>
<span class="cstat-no" title="statement not covered" >    searchInterface.options.originalOptionsObject = options;</span>
<span class="cstat-no" title="statement not covered" >    let initParameters: IInitializationParameters = { options: options, bindings: searchInterface.getBindings() };</span>
...
<span class="cstat-no" title="statement not covered" >      searchInterface.usageAnalytics.logSearchEvent&lt;IAnalyticsNoMeta&gt;(analyticsActionCauseList[firstQueryCause], meta);</span>
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (Utils.isNonEmptyString(searchInterface.getBindings().queryStateModel.get('q'))) {
  ...
  private static initExternalComponents(element: HTMLElement, options?: any) {
    if (options &amp;&amp; options['externalComponents']) {
      ...
      _.each(options['externalComponents'], (externalComponent: HTMLElement) =&gt; {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (Utils.isHtmlElement(elementToInstantiate)) {
  ...
  private static createFunctionThatInitializesComponentOnElements(elements: Element[], componentClassId: string, componentClass: BaseComponent, initParameters: IInitializationParameters) {
    return () =&gt; {
      _.each(elements, (matchingElement: HTMLElement) =&gt; {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (Component.get(matchingElement, componentClassId) == null) {
