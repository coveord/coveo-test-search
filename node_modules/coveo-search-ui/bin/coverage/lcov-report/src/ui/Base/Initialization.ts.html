...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/Base/Initialization.ts</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">src/ui/Base/Initialization.ts</span></h1>
    <h2>
        Statements: <span class="metric">77.65% <small>(205 / 264)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">51.58% <small>(49 / 95)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">75% <small>(27 / 36)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">78.13% <small>(200 / 256)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/Base/</a> &#187; Initialization.ts</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">2946</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">366</span>
<span class="cline-any cline-yes">25147</span>
<span class="cline-any cline-yes">25135</span>
<span class="cline-any cline-yes">25135</span>
<span class="cline-any cline-yes">25135</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">25135</span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (element.parentElement) {
<span class="cstat-no" title="statement not covered" >      return Initialization.resolveDefaultOptions(element.parentElement, optionsSoFar);</span>
    } else {
      return optionsSoFar;
    }
  }
...
&nbsp;
    ...
    _.each(elemsHidden, <span class="fstat-no" title="function not covered" >(e: HTMLElement)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      $$(e).removeClass('coveo-hide-until-loaded');</span>
<span class="cstat-no" title="statement not covered" >      $$(e).addClass('coveo-show-after-loaded');</span>
    });
&nbsp;
...
&nbsp;
   ...
   * @param options
   */
  public static initSearchInterface(element: HTMLElement, <span class="missing-if-branch" title="if path not taken" >I</span>options: any = {}) {
    options = Initialization.resolveDefaultOptions(element, options);
...
&nbsp;
   ...
   * @param options
   */
  public static initStandaloneSearchInterface(element: HTMLElement, <span class="missing-if-branch" title="if path not taken" >I</span>options: any = {}) {
    options = Initialization.resolveDefaultOptions(element, options);
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!options.Querybox) {
      options.Querybox = {};
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!options.Omnibox) {
      options.Omnibox = {};
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!options.Searchbox) {
<span class="cstat-no" title="statement not covered" >      options.Searchbox = {};</span>
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!options.Querybox.triggerQueryOnClear || <span class="branch-1 cbranch-no" title="branch not covered" >!options.Omnibox.triggerQueryOnClear </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >!options.Searchbox.triggerOnQueryClear)</span> {
...
&nbsp;
   ...
   * @param options
   */
  public static initRecommendationInterface(element: HTMLElement, <span class="missing-if-branch" title="if path not taken" >I</span>options: any = {}) {
    options = Initialization.resolveDefaultOptions(element, options);
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (initParameters != undefined) {
...
&nbsp;
   ...
   * @returns {boolean}
   */
<span class="fstat-no" title="function not covered" >  public static isNamedMethodRegistered(methodName: string)</span>: boolean {
<span class="cstat-no" title="statement not covered" >    return Utils.exists(Initialization.namedMethods[methodName]);</span>
  }
&nbsp;
  /**
...
&nbsp;
    let componentClass;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (methodName.indexOf('.') &gt; 0) {
<span class="cstat-no" title="statement not covered" >      let splitArg = methodName.split('.');</span>
<span class="cstat-no" title="statement not covered" >      Assert.check(splitArg.length == 2, 'Invalid method name, correct syntax is CoveoComponent.methodName.');</span>
<span class="cstat-no" title="statement not covered" >      componentClass = splitArg[0];</span>
<span class="cstat-no" title="statement not covered" >      methodName = &lt;string&gt;splitArg[1];</span>
    }
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!Utils.exists(boundComponent[originalMethodName])) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  public static initBoxInterface(element: HTMLElement, <span class="cstat-no" title="statement not covered" >options: any = {},</span> <span class="cstat-no" title="statement not covered" >type: string = 'Standard',</span> <span class="cstat-no" title="statement not covered" >injectMarkup: boolean = true)</span></span> {
<span class="cstat-no" title="statement not covered" >    options = Initialization.resolveDefaultOptions(element, options);</span>
<span class="cstat-no" title="statement not covered" >    let fromInitTypeToBoxReference = 'Box';</span>
<span class="cstat-no" title="statement not covered" >    if (type != 'Standard') {</span>
<span class="cstat-no" title="statement not covered" >      fromInitTypeToBoxReference += 'For' + type;</span>
    }
<span class="cstat-no" title="statement not covered" >    let boxRef = Component.getComponentRef(fromInitTypeToBoxReference);</span>
<span class="cstat-no" title="statement not covered" >    if (boxRef) {</span>
<span class="cstat-no" title="statement not covered" >      new Logger(element).info('Initializing box of type ' + fromInitTypeToBoxReference);</span>
<span class="cstat-no" title="statement not covered" >      let injectFunction: () =&gt; any = injectMarkup ? boxRef.getInjection : <span class="fstat-no" title="function not covered" >() =&gt; {</span></span>
      };
<span class="cstat-no" title="statement not covered" >      let box = new boxRef(element, options[fromInitTypeToBoxReference], options.Analytics, injectFunction, options);</span>
<span class="cstat-no" title="statement not covered" >      box.options.originalOptionsObject = options;</span>
<span class="cstat-no" title="statement not covered" >      let initParameters: IInitializationParameters = { options: options, bindings: box.getBindings() };</span>
<span class="cstat-no" title="statement not covered" >      Initialization.automaticallyCreateComponentsInside(element, initParameters);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      new Logger(element).error('Trying to initialize box of type : ' + fromInitTypeToBoxReference + ' but not found in code (not compiled)!');</span>
<span class="cstat-no" title="statement not covered" >      Assert.fail('Cannot initialize unknown type of box');</span>
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  public static dispatchNamedMethodCall(methodName: string, element: HTMLElement, args: any[])</span>: any {
<span class="cstat-no" title="statement not covered" >    Assert.isNonEmptyString(methodName);</span>
<span class="cstat-no" title="statement not covered" >    Assert.exists(element);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    let namedMethodHandler: (element: HTMLElement, ...args: any[]) =&gt; any = Initialization.namedMethods[methodName];</span>
<span class="cstat-no" title="statement not covered" >    Assert.exists(namedMethodHandler);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    Initialization.logger.trace('Dispatching named method call of ' + methodName, element, args);</span>
<span class="cstat-no" title="statement not covered" >    if (args.length != 0) {</span>
<span class="cstat-no" title="statement not covered" >      return namedMethodHandler.apply(null, [element].concat(args));</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return namedMethodHandler.apply(null, [element]);</span>
    }
&nbsp;
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  public static dispatchNamedMethodCallOrComponentCreation(token: string, element: HTMLElement, args: any[])</span>: any {
<span class="cstat-no" title="statement not covered" >    Assert.isNonEmptyString(token);</span>
<span class="cstat-no" title="statement not covered" >    Assert.exists(element);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (Initialization.isNamedMethodRegistered(token)) {</span>
<span class="cstat-no" title="statement not covered" >      return Initialization.dispatchNamedMethodCall(token, element, args);</span>
    } else <span class="cstat-no" title="statement not covered" >if (Initialization.isComponentClassIdRegistered(token)) {</span>
<span class="cstat-no" title="statement not covered" >      return Initialization.createComponentOfThisClassOnElement(token, element, args[0]);</span>
    } else <span class="cstat-no" title="statement not covered" >if (Initialization.isThereASingleComponentBoundToThisElement(element)) {</span>
<span class="cstat-no" title="statement not covered" >      return Initialization.dispatchMethodCallOnBoundComponent(token, element, args);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      Assert.fail('No method or component named ' + token + ' are registered.');</span>
    }
  }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private static isThereASingleComponentBoundToThisElement(element: HTMLElement)</span>: boolean {
<span class="cstat-no" title="statement not covered" >    Assert.exists(element);</span>
<span class="cstat-no" title="statement not covered" >    return Utils.exists(Component.get(element));</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private static dispatchMethodCallOnBoundComponent(methodName: string, element: HTMLElement, args: any[])</span>: any {
<span class="cstat-no" title="statement not covered" >    Assert.isNonEmptyString(methodName);</span>
<span class="cstat-no" title="statement not covered" >    Assert.exists(element);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    let boundComponent = Component.get(element);</span>
<span class="cstat-no" title="statement not covered" >    Assert.exists(boundComponent);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    let method = boundComponent[methodName];</span>
<span class="cstat-no" title="statement not covered" >    if (Utils.exists(method)) {</span>
<span class="cstat-no" title="statement not covered" >      return method.apply(boundComponent, args);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      Assert.fail('No method named ' + methodName + ' exist on component ' + boundComponent.type);</span>
    }
  }
&nbsp;
&nbsp;
  private static logFirstQueryCause(searchInterface: SearchInterface) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (firstQueryCause != null) {
<span class="cstat-no" title="statement not covered" >      let meta = HashUtils.getValue('firstQueryMeta', HashUtils.getHash()) || {};</span>
<span class="cstat-no" title="statement not covered" >      searchInterface.usageAnalytics.logSearchEvent&lt;IAnalyticsNoMeta&gt;(analyticsActionCauseList[firstQueryCause], meta);</span>
    } else {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (Initialization.isSearchFromLink(searchInterface)) {
<span class="cstat-no" title="statement not covered" >        searchInterface.usageAnalytics.logSearchEvent&lt;IAnalyticsNoMeta&gt;(analyticsActionCauseList.searchFromLink, {});</span>
      } else {
...
&nbsp;
  private static performInitFunctionsOption(options, event: string) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (Utils.exists(options)) {
      Initialization.performFunctions(options[event]);
    }
  }
&nbsp;
  private static performFunctions(option) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Utils.exists(option)) {
<span class="cstat-no" title="statement not covered" >      _.each(option, <span class="fstat-no" title="function not covered" >(func: () =&gt; void)</span> =&gt; {</span>
  ...
  private static initExternalComponents(element: HTMLElement, options?: any) {
    if (options &amp;&amp; options['externalComponents']) {
      ...
      _.each(options['externalComponents'], (externalComponent: HTMLElement | IJQuery) =&gt; {
        ...
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (JQueryUtils.isInstanceOfJQuery(elementToInstantiate)) {
    ...
    return () =&gt; {
      _.each(elements, (matchingElement: HTMLElement) =&gt; {
        if (Component.get(matchingElement, componentClassId) == null) {
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (Utils.exists(initParameters.options)) {
            ...
            let initOptions = initParameters.options['initOptions'] ? <span class="branch-0 cbranch-no" title="branch not covered" >initParameters.options['initOptions'][componentClassId] </span>: {};
