...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/AnalyticsSuggestions/AnalyticsSuggestions.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/AnalyticsSuggestions/AnalyticsSuggestions.ts</span></h1>
    <h2>
        Statements: <span class="metric">82.46% <small>(94 / 114)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">63.16% <small>(24 / 38)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">77.27% <small>(17 / 22)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">82.24% <small>(88 / 107)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/AnalyticsSuggestions/</a> &#187; AnalyticsSuggestions.ts</div>
</div>
<div class="body">
...
275
276
277</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { ISuggestionForOmniboxOptions, SuggestionForOmnibox, ISuggestionForOmniboxTemplate } from '../Misc/SuggestionForOmnibox';
...
&nbsp;
  ...
  constructor(element: HTMLElement, public options: IAnalyticsSuggestionsOptions, bindings?: IComponentBindings) {
    super(element, AnalyticsSuggestions.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
&nbsp;
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options &amp;&amp; 'omniboxSuggestionOptions' in this.options) {
<span class="cstat-no" title="statement not covered" >      this.options = _.extend(this.options, this.options['omniboxSuggestionOptions']);</span>
    }
&nbsp;
...
&nbsp;
    let rowTemplate = (toRender: IStringMap&lt;any&gt;) =&gt; {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (toRender['data']) {
...
<span class="cstat-no" title="statement not covered" >      let headerTemplate = <span class="fstat-no" title="function not covered" >() =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >        let headerElement = $$('div', {</span>
          className: 'coveo-top-analytics-suggestion-header'
        });
<span class="cstat-no" title="statement not covered" >        let iconElement = $$('span', {</span>
          className: 'coveo-icon-top-analytics'
        });
<span class="cstat-no" title="statement not covered" >        let captionElement = $$('span', {</span>
          className: 'coveo-caption'
        });
<span class="cstat-no" title="statement not covered" >        if (this.options.headerTitle) {</span>
<span class="cstat-no" title="statement not covered" >          captionElement.text(this.options.headerTitle);</span>
        }
<span class="cstat-no" title="statement not covered" >        headerElement.append(iconElement.el);</span>
<span class="cstat-no" title="statement not covered" >        headerElement.append(captionElement.el);</span>
<span class="cstat-no" title="statement not covered" >        return headerElement.el.outerHTML;</span>
      };
<span class="cstat-no" title="statement not covered" >      suggestionStructure = {</span>
...
&nbsp;
    ...
    }, <span class="fstat-no" title="function not covered" >(value: string, args: IPopulateOmniboxEventArgs)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      this.onRowTab.call(this, value, args);</span>
    });
    this.bind.onRootElement(OmniboxEvents.populateOmnibox, (args: IPopulateOmniboxEventArgs) =&gt; this.handlePopulateOmnibox(args));
    this.bind.onRootElement(QueryEvents.querySuccess, <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.partialQueries = [])</span>;
  }
&nbsp;
  /**
  ...
  public selectSuggestion(suggestion: any) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.currentlyDisplayedSuggestions) {
      if (isNaN(suggestion)) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.currentlyDisplayedSuggestions[suggestion]) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (currentlySuggested) {
...
&nbsp;
      searchPromise.then((results: string[]) =&gt; {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!_.isEmpty(this.resultsToBuildWith) &amp;&amp; args.completeQueryExpression.word != '') {
      ...
      searchPromise.catch(<span class="fstat-no" title="function not covered" >() =&gt; {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private onRowTab(value: string, args: IPopulateOmniboxEventArgs)</span> {
<span class="cstat-no" title="statement not covered" >    args.clear();</span>
<span class="cstat-no" title="statement not covered" >    args.closeOmnibox();</span>
<span class="cstat-no" title="statement not covered" >    this.queryStateModel.set(QueryStateModel.attributesEnum.q, `${value}`);</span>
<span class="cstat-no" title="statement not covered" >    this.usageAnalytics.logCustomEvent&lt;IAnalyticsTopSuggestionMeta&gt;(this.getOmniboxAnalyticsEventCause(), {</span>
      partialQueries: this.cleanCustomData(this.partialQueries),
      suggestionRanking: _.indexOf(_.pluck(this.resultsToBuildWith, 'value'), value),
      suggestions: this.cleanCustomData(this.lastSuggestions),
      partialQuery: args.completeQueryExpression.word
