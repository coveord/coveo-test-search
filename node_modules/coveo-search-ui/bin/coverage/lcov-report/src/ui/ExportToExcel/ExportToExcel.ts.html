...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/ExportToExcel/ExportToExcel.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/ExportToExcel/ExportToExcel.ts</span></h1>
    <h2>
        Statements: <span class="metric">91.67% <small>(33 / 36)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">75% <small>(6 / 8)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">50% <small>(3 / 6)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">90% <small>(27 / 30)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/ExportToExcel/</a> &#187; ExportToExcel.ts</div>
</div>
<div class="body">
...
&nbsp;
  ...
  constructor(public element: HTMLElement, public options: IExportToExcelOptions, public bindings?: IComponentBindings, public _window?: Window) {
    super(element, ExportToExcel.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
<span class="cstat-no" title="statement not covered" >      args.menuData.push({</span>
        ...
        onOpen: <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.download()</span>
      });
    });
  }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  static create(element: HTMLElement, options?: IExportToExcelOptions, root?: HTMLElement)</span>: ExportToExcel {
<span class="cstat-no" title="statement not covered" >    return new ExportToExcel(element, options, root);</span>
  }
}
&nbsp;
