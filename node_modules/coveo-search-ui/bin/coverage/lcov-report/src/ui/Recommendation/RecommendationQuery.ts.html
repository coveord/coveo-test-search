...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/Recommendation/RecommendationQuery.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/Recommendation/RecommendationQuery.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/Recommendation/</a> &#187; RecommendationQuery.ts</div>
</div>
<div class="body">
...
&nbsp;
  constructor(public element: HTMLElement, public options?: IRecommendationQueryOptions, bindings?: IComponentBindings) {
    super(element, RecommendationQuery.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
&nbsp;
    if (this.element.tagName.toLowerCase() === 'script') {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!_.isUndefined(this.content) &amp;&amp; this.content != '') {
