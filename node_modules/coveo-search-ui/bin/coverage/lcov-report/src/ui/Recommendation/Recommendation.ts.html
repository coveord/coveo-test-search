...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">100% <small>(113 / 113)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">86.67% <small>(26 / 30)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2190</span>
...
&nbsp;
  constructor(public element: HTMLElement, public options: IRecommendationOptions = {}, <span class="missing-if-branch" title="else path not taken" >E</span>public analyticsOptions = {}, <span class="missing-if-branch" title="else path not taken" >E</span>_window = window) {
...
&nbsp;
  public show(): void {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.displayStyle) {
      this.displayStyle = this.element.style.display;
    }
