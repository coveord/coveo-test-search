...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/Recommendation/Recommendation.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/Recommendation/Recommendation.ts</span></h1>
    <h2>
        Statements: <span class="metric">96.86% <small>(154 / 159)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">83.33% <small>(40 / 48)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">94.29% <small>(33 / 35)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">96.5% <small>(138 / 143)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/Recommendation/</a> &#187; Recommendation.ts</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3444</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { SearchInterface, ISearchInterfaceOptions } from '../SearchInterface/SearchInterface';
...
&nbsp;
   ...
   * @param _window
   */
  constructor(public element: HTMLElement, public options: IRecommendationOptions = {}, public <span class="missing-if-branch" title="else path not taken" >E</span>analyticsOptions = {}, <span class="missing-if-branch" title="else path not taken" >E</span>_window = window) {
    super(element, ComponentOptions.initComponentOptions(element, Recommendation, options), analyticsOptions, _window)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
    if (!this.options.id) {
...
&nbsp;
    let onceInitialized = () =&gt; {
      ...
      $$(this.options.mainSearchInterface).on(this.componentOptionsModel.getEventName(MODEL_EVENTS.ALL), <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        this.componentOptionsModel.setMultiple(mainSearchInterfaceOptionsModel.getAttributes());</span>
      });
    };
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (alreadyInitialized) {
      onceInitialized();
    } else {
<span class="cstat-no" title="statement not covered" >      $$(this.options.mainSearchInterface).on(InitializationEvents.afterComponentsInitialization, <span class="fstat-no" title="function not covered" >() =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >        searchInterfaceComponent = &lt;SearchInterface&gt;get(this.options.mainSearchInterface, SearchInterface);</span>
<span class="cstat-no" title="statement not covered" >        onceInitialized();</span>
      });
    }
  }
&nbsp;
...
&nbsp;
  private getHistory(): string {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (historyFromStore == null) {
<span class="cstat-no" title="statement not covered" >      historyFromStore = [];</span>
    }
...
&nbsp;
  private preventEventPropagationOn(eventType, <span class="missing-if-branch" title="else path not taken" >E</span>eventName = (event: string) =&gt; { return event; }) {
