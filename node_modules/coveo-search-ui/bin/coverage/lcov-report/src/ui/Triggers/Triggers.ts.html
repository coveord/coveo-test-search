...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/Triggers/Triggers.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/Triggers/Triggers.ts</span></h1>
    <h2>
        Statements: <span class="metric">97.01% <small>(65 / 67)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">83.33% <small>(10 / 12)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(11 / 11)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">96.61% <small>(57 / 59)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/Triggers/</a> &#187; Triggers.ts</div>
</div>
<div class="body">
...
&nbsp;
    super(element, Triggers.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (data.results.triggers === undefined) {
<span class="cstat-no" title="statement not covered" >      $$(this.element).toggleClass('coveo-visible', showElement);</span>
