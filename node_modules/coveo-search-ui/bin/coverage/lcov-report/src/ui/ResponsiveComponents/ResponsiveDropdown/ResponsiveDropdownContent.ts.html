...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/ResponsiveComponents/ResponsiveDropdown/ResponsiveDropdownContent.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/ResponsiveComponents/ResponsiveDropdown/ResponsiveDropdownContent.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">src/ui/ResponsiveComponents/ResponsiveDropdown/</a> &#187; ResponsiveDropdownContent.ts</div>
</div>
<div class="body">
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (width &lt;= this.minWidth) {
      width = this.minWidth;
    }
