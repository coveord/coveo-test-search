...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">83.65% <small>(87 / 104)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">66.67% <small>(22 / 33)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">78.26% <small>(18 / 23)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">83.33% <small>(80 / 96)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
    super(element, FollowItem.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
&nbsp;
...
&nbsp;
    ...
    this.container.on('click', <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.toggleFollow())</span>;
&nbsp;
...
&nbsp;
   ...
   */
  public toggleFollow() {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.container.hasClass('coveo-follow-item-loading')) {
      this.container.removeClass('coveo-follow-item-followed');
      this.container.addClass('coveo-follow-item-loading');
...
&nbsp;
  private handleSubscriptionDeleted(args: ISearchAlertsEventArgs) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (args.subscription &amp;&amp; args.subscription.type == SUBSCRIPTION_TYPE.followDocument) {
...
&nbsp;
  private handleSubscriptionCreated(args: ISearchAlertsEventArgs) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (args.subscription &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >args.subscription.type == SUBSCRIPTION_TYPE.followDocument)</span> {
<span class="cstat-no" title="statement not covered" >      let typeConfig = &lt;ISubscriptionItemRequest&gt;args.subscription.typeConfig;</span>
<span class="cstat-no" title="statement not covered" >      if (typeConfig.id == this.getId()) {</span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.watchedFields) {
<span class="cstat-no" title="statement not covered" >      typeCofig.watchedFields = &lt;string[]&gt;options.watchedFields;</span>
    }
&nbsp;
    return {
