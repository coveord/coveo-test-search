...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">95.41% <small>(104 / 109)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">81.82% <small>(27 / 33)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
252
253
254</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
&nbsp;
    ...
    this.bind.on(this.container, 'keyup', KeyboardUtils.keypressAction(KEYBOARD.ENTER, <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.toggleFollow())</span>);
&nbsp;
...
&nbsp;
  private handleSubscriptionDeleted(args: ISearchAlertsEventArgs) {
    if (args.subscription &amp;&amp; args.subscription.type == SUBSCRIPTION_TYPE.followDocument) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (typeConfig.id == this.getId()) {
        this.setNotFollowed();
      }
    }
  }
