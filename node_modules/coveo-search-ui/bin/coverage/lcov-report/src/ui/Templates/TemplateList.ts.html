...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Template, IInstantiateTemplateOptions, DefaultInstantiateTemplateOptions } from './Template';
...
&nbsp;
  instantiateToString(object: IQueryResult, <span class="missing-if-branch" title="else path not taken" >E</span>instantiateOptions: IInstantiateTemplateOptions = {}): string {
...
&nbsp;
  instantiateToElement(object: IQueryResult, <span class="missing-if-branch" title="else path not taken" >E</span>instantiateOptions: IInstantiateTemplateOptions = {}): HTMLElement {
    let merged = new DefaultInstantiateTemplateOptions().merge(instantiateOptions);
    for (var i = 0; i &lt; this.templates.length; i++) {
