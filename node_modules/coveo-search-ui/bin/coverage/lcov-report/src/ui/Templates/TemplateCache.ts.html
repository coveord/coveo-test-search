...
<div class="header high">
    ...
    <h2>
        ...
        Lines: <span class="metric">90.41% <small>(66 / 73)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
   ...
   * @param pageTemplate
   */
  public static registerTemplate(name: string, template: any, publicTemplate: boolean = true, defaultTemplate: boolean = false, <span class="missing-if-branch" title="else path not taken" >E</span>resultListTemplate: boolean = false) {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (resultListTemplate &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!_.contains(TemplateCache.resultListTemplateNames, name))</span> {
<span class="cstat-no" title="statement not covered" >      TemplateCache.resultListTemplateNames.push(name);</span>
    }
&nbsp;
    if (defaultTemplate) {
...
&nbsp;
  ...
  public static unregisterTemplate(name) {
    Assert.isNonEmptyString(name);
    <span class="missing-if-branch" title="else path not taken" >E</span>if (TemplateCache.templates[name] != undefined) {
