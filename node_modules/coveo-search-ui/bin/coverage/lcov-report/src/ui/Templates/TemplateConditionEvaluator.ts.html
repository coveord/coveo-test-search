...
<div class="header high">
    ...
    <h2>
        ...
        Branches: <span class="metric">89.66% <small>(26 / 29)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">43</span>
<span class="cline-any cline-yes">2945</span>
<span class="cline-any cline-yes">2945</span>
...
export class TemplateConditionEvaluator {
  static getFieldFromString(text: string) {
    var fields: string[] = _.map(StringUtils.match(text, /(?:(?!\b@)@([a-z0-9]+(?:\.[a-z0-9]+)*\b))|\braw.([a-z0-9]+)|\braw\['([^']+)'\]|\braw\["([^"]+)"\]/gi), (field) =&gt; {
      return field[1] || field[2] || field[3] || field[4] || <span class="branch-4 cbranch-no" title="branch not covered" >null;</span>
    });
&nbsp;
