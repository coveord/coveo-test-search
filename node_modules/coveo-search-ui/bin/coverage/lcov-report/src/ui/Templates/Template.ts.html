...
<div class="header high">
    ...
    <h2>
        ...
        Branches: <span class="metric">95.59% <small>(65 / 68)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">91.67% <small>(11 / 12)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">96.59% <small>(85 / 88)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
  instantiateToString(object: IQueryResult, instantiateOptions: IInstantiateTemplateOptions = new DefaultInstantiateTemplateOptions()): string {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.dataToString) {
...
&nbsp;
  getFields(): string[] {
    return this.fields || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
  }
&nbsp;
  getType() {
    return 'Template';
...
<span class="cstat-no" title="statement not covered" >      this.conditionToParse = condition;</span>
    }
  }
}
&nbsp;</pre></td></tr>
