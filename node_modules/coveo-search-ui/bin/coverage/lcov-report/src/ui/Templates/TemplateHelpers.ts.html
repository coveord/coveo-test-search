...
&nbsp;
   ...
   * @returns {{}}
   */
<span class="fstat-no" title="function not covered" >  static getHelpers() {</span>
<span class="cstat-no" title="statement not covered" >    return TemplateHelpers.helpers;</span>
  }
&nbsp;
