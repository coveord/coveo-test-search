...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/Templates/TemplateFromAScriptTag.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/Templates/TemplateFromAScriptTag.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/Templates/</a> &#187; TemplateFromAScriptTag.ts</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Template, IFieldsToMatch } from './Template';
...
&nbsp;
  static fromString(template: string, <span class="missing-if-branch" title="if path not taken" >I</span>properties: ITemplateFromStringProperties = {}): HTMLElement {
