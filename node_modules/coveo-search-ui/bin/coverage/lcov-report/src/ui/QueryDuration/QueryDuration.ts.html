...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/QueryDuration/QueryDuration.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/QueryDuration/QueryDuration.ts</span></h1>
    <h2>
        ...
        Lines: <span class="metric">94.29% <small>(33 / 35)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/QueryDuration/</a> &#187; QueryDuration.ts</div>
</div>
<div class="body">
...
&nbsp;
  ...
  constructor(public element: HTMLElement, public options?: IQueryDurationOptions, bindings?: IComponentBindings) {
    super(element, QueryDuration.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
&nbsp;
    this.options = ComponentOptions.initComponentOptions(element, QueryDuration, options);
&nbsp;
    this.bind.onRootElement(QueryEvents.querySuccess, (data: IQuerySuccessEventArgs) =&gt; this.handleQuerySuccess(data));
    this.bind.onRootElement(QueryEvents.queryError, <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>$$(this.element).hide())</span>;
...
&nbsp;
  private handleQuerySuccess(data: IQuerySuccessEventArgs) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.disabled &amp;&amp; data.results.results.length &gt; 0) {
      Assert.exists(data);
&nbsp;
      let tooltip = [
...
&nbsp;
  private formatQueryDuration(durationInMillis: number): string {
    if (durationInMillis == undefined) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (String['locale'] === 'en') {
        return l('Seconds', Globalize.format(seconds, 'n2'), seconds, true);
      } else {
<span class="cstat-no" title="statement not covered" >        return l('Seconds', Globalize.format(seconds, 'n2'), seconds);</span>
      }
    }
  }
}
