...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/ResultAttachments/ResultAttachments.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/ResultAttachments/ResultAttachments.ts</span></h1>
    <h2>
        Statements: <span class="metric">96.15% <small>(50 / 52)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">88.89% <small>(16 / 18)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(8 / 8)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">95.56% <small>(43 / 45)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/ResultAttachments/</a> &#187; ResultAttachments.ts</div>
</div>
<div class="body">
...
&nbsp;
  ...
  constructor(public element: HTMLElement, public options?: IResultAttachmentsOptions, public bindings?: IComponentBindings, result?: IQueryResult, public attachmentLevel = 0) {
    super(element, ResultAttachments.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
&nbsp;
...
&nbsp;
  private attachmentHasSubAttachment(attachment: IQueryResult) {
    if (Utils.isNonEmptyArray(attachment.attachments)) {
      return true;
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (Utils.isNonEmptyArray(attachment.childResults)) {
<span class="cstat-no" title="statement not covered" >      attachment.attachments = attachment.childResults;</span>
