...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/AdvancedSearch/DateInput/DateInput.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/AdvancedSearch/DateInput/DateInput.ts</span></h1>
    <h2>
        Statements: <span class="metric">97.83% <small>(45 / 46)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">75% <small>(3 / 4)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">93.75% <small>(15 / 16)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">97.67% <small>(42 / 43)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">src/ui/AdvancedSearch/DateInput/</a> &#187; DateInput.ts</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    this.radio.reset();</span>
  }
&nbsp;
...
&nbsp;
  protected onChange() {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.element) {
