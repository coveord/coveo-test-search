...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/AdvancedSearch/DateInput/BetweenDateInput.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/AdvancedSearch/DateInput/BetweenDateInput.ts</span></h1>
    <h2>
        ...
        Lines: <span class="metric">94.12% <small>(32 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">src/ui/AdvancedSearch/DateInput/</a> &#187; BetweenDateInput.ts</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { DateInput } from './DateInput';
...
<span class="cstat-no" title="statement not covered" >    this.firstDatePicker.reset();</span>
<span class="cstat-no" title="statement not covered" >    this.secondDatePicker.reset();</span>
  }
&nbsp;
...
&nbsp;
  public getValue(): string {
    ...
    let query = '';
    <span class="missing-if-branch" title="else path not taken" >E</span>if (firstDate) {
      query += `(@date&gt;=${firstDate})`;
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (secondDate) {
