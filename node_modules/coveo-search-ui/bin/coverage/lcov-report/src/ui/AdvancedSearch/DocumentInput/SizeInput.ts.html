...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/AdvancedSearch/DocumentInput/SizeInput.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/AdvancedSearch/DocumentInput/SizeInput.ts</span></h1>
    <h2>
        Statements: <span class="metric">95.56% <small>(43 / 45)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">src/ui/AdvancedSearch/DocumentInput/</a> &#187; SizeInput.ts</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Dropdown } from '../Form/Dropdown';
...
<span class="cstat-no" title="statement not covered" >    this.modeSelect.reset();</span>
<span class="cstat-no" title="statement not covered" >    this.sizeInput.reset();</span>
  }
&nbsp;
