...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/AdvancedSearch/AdvancedSearchInputFactory.ts</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">src/ui/AdvancedSearch/AdvancedSearchInputFactory.ts</span></h1>
    <h2>
        Statements: <span class="metric">75% <small>(36 / 48)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">0% <small>(0 / 11)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">92.31% <small>(12 / 13)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">73.91% <small>(34 / 46)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/AdvancedSearch/</a> &#187; AdvancedSearchInputFactory.ts</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { ISearchEndpoint } from '../../rest/SearchEndpointInterface';
...
&nbsp;
<span class="fstat-no" title="function not covered" >  public create(name: string, options?: IFieldInputParameters)</span>: IAdvancedSearchInput {
<span class="cstat-no" title="statement not covered" >    switch (name) {</span>
      case 'keywords_all':
<span class="cstat-no" title="statement not covered" >        return this.createAllKeywordsInput();</span>
      case 'keywords_exact':
<span class="cstat-no" title="statement not covered" >        return this.createExactKeywordsInput();</span>
      case 'keywords_any':
<span class="cstat-no" title="statement not covered" >        return this.createAnyKeywordsInput();</span>
      case 'keywords_none':
<span class="cstat-no" title="statement not covered" >        return this.createNoneKeywordsInput();</span>
      case 'date_any':
<span class="cstat-no" title="statement not covered" >        return this.createAnytimeDateInput();</span>
      case 'date_last':
<span class="cstat-no" title="statement not covered" >        return this.createInTheLastDateInput();</span>
      case 'date_between':
<span class="cstat-no" title="statement not covered" >        return this.createBetweenDateInput();</span>
      case 'document_field':
<span class="cstat-no" title="statement not covered" >        return this.createSimpleFieldInput(options.name, options.field);</span>
      case 'document_advanced_field':
<span class="cstat-no" title="statement not covered" >        return this.createAdvancedFieldInput(options.name, options.field);</span>
      case 'document_size':
<span class="cstat-no" title="statement not covered" >        return this.createSizeInput();</span>
      default:
