...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/AdvancedSearch/AdvancedSearch.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/AdvancedSearch/AdvancedSearch.ts</span></h1>
    <h2>
        Statements: <span class="metric">91.3% <small>(126 / 138)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">78.57% <small>(11 / 14)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">67.65% <small>(23 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">91.47% <small>(118 / 129)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/AdvancedSearch/</a> &#187; AdvancedSearch.ts</div>
</div>
<div class="body">
...
264
265
266</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
&nbsp;
  ...
  constructor(public element: HTMLElement, public options?: IAdvancedSearchOptions, bindings?: IComponentBindings) {
    super(element, AdvancedSearch.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
<span class="cstat-no" title="statement not covered" >    _.each(this.inputs, <span class="fstat-no" title="function not covered" >(input)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      input.reset();</span>
    });
  }
&nbsp;
...
&nbsp;
    ...
    $$(this.root).trigger(AdvancedSearchEvents.buildingAdvancedSearch, {
      ...
      executeQuery: <span class="fstat-no" title="function not covered" >(options: IQueryOptions)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >        return this.queryController.executeQuery(options);</span>
      }
    });
&nbsp;
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private open() {</span>
<span class="cstat-no" title="statement not covered" >    $$(this.element).show();</span>
  }
&nbsp;
...
&nbsp;
  private buildDefaultInput(input: IAdvancedSearchInput | IAdvancedSearchPrebuiltInput): IAdvancedSearchInput {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.isPrebuiltInput(input)) {
<span class="cstat-no" title="statement not covered" >      return this.inputFactory.create(input.name, input.parameters);</span>
    } else {
      return input;
    }
  }
...
&nbsp;
  private bindEvents() {
    this.bind.onRootElement(SettingsEvents.settingsPopulateMenu, <span class="fstat-no" title="function not covered" >(args: ISettingsPopulateMenuArgs)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      args.menuData.push({</span>
        text: l('AdvancedSearch'),
        className: 'coveo-advanced-search',
        onOpen: <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.open(),</span>
...
&nbsp;
    this.bind.onRootElement(QueryEvents.buildingQuery, (data: IBuildingQueryEventArgs) =&gt; {
      _.each(this.externalSections, (section: IExternalAdvancedSearchSection) =&gt; {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (section.updateQuery) {
...
&nbsp;
    this.bind.onRootElement(AdvancedSearchEvents.executeAdvancedSearch, <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      this.executeAdvancedSearch();</span>
    });
&nbsp;
    this.bind.onRootElement(QuerySummaryEvents.cancelLastAction, <span class="fstat-no" title="function not covered" >() =&gt; {</span>
