...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/AdvancedSearch/Form/RadioButton.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/AdvancedSearch/Form/RadioButton.ts</span></h1>
    <h2>
        Statements: <span class="metric">88.57% <small>(31 / 35)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">50% <small>(1 / 2)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">58.33% <small>(7 / 12)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">87.5% <small>(28 / 32)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">src/ui/AdvancedSearch/Form/</a> &#187; RadioButton.ts</div>
</div>
<div class="body">
...
&nbsp;
   ...
   */
  constructor(public <span class="fstat-no" title="function not covered" ><span class="missing-if-branch" title="if path not taken" >I</span>onChange: () =&gt; void = () =&gt; {</span>
  }, public label: string) {
    this.buildContent();
  }
&nbsp;
...
<span class="fstat-no" title="function not covered" >  public reset() {</span>
    (&lt;HTMLInputElement&gt;<span class="cstat-no" title="statement not covered" >this.element).checked = false;</span>
  }
&nbsp;
  /**
   ...
   * @returns {HTMLElement}
   */
<span class="fstat-no" title="function not covered" >  public build(): HTMLElement {</span>
<span class="cstat-no" title="statement not covered" >    return this.element;</span>
  }
&nbsp;
  /**
   * Return the element on which the dropdown is bound.
...
&nbsp;
<span class="fstat-no" title="function not covered" >  public getValue(): string {</span>
...
&nbsp;
   ...
   * @returns {boolean}
   */
<span class="fstat-no" title="function not covered" >  public isSelected(): boolean {</span>
<span class="cstat-no" title="statement not covered" >    return this.getRadio().checked;</span>
  }
&nbsp;
  /**
