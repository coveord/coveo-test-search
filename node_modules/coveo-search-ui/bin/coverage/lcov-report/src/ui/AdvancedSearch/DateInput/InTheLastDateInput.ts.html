...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/AdvancedSearch/DateInput/InTheLastDateInput.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/AdvancedSearch/DateInput/InTheLastDateInput.ts</span></h1>
    <h2>
        Statements: <span class="metric">94.12% <small>(32 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">src/ui/AdvancedSearch/DateInput/</a> &#187; InTheLastDateInput.ts</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    this.spinner.reset();</span>
  }
&nbsp;
