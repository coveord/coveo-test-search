...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/AdvancedSearch/Form/NumericSpinner.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/AdvancedSearch/Form/NumericSpinner.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">src/ui/AdvancedSearch/Form/</a> &#187; NumericSpinner.ts</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    this.getSpinnerInput().value = '';</span>
  }
&nbsp;
  /**
...
&nbsp;
    ...
    $$(numberInput).on('input', <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      if (numberInput.value.match(/[0-9]*/)) {</span>
