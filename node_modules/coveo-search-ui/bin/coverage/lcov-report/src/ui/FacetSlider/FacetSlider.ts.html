...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">82.35% <small>(308 / 374)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">70.56% <small>(139 / 197)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">70.77% <small>(46 / 65)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">81.87% <small>(289 / 353)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
947
948
949</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  ...
  constructor(public element: HTMLElement, public options: IFacetSliderOptions, bindings?: IComponentBindings, private slider?: Slider) {
    super(element, FacetSlider.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.hasAGraph() &amp;&amp; typeof d3 == 'undefined') {
...
<span class="cstat-no" title="statement not covered" >    $$(this.element).addClass('coveo-disabled-empty');</span>
  }
&nbsp;
  /**
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private handlePopulateSearchAlerts(args: ISearchAlertsPopulateMessageEventArgs)</span> {
<span class="cstat-no" title="statement not covered" >    if (this.isActive()) {</span>
<span class="cstat-no" title="statement not covered" >      args.text.push($$(this.buildBreadcrumbFacetSlider()).text());</span>
    }
  }
&nbsp;
...
&nbsp;
    this.slider = this.slider ? <span class="branch-0 cbranch-no" title="branch not covered" >this.slider </span>: new Slider(sliderDiv, _.extend({}, this.options, { dateField: this.options.dateField }), this.root);
...
&nbsp;
  private renderToSliderGraph(data: IQuerySuccessEventArgs) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (rawGroupByResults) {
      graphData = _.map(rawGroupByResults.values, (value) =&gt; {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.options.dateField) {
          start = Number(start);
          end = Number(end);
        } else {
...
<span class="cstat-no" title="statement not covered" >          end = new Date(end.split('@')[0]).getTime();</span>
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (totalGraphResults == 0) {
<span class="cstat-no" title="statement not covered" >      this.isEmpty = true;</span>
<span class="cstat-no" title="statement not covered" >      this.updateAppearanceDependingOnState();</span>
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (graphData != undefined &amp;&amp; !this.isDropdownHidden()) {
<span class="cstat-no" title="statement not covered" >      this.slider.drawGraph(graphData);</span>
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (graphData != undefined &amp;&amp; this.isDropdownHidden()) {
...
&nbsp;
  private isDropdownHidden() {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (facetDropdown) {
      return $$(&lt;HTMLElement&gt;facetDropdown).css('display') == 'none';
    }
<span class="cstat-no" title="statement not covered" >    if ($$(this.root).hasClass('CoveoRecommendation')) {</span>
<span class="cstat-no" title="statement not covered" >      let recommendationDropdown = $$(this.root).parents('.coveo-recommendation-column')[0] || this.root;</span>
<span class="cstat-no" title="statement not covered" >      return $$(&lt;HTMLElement&gt;recommendationDropdown).css('display') == 'none';</span>
    }
&nbsp;
