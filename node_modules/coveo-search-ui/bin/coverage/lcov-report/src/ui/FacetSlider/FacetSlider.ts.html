...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/FacetSlider/FacetSlider.ts</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">src/ui/FacetSlider/FacetSlider.ts</span></h1>
    <h2>
        Statements: <span class="metric">74.38% <small>(270 / 363)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">59.14% <small>(110 / 186)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">63.49% <small>(40 / 63)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">73.84% <small>(254 / 344)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/FacetSlider/</a> &#187; FacetSlider.ts</div>
</div>
<div class="body">
...
836
837
838</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/// &lt;reference path="../Facet/FacetHeader.ts" /&gt;
...
&nbsp;
  ...
  static options: IFacetSliderOptions = {
     ...
     * ```
     */
    getSteps: ComponentOptions.buildCustomOption&lt;(start: number, end: number) =&gt; number[]&gt;(<span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      return null;</span>
     ...
     * ```
     */
    valueCaption: ComponentOptions.buildCustomOption&lt;(values: number[]) =&gt; string&gt;(<span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      return null;</span>
    }),
    /**
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.excludeOuterBounds == null) {
<span class="cstat-no" title="statement not covered" >      this.options.excludeOuterBounds = false;</span>
    }
&nbsp;
    if (this.options.start) {
      this.options.start = this.options.dateField ? &lt;any&gt;new Date(this.options.start.replace(/-/g, '/')).getTime() : &lt;any&gt;<span class="branch-1 cbranch-no" title="branch not covered" >Number(this.options.start);</span>
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.options.end) {
      this.options.end = this.options.dateField ? &lt;any&gt;new Date(this.options.end.replace(/-/g, '/')).getTime() : &lt;any&gt;Number(this.options.end);
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.hasAGraph()) {
<span class="cstat-no" title="statement not covered" >      if (!FeatureDetectionUtils.supportSVG()) {</span>
<span class="cstat-no" title="statement not covered" >        this.options.graph = undefined;</span>
<span class="cstat-no" title="statement not covered" >        this.logger.info('Your browser does not support SVG. Cannot add graphic to your facet range', this);</span>
      }
<span class="cstat-no" title="statement not covered" >      if (typeof d3 == 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >        this.options.graph = undefined;</span>
<span class="cstat-no" title="statement not covered" >        this.logger.info('Cannot find the required dependencies d3.js. Cannot add graphic to your facet range', this);</span>
      }
    }
&nbsp;
    ...
    this.bind.onRootElement(QueryEvents.noResults, <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.handleNoresults())</span>;
    ...
    this.bind.onRootElement(BreadcrumbEvents.clearBreadcrumb, <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.reset())</span>
&nbsp;
    this.onResize = _.debounce(<span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      if (!ResponsiveComponentsUtils.isSmallFacetActivated($$(this.root)) &amp;&amp; this.slider) {</span>
<span class="cstat-no" title="statement not covered" >        this.slider.drawGraph();</span>
      }
    }, 250);
...
<span class="cstat-no" title="statement not covered" >    if (this.slider) {</span>
<span class="cstat-no" title="statement not covered" >      this.slider.initializeState();</span>
<span class="cstat-no" title="statement not covered" >      this.updateQueryState();</span>
<span class="cstat-no" title="statement not covered" >      this.updateAppearanceDependingOnState();</span>
    }
  }
&nbsp;
  /**
...
<span class="fstat-no" title="function not covered" >  public drawDelayedGraphData() {</span>
<span class="cstat-no" title="statement not covered" >    if (this.delayedGraphData != undefined) {</span>
<span class="cstat-no" title="statement not covered" >      this.slider.drawGraph(this.delayedGraphData);</span>
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private handleNoresults(): void {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private handleRangeQueryStateChanged(args: IAttributeChangedEventArg)</span>: void {
<span class="cstat-no" title="statement not covered" >    this.setupSliderIfNeeded(args);</span>
<span class="cstat-no" title="statement not covered" >    this.startOfSlider = args.value[0] == undefined ? this.startOfSlider : args.value[0];</span>
<span class="cstat-no" title="statement not covered" >    this.endOfSlider = args.value[1] == undefined ? this.endOfSlider : args.value[1];</span>
<span class="cstat-no" title="statement not covered" >    this.setSelectedValues([this.startOfSlider, this.endOfSlider]);</span>
  }
&nbsp;
  private handlePopulateBreadcrumb(args: IPopulateBreadcrumbEventArgs): void {
    let populateBreadcrumb = () =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.isActive()) {
    ...
    if (this.slider) {
      ...
      $$(this.root).one(QueryEvents.deferredQuerySuccess, <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        populateBreadcrumb();</span>
<span class="cstat-no" title="statement not covered" >        $$(this.root).trigger(BreadcrumbEvents.redrawBreadcrumb);</span>
      })
    }
  }
&nbsp;
...
&nbsp;
    value.on('click', <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      this.reset();</span>
<span class="cstat-no" title="statement not covered" >      this.usageAnalytics.logSearchEvent&lt;IAnalyticsFacetMeta&gt;(analyticsActionCauseList.facetClearAll, {</span>
...
&nbsp;
  private initQueryStateEvents() {
    ...
    this.bind.onRootElement(eventName, <span class="fstat-no" title="function not covered" >(args: IAttributeChangedEventArg)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      this.slider ? this.handleRangeQueryStateChanged(args) : this.setRangeStateSliderStillNotCreated(args);</span>
    })
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private setRangeStateSliderStillNotCreated(args: IAttributeChangedEventArg)</span> {
<span class="cstat-no" title="statement not covered" >    this.rangeFromUrlState = this.copyValues(args.value);</span>
  }
&nbsp;
  private buildSlider() {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.hasAGraph()) {
<span class="cstat-no" title="statement not covered" >      $$(sliderContainer).addClass('coveo-with-graph');</span>
    }
    let sliderDiv = $$('div').el;
&nbsp;
    this.slider = new Slider(sliderDiv, _.extend({}, this.options, { dateField: this.options.dateField }), this.root);
    $$(sliderDiv).on(SliderEvents.endSlide, <span class="fstat-no" title="function not covered" >(e: MouseEvent, args: IEndSlideEventArgs)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      this.handleEndSlide(args);</span>
    });
    $$(sliderDiv).on(SliderEvents.duringSlide, <span class="fstat-no" title="function not covered" >(e: MouseEvent, args: IDuringSlideEventArgs)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      this.handleDuringSlide(args);</span>
    });
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.hasAGraph()) {
<span class="cstat-no" title="statement not covered" >      $$(sliderDiv).on(SliderEvents.graphValueSelected, <span class="fstat-no" title="function not covered" >(e: MouseEvent, args: IGraphValueSelectedArgs)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        this.handleGraphValueSelected(args);</span>
      })
    }
...
&nbsp;
  private handleDeferredQuerySuccess(data: IQuerySuccessEventArgs) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (groupByResults == undefined || <span class="branch-1 cbranch-no" title="branch not covered" >groupByResults.values[0] == undefined)</span> {
      this.isEmpty = true;
    }
    this.updateAppearanceDependingOnState();
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.hasAGraph()) {
<span class="cstat-no" title="statement not covered" >      this.renderToSliderGraph(data);</span>
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private handleEndSlide(args: IEndSlideEventArgs)</span> {
<span class="cstat-no" title="statement not covered" >    let values = args.slider.getValues();</span>
<span class="cstat-no" title="statement not covered" >    this.startOfSlider = values[0];</span>
<span class="cstat-no" title="statement not covered" >    this.endOfSlider = values[1];</span>
<span class="cstat-no" title="statement not covered" >    if (this.updateQueryState(values)) {</span>
<span class="cstat-no" title="statement not covered" >      this.updateAppearanceDependingOnState();</span>
<span class="cstat-no" title="statement not covered" >      this.usageAnalytics.logSearchEvent&lt;IAnalyticsFacetSliderChangeMeta&gt;(analyticsActionCauseList.facetRangeSlider, {</span>
        facetId: this.options.id,
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private handleDuringSlide(args: IDuringSlideEventArgs)</span> {
<span class="cstat-no" title="statement not covered" >    let values = args.slider.getValues();</span>
<span class="cstat-no" title="statement not covered" >    this.startOfSlider = values[0];</span>
<span class="cstat-no" title="statement not covered" >    this.endOfSlider = values[1];</span>
<span class="cstat-no" title="statement not covered" >    this.slider.setValues([this.startOfSlider, this.endOfSlider]);</span>
<span class="cstat-no" title="statement not covered" >    this.updateAppearanceDependingOnState(true);</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private handleGraphValueSelected(args: IGraphValueSelectedArgs)</span> {
<span class="cstat-no" title="statement not covered" >    if ((this.options.rangeSlider &amp;&amp; this.startOfSlider != args.start) || this.endOfSlider != args.end) {</span>
<span class="cstat-no" title="statement not covered" >      if (this.options.rangeSlider) {</span>
<span class="cstat-no" title="statement not covered" >        this.startOfSlider = args.start;</span>
      }
<span class="cstat-no" title="statement not covered" >      this.endOfSlider = args.end;</span>
<span class="cstat-no" title="statement not covered" >      this.slider.setValues([this.startOfSlider, this.endOfSlider]);</span>
<span class="cstat-no" title="statement not covered" >      this.updateQueryState();</span>
<span class="cstat-no" title="statement not covered" >      this.usageAnalytics.logSearchEvent&lt;IAnalyticsFacetGraphSelectedMeta&gt;(analyticsActionCauseList.facetRangeGraph, {</span>
        facetId: this.options.id,
        facetRangeStart: this.startOfSlider.toString(),
        facetRangeEnd: this.endOfSlider.toString()
      });
...
&nbsp;
  private updateQueryState(<span class="missing-if-branch" title="else path not taken" >E</span>values = this.slider.getValues(), <span class="missing-if-branch" title="else path not taken" >E</span>silent = false) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  private renderToSliderGraph(data: IQuerySuccessEventArgs)</span> {</span>
<span class="cstat-no" title="statement not covered" >    let rawGroupByResults = data.results.groupByResults[this.facetQueryController.graphGroupByQueriesIndex];</span>
<span class="cstat-no" title="statement not covered" >    let graphData: ISliderGraphData[];</span>
<span class="cstat-no" title="statement not covered" >    let totalGraphResults = 0;</span>
<span class="cstat-no" title="statement not covered" >    if (rawGroupByResults) {</span>
<span class="cstat-no" title="statement not covered" >      graphData = _.map(rawGroupByResults.values, <span class="fstat-no" title="function not covered" >(value)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        totalGraphResults += value.numberOfResults;</span>
<span class="cstat-no" title="statement not covered" >        let start: any = value.value.split('..')[0];</span>
<span class="cstat-no" title="statement not covered" >        let end: any = value.value.split('..')[1];</span>
<span class="cstat-no" title="statement not covered" >        if (!this.options.dateField) {</span>
<span class="cstat-no" title="statement not covered" >          start = Number(start);</span>
<span class="cstat-no" title="statement not covered" >          end = Number(end);</span>
        } else {
<span class="cstat-no" title="statement not covered" >          start = new Date(start.split('@')[0]).getTime();</span>
<span class="cstat-no" title="statement not covered" >          end = new Date(end.split('@')[0]).getTime();</span>
        }
<span class="cstat-no" title="statement not covered" >        let y = value.numberOfResults;</span>
...
<span class="cstat-no" title="statement not covered" >    if (totalGraphResults == 0) {</span>
<span class="cstat-no" title="statement not covered" >      this.isEmpty = true;</span>
<span class="cstat-no" title="statement not covered" >      this.updateAppearanceDependingOnState();</span>
    } else <span class="cstat-no" title="statement not covered" >if (graphData != undefined &amp;&amp; !this.isFacetDropdownHidden()) {</span>
<span class="cstat-no" title="statement not covered" >      this.slider.drawGraph(graphData);</span>
    } else <span class="cstat-no" title="statement not covered" >if (graphData != undefined &amp;&amp; this.isFacetDropdownHidden()) {</span>
<span class="cstat-no" title="statement not covered" >      this.delayedGraphData = graphData;</span>
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private isFacetDropdownHidden() {</span>
<span class="cstat-no" title="statement not covered" >    let facetDropdown = this.root.querySelector('.coveo-facet-column');</span>
<span class="cstat-no" title="statement not covered" >    if (facetDropdown) {</span>
<span class="cstat-no" title="statement not covered" >      return $$(&lt;HTMLElement&gt;facetDropdown).css('display') == 'none';</span>
    }
...
&nbsp;
  private generateBoundary(): number[] {
    if (!this.slider) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (boundary[0] == undefined &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >boundary[1] == undefined)</span> {
<span class="cstat-no" title="statement not covered" >        return this.generateBoundaryFromState();</span>
      } else {
        return boundary;
      }
    }
...
&nbsp;
  private generateBoundaryFromSlider() {
    let start, end;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.startOfSlider != undefined) {
      start = this.startOfSlider;
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.endOfSlider != undefined) {
...
&nbsp;
  private generateBoundaryFromState() {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (startFromState != undefined) {
      start = startFromState;
    }
    let endFromState = this.queryStateModel.get(this.rangeQueryStateAttribute)[1];
    <span class="missing-if-branch" title="else path not taken" >E</span>if (endFromState != undefined) {
      end = endFromState;
    }
...
&nbsp;
  private setupSliderIfNeeded(data: any) {
    ...
    if (Utils.isNullOrUndefined(this.slider)) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.alreadySetBoundary()) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (isInError) {
<span class="cstat-no" title="statement not covered" >        this.logger.warn('Unable to initialize slider with current values', this);</span>
      } else {
        this.initSlider();
...
&nbsp;
  private verifySetup() {
    let isInError = 0;
    isInError += this.initialStartOfSlider == undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >1 </span>: 0;
    isInError += isNaN(this.initialStartOfSlider) ? <span class="branch-0 cbranch-no" title="branch not covered" >1 </span>: 0;
    isInError += this.initialEndOfSlider == undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >1 </span>: 0;
    isInError += isNaN(this.initialEndOfSlider) ? <span class="branch-0 cbranch-no" title="branch not covered" >1 </span>: 0;
    return isInError;
  }
&nbsp;
  private setupSliderStateVariables() {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (isNaN(this.initialStartOfSlider) || isNaN(this.initialEndOfSlider)) {
<span class="cstat-no" title="statement not covered" >      this.logger.warn('Cannnot initialize slider with those values : start: ' + this.initialStartOfSlider + ' end: ' + this.initialEndOfSlider)</span>
    } else {
...
&nbsp;
  private alreadySetBoundary() {
    return this.startOfSlider != undefined &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.endOfSlider != undefined;</span>
  }
&nbsp;
  private trySetSliderBoundaryFromOptions() {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!Utils.isNullOrUndefined(this.options.start)) {
      this.setupInitialSliderStateStart(this.options.start);
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!Utils.isNullOrUndefined(this.options.end)) {
...
&nbsp;
  private trySetSliderBoundaryFromQueryResult(data: IQuerySuccessEventArgs) {
    let groupByResults = data.results.groupByResults[this.facetQueryController.lastGroupByRequestIndex];
    <span class="missing-if-branch" title="if path not taken" >I</span>if (groupByResults &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >groupByResults.values.length &gt; 0)</span> {
<span class="cstat-no" title="statement not covered" >      this.setupInitialSliderStateStart(groupByResults.values[0].value.split('..')[0]);</span>
<span class="cstat-no" title="statement not covered" >      this.setupInitialSliderStateEnd(groupByResults.values[groupByResults.values.length - 1].value.split('..')[1]);</span>
    }
  }
&nbsp;
  private setupInitialSliderStateStart(value: any) {
    if (this.initialStartOfSlider == undefined) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.dateField &amp;&amp; isNaN(value)) {
<span class="cstat-no" title="statement not covered" >        this.initialStartOfSlider = new Date(value.replace('@', ' ')).getTime();</span>
      }
    }
  }
&nbsp;
  private setupInitialSliderStateEnd(value: any) {
    if (this.initialEndOfSlider == undefined) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.dateField &amp;&amp; isNaN((value))) {
<span class="cstat-no" title="statement not covered" >        this.initialEndOfSlider = new Date(value.replace('@', ' ')).getTime();</span>
      }
    }
  }
&nbsp;
...
&nbsp;
  private updateAppearanceDependingOnState(<span class="missing-if-branch" title="else path not taken" >E</span>sliding = false) {
