...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/DidYouMean/DidYouMean.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/DidYouMean/DidYouMean.ts</span></h1>
    <h2>
        Statements: <span class="metric">97.87% <small>(92 / 94)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">81.82% <small>(9 / 11)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">90.91% <small>(10 / 11)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">97.7% <small>(85 / 87)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/DidYouMean/</a> &#187; DidYouMean.ts</div>
</div>
<div class="body">
...
&nbsp;
    super(element, DidYouMean.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
&nbsp;
...
&nbsp;
  private handleNewQuery() {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.hideNext) {
      $$(this.element).empty();
      $$(this.element).hide();
      this.correctedTerm = null;
    } else {
<span class="cstat-no" title="statement not covered" >      this.hideNext = true;</span>
    }
  }
&nbsp;
...
&nbsp;
      $$(searchTerm).on('click', <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        this.doQueryWithCorrectedTerm();</span>
      });
&nbsp;
      $$(this.element).show();
    }
