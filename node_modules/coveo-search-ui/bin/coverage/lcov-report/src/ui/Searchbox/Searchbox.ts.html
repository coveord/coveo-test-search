...
<div class="header medium">
    ...
    <h2>
        ...
        Lines: <span class="metric">58.06% <small>(18 / 31)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {IOmniboxOptions} from '../Omnibox/Omnibox';
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  constructor(public <span class="cstat-no" title="statement not covered" >element: HTMLElement,</span> public <span class="cstat-no" title="statement not covered" >options?: ISearchboxOptions,</span> bindings?: IComponentBindings)</span> {
<span class="cstat-no" title="statement not covered" >    super(element, Searchbox.ID, bindings);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.options = ComponentOptions.initComponentOptions(element, Searchbox, options);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.options.inline) {</span>
<span class="cstat-no" title="statement not covered" >      $$(element).addClass('coveo-inline');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.options.addSearchButton) {</span>
<span class="cstat-no" title="statement not covered" >      var anchor = document.createElement('a');</span>
<span class="cstat-no" title="statement not covered" >      this.element.appendChild(anchor);</span>
<span class="cstat-no" title="statement not covered" >      this.searchButton = new SearchButton(anchor, undefined, bindings);</span>
    }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.options.enableOmnibox) {</span>
<span class="cstat-no" title="statement not covered" >      this.searchbox = new Omnibox(div, this.options, bindings)</span>
    } else {
<span class="cstat-no" title="statement not covered" >      this.searchbox = new Querybox(div, this.options, bindings)</span>
    }
  }
}
&nbsp;
