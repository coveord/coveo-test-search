...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/Facet/FacetSort.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/Facet/FacetSort.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/Facet/</a> &#187; FacetSort.ts</div>
</div>
<div class="body">
...
&nbsp;
  constructor(sorts: string[], public facet: Facet) {
    ...
    if (Utils.isNonEmptyArray(this.enabledSorts)) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.facet.options.sortCriteria != undefined) {
...
&nbsp;
  private removeEnabledSortsBasedOnFacetType() {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Coveo.FacetRange &amp;&amp; this.facet instanceof Coveo.FacetRange) {
<span class="cstat-no" title="statement not covered" >      var facetRange = this.facet;</span>
<span class="cstat-no" title="statement not covered" >      if (facetRange.options['slider']) {</span>
<span class="cstat-no" title="statement not covered" >        this.enabledSorts = [];</span>
      }
    }
  }
}
