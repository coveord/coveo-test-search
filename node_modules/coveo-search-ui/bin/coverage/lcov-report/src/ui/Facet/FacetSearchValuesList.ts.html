...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/Facet/FacetSearchValuesList.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/Facet/FacetSearchValuesList.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/Facet/</a> &#187; FacetSearchValuesList.ts</div>
</div>
<div class="body">
...
&nbsp;
  public build(facetValues: FacetValue[]): HTMLElement[] {
    var valuesToBuildWith = _.map(facetValues, (facetValue) =&gt; {
      return _.find(this.facet.values.getAll(), <span class="fstat-no" title="function not covered" >(valueAlreadyInFacet: FacetValue)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >        return valueAlreadyInFacet.value == facetValue.value;</span>
      }) || facetValue;
    });
