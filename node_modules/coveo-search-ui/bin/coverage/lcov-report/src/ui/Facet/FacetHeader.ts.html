...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/Facet/FacetHeader.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/Facet/FacetHeader.ts</span></h1>
    <h2>
        Statements: <span class="metric">92.31% <small>(156 / 169)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">70.97% <small>(44 / 62)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">83.33% <small>(20 / 24)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">93.67% <small>(148 / 158)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/Facet/</a> &#187; FacetHeader.ts</div>
</div>
<div class="body">
...
&nbsp;
  public switchToAnd(): void {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.options.facet) {
...
&nbsp;
  public collapseFacet(): void {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.collapseElement &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.expandElement)</span> {
<span class="cstat-no" title="statement not covered" >      $$(this.collapseElement).hide();</span>
<span class="cstat-no" title="statement not covered" >      $$(this.expandElement).show();</span>
    }
...
&nbsp;
  public expandFacet(): void {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.collapseElement &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.expandElement)</span> {
<span class="cstat-no" title="statement not covered" >      $$(this.expandElement).hide();</span>
<span class="cstat-no" title="statement not covered" >      $$(this.collapseElement).show();</span>
    }
...
&nbsp;
  public updateOperatorQueryStateModel(): void {
    if (this.options.facet &amp;&amp; this.options.facet.options.enableTogglingOperator) {
      var valueToSet = '';
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.options.facet.getSelectedValues().length != 0 || <span class="branch-1 cbranch-no" title="branch not covered" >this.options.facet.getExcludedValues().length != 0)</span> {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.options.settingsKlass) {
      this.sort = this.settings = new this.options.settingsKlass(this.options.availableSorts, this.options.facet);
      this.element.appendChild(this.settings.build());
    } else <span class="cstat-no" title="statement not covered" >if (this.options.sortKlass) {</span>
<span class="cstat-no" title="statement not covered" >      this.sort = new this.options.sortKlass(this.options.availableSorts, this.options.facet);</span>
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.options.enableCollapseElement) {
...
&nbsp;
  private rebuildOperatorToggle(): void {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.operatorElement) {
...
&nbsp;
    $$(collapse).on('click', <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.collapseFacet())</span>;
&nbsp;
    return collapse;
  }
&nbsp;
...
&nbsp;
    ...
    $$(expand).on('click', <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.expandFacet())</span>;
    return expand;
  }
&nbsp;
...
&nbsp;
  private handleOperatorClick(): void {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.options.facet.getSelectedValues().length != 0) {
      var operatorNow = this.options.facet.options.useAnd ? 'AND' : 'OR';
      var operatorBefore = this.options.facet.options.useAnd ? 'OR' : 'AND';
      this.options.facet.triggerNewQuery(<span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.options.facet.usageAnalytics.logSearchEvent&lt;IAnalyticsFacetOperatorMeta&gt;(analyticsActionCauseList.facetToggle, {</span>
...
&nbsp;
    ...
    $$(eraser).on('click', <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      var cmp = this.options.facet || this.options.facetSlider;</span>
<span class="cstat-no" title="statement not covered" >      cmp.reset();</span>
<span class="cstat-no" title="statement not covered" >      cmp.usageAnalytics.logSearchEvent&lt;IAnalyticsFacetMeta&gt;(analyticsActionCauseList.facetClearAll, {</span>
        facetId: cmp.options.id,
        facetTitle: cmp.options.title
      });
<span class="cstat-no" title="statement not covered" >      cmp.queryController.executeQuery();</span>
    });
    return eraser;
  }
}
