...
<div class="header medium">
    ...
    <h2>
        Statements: <span class="metric">73.94% <small>(522 / 706)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">57.27% <small>(130 / 227)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">66.44% <small>(99 / 149)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">74.16% <small>(488 / 658)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
1583
1584
1585</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  protected rebuildValueElements() {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.shouldRenderMoreLess()) {
      this.updateMoreLess();
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.shouldRenderFacetSearch() &amp;&amp; this.searchInterface.isNewDesign()) {
        this.updateSearchInNewDesign(this.nbAvailableValues &gt; this.numberOfValues);
      }
    } else <span class="cstat-no" title="statement not covered" >if (this.shouldRenderFacetSearch() &amp;&amp; this.searchInterface.isNewDesign()) {</span>
...
<span class="cstat-no" title="statement not covered" >        $$(built.label).on('click', <span class="fstat-no" title="function not covered" >(e: Event)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          if (built.checkbox.getAttribute('checked')) {</span>
<span class="cstat-no" title="statement not covered" >            built.checkbox.removeAttribute('checked');</span>
          } else {
<span class="cstat-no" title="statement not covered" >            built.checkbox.setAttribute('checked', 'checked');</span>
          }
<span class="cstat-no" title="statement not covered" >          $$(built.checkbox).trigger('change');</span>
...
&nbsp;
      $$(built.checkbox).on('change', <span class="fstat-no" title="function not covered" >() =&gt; {</span>
...
&nbsp;
  private buildMore(): HTMLElement {
    if (this.searchInterface.isNewDesign()) {
      ...
      $$(more).on('click', <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.handleClickMore())</span>
      return more;
    } else {
...
&nbsp;
  private buildLess(): HTMLElement {
    if (this.searchInterface.isNewDesign()) {
      ...
      $$(less).on('click', <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.handleClickLess())</span>;
      return less;
    } else {
...
&nbsp;
    ...
    if (this.options.customSort != null &amp;&amp; this.facetSort != null &amp;&amp; this.options.customSort.length &gt; 0) {
      ...
      new FacetValuesOrder(this, this.facetSort).reorderValues(this.values.getAll()).forEach((facetValue, index) =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (facetValue.selected) {
<span class="cstat-no" title="statement not covered" >          lastSelectedValueIndex = index;</span>
        }
      });
