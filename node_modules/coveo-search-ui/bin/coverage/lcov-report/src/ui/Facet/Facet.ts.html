...
<div class="header medium">
    ...
    <h2>
        Statements: <span class="metric">73.85% <small>(531 / 719)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">56.9% <small>(136 / 239)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">66.89% <small>(101 / 151)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">73.92% <small>(496 / 671)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
1877
1878
1879</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    ...
    numberOfValuesInBreadcrumb: ComponentOptions.buildNumberOption({
      defaultFunction: () =&gt; DeviceUtils.isMobileDevice() ? <span class="branch-0 cbranch-no" title="branch not covered" >3 </span>: 5,
      min: 0,
...
&nbsp;
  ...
  public getValueCaption(facetValue: any): string {
    ...
    let lookupValue = facetValue.lookupValue || <span class="branch-1 cbranch-no" title="branch not covered" >facetValue.value;</span>
    let ret = lookupValue;
...
<span class="cstat-no" title="statement not covered" >      args.text.push(new BreadcrumbValueList(this, this.values.getSelected().concat(this.values.getExcluded()), BreadcrumbValueElement).buildAsString());</span>
    }
  }
&nbsp;
