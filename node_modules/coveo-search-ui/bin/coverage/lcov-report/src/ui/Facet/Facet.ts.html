...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/Facet/Facet.ts</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">src/ui/Facet/Facet.ts</span></h1>
    <h2>
        Statements: <span class="metric">73.24% <small>(531 / 725)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">56.38% <small>(137 / 243)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">66.89% <small>(101 / 151)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">73.26% <small>(496 / 677)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/Facet/</a> &#187; Facet.ts</div>
</div>
<div class="body">
...
1825
1826
1827</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/// &lt;reference path="../../controllers/HierarchicalFacetQueryController.ts" /&gt;
...
&nbsp;
     ...
     */
    sortCriteria: ComponentOptions.buildStringOption({ postProcessing: (value, options: IFacetOptions) =&gt; value || (options.availableSorts.length &gt; 0 ? options.availableSorts[0] : <span class="branch-1 cbranch-no" title="branch not covered" >'occurrences')</span> }),
&nbsp;
    /**
...
&nbsp;
     ...
     */
    numberOfValuesInBreadcrumb: ComponentOptions.buildNumberOption({ defaultFunction: () =&gt; DeviceUtils.isMobileDevice() ? <span class="branch-0 cbranch-no" title="branch not covered" >3 </span>: 5, min: 0, depend: 'includeInBreadcrumb' }),
&nbsp;
...
&nbsp;
    numberOfValuesInOmnibox: ComponentOptions.buildNumberOption({ defaultFunction: () =&gt; DeviceUtils.isMobileDevice() ? <span class="branch-0 cbranch-no" title="branch not covered" >3 </span>: 5, min: 0, depend: 'includeInOmnibox', deprecated: 'This option is exposed for legacy reasons, and the recommendation is to not use this option.' }),
&nbsp;
    /**
...
&nbsp;
     ...
     * ```
     */
    valueCaption: ComponentOptions.buildCustomOption&lt;IStringMap&lt;string&gt;&gt;(<span class="fstat-no" title="function not covered" >() =&gt; {</span>
...
&nbsp;
  ...
  constructor(public element: HTMLElement, public options: IFacetOptions, bindings?: IComponentBindings, facetClassId: string = Facet.ID) {
    super(element, facetClassId, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
    this.options = ComponentOptions.initComponentOptions(element, Facet, options);
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.valueCaption != null) {
<span class="cstat-no" title="statement not covered" >      this.options.availableSorts = _.filter(this.options.availableSorts, <span class="fstat-no" title="function not covered" >(sort: string)</span> =&gt; <span class="cstat-no" title="statement not covered" >!/^alpha.*$/.test(sort))</span>;</span>
    }
&nbsp;
...
&nbsp;
    this.resize = <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      if (!this.disabled) {</span>
<span class="cstat-no" title="statement not covered" >        FacetUtils.clipCaptionsToAvoidOverflowingTheirContainer(this);</span>
      }
    };
    window.addEventListener('resize', _.debounce(this.resize, 200));
    this.bind.onRootElement(InitializationEvents.nuke, <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.handleNuke())</span>;
&nbsp;
...
&nbsp;
  public createDom() {
    ...
    if (this.facetSettings &amp;&amp; this.options.enableSettingsFacetState) {
      let loadOnce = &lt;(args: INewQueryEventArgs) =&gt; any&gt;_.once(<span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        this.facetSettings.loadSavedState.apply(this.facetSettings);</span>
      });
...
&nbsp;
  ...
  public updateSort(criteria: string): void {
    this.ensureDom();
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.options.sortCriteria != criteria) {
...
&nbsp;
  ...
  public showWaitingAnimation() {
    ...
    if (!this.showingWaitAnimation) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.searchInterface.isNewDesign()) {
<span class="cstat-no" title="statement not covered" >        $$(this.headerElement).find('.coveo-icon').style.display = 'none';</span>
<span class="cstat-no" title="statement not covered" >        $$(this.headerElement).find('.coveo-facet-header-wait-animation').style.display = '';</span>
      } else {
...
&nbsp;
  ...
  public hideWaitingAnimation(): void {
    ...
    if (this.showingWaitAnimation) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.searchInterface.isNewDesign()) {
<span class="cstat-no" title="statement not covered" >        $$(this.headerElement).find('.coveo-facet-header-wait-animation').style.display = 'none';</span>
      } else {
...
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  public processFacetSearchAllResultsSelected(facetValues: FacetValue[])</span>: void {</span>
<span class="cstat-no" title="statement not covered" >    let valuesForAnalytics = [];</span>
<span class="cstat-no" title="statement not covered" >    _.each(facetValues, <span class="fstat-no" title="function not covered" >(facetValue)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      this.ensureFacetValueIsInList(facetValue);</span>
<span class="cstat-no" title="statement not covered" >      valuesForAnalytics.push(facetValue.value);</span>
    });
...
<span class="cstat-no" title="statement not covered" >    let valuesThatStays = this.values.getSelected().concat(this.values.getExcluded());</span>
<span class="cstat-no" title="statement not covered" >    this.numberOfValues = valuesThatStays.length + _.difference(valuesThatStays, facetValues).length;</span>
<span class="cstat-no" title="statement not covered" >    this.numberOfValues = Math.max(this.numberOfValues, this.options.numberOfValues);</span>
...
<span class="cstat-no" title="statement not covered" >    this.currentPage = Math.floor((this.numberOfValues - this.options.numberOfValues) / this.options.pageSize);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.updateQueryStateModel();</span>
<span class="cstat-no" title="statement not covered" >    this.triggerNewQuery(<span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.usageAnalytics.logSearchEvent&lt;IAnalyticsFacetMeta&gt;(analyticsActionCauseList.facetSelectAll, {</span></span>
      facetId: this.options.id,
      facetTitle: this.options.title
    }));
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  public pinFacetPosition() {</span>
<span class="cstat-no" title="statement not covered" >    if (this.options.preservePosition) {</span>
<span class="cstat-no" title="statement not covered" >      this.pinnedViewportPosition = this.element.getBoundingClientRect().top;</span>
    }
  }
&nbsp;
  /**
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Utils.exists(this.options.valueCaption)) {
<span class="cstat-no" title="statement not covered" >      if (typeof this.options.valueCaption == 'object') {</span>
<span class="cstat-no" title="statement not covered" >        ret = this.options.valueCaption[lookupValue] || ret;</span>
      }
<span class="cstat-no" title="statement not covered" >      if (typeof this.options.valueCaption == 'function') {</span>
<span class="cstat-no" title="statement not covered" >        this.values.get(lookupValue);</span>
<span class="cstat-no" title="statement not covered" >        ret = this.options.valueCaption.call(this, this.facetValuesList.get(lookupValue).facetValue);</span>
      }
    }
    return ret;
  }
&nbsp;
  ...
  public showMore() {
    this.currentPage++;
    this.updateNumberOfValues();
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.nbAvailableValues &gt;= this.numberOfValues || !this.canFetchMore) {
<span class="cstat-no" title="statement not covered" >      this.rebuildValueElements();</span>
    } else {
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  public showLess() {</span>
<span class="cstat-no" title="statement not covered" >    $$(this.lessElement).removeClass('coveo-active');</span>
<span class="cstat-no" title="statement not covered" >    this.currentPage = 0;</span>
<span class="cstat-no" title="statement not covered" >    this.updateNumberOfValues();</span>
<span class="cstat-no" title="statement not covered" >    $$(this.moreElement).addClass('coveo-active');</span>
<span class="cstat-no" title="statement not covered" >    this.values.sortValuesDependingOnStatus(this.numberOfValues);</span>
<span class="cstat-no" title="statement not covered" >    this.rebuildValueElements();</span>
  }
&nbsp;
  /**
  ...
  public collapse() {
    this.ensureDom();
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.facetHeader) {
...
&nbsp;
  protected handlePopulateBreadcrumb(args: IPopulateBreadcrumbEventArgs) {
    Assert.exists(args);
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.values.hasSelectedOrExcludedValues()) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  protected handlePopulateSearchAlerts(args: ISearchAlertsPopulateMessageEventArgs)</span> {
<span class="cstat-no" title="statement not covered" >    if (this.values.hasSelectedOrExcludedValues()) {</span>
<span class="cstat-no" title="statement not covered" >      let excludedValues = this.values.getExcluded();</span>
<span class="cstat-no" title="statement not covered" >      let selectedValues = this.values.getSelected();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!_.isEmpty(excludedValues)) {</span>
<span class="cstat-no" title="statement not covered" >        args.text.push({</span>
          value: new BreadcrumbValueList(this, excludedValues, BreadcrumbValueElement).buildAsString(),
          lineThrough: true
        });
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!_.isEmpty(selectedValues)) {</span>
<span class="cstat-no" title="statement not covered" >        args.text.push({</span>
...
&nbsp;
    this.bind.onQueryState(MODEL_EVENTS.CHANGE, undefined, <span class="fstat-no" title="function not covered" >(args: IAttributesChangedEventArg)</span> =&gt; <span class="cstat-no" title="statement not covered" >this.handleQueryStateChanged(args))</span>;
  }
&nbsp;
...
&nbsp;
  protected initBreadCrumbEvents() {
    if (this.options.includeInBreadcrumb) {
      ...
      this.bind.onRootElement(BreadcrumbEvents.clearBreadcrumb, <span class="fstat-no" title="function not covered" >(args: IClearBreadcrumbEventArgs)</span> =&gt; <span class="cstat-no" title="statement not covered" >this.handleClearBreadcrumb())</span>;
    }
  }
&nbsp;
  protected initSearchAlertEvents() {
    this.bind.onRootElement(SearchAlertsEvents.searchAlertsPopulateMessage, <span class="fstat-no" title="function not covered" >(args: ISearchAlertsPopulateMessageEventArgs)</span> =&gt; <span class="cstat-no" title="statement not covered" >this.handlePopulateSearchAlerts(args))</span>;
  }
&nbsp;
  protected handleOmniboxWithStaticValue(eventArg: IPopulateOmniboxEventArgs) {
    ...
    let match = _.first(_.filter(this.getDisplayedValues(), <span class="fstat-no" title="function not covered" >(displayedValue: string)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      let value = this.getValueCaption(this.facetValuesList.get(displayedValue).facetValue);</span>
<span class="cstat-no" title="statement not covered" >      return regex.test(value);</span>
    }), this.options.numberOfValuesInOmnibox);
    let facetValues = _.map(match, <span class="fstat-no" title="function not covered" >(gotAMatch: string)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      return this.facetValuesList.get(gotAMatch).facetValue;</span>
    });
...
&nbsp;
  protected rebuildValueElements() {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.searchInterface.isNewDesign()) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.shouldRenderMoreLess()) {
        this.updateMoreLess();
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.shouldRenderFacetSearch()) {
          this.updateSearchInNewDesign(this.nbAvailableValues &gt; this.numberOfValues);
        }
      } else <span class="cstat-no" title="statement not covered" >if (this.shouldRenderFacetSearch()) {</span>
<span class="cstat-no" title="statement not covered" >        this.updateSearchInNewDesign();</span>
      }
    } else {
<span class="cstat-no" title="statement not covered" >      if (this.shouldRenderMoreLess()) {</span>
<span class="cstat-no" title="statement not covered" >        this.updateMoreLess();</span>
      }
    }
  }
&nbsp;
  protected updateSearchInNewDesign(<span class="missing-if-branch" title="if path not taken" >I</span>moreValuesAvailable = true) {
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (DeviceUtils.isMobileDevice()) {
<span class="cstat-no" title="statement not covered" >        $$(searchButton.label).on('click', <span class="fstat-no" title="function not covered" >(e: Event)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          if (searchButton.checkbox.getAttribute('checked')) {</span>
<span class="cstat-no" title="statement not covered" >            searchButton.checkbox.removeAttribute('checked');</span>
          } else {
<span class="cstat-no" title="statement not covered" >            searchButton.checkbox.setAttribute('checked', 'checked');</span>
          }
<span class="cstat-no" title="statement not covered" >          $$(searchButton.checkbox).trigger('change');</span>
...
&nbsp;
      $$(searchButton.checkbox).on('change', <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        $$(this.element).addClass('coveo-facet-searching');</span>
<span class="cstat-no" title="statement not covered" >        this.facetSearch.focus();</span>
      });
...
&nbsp;
  protected updateMoreLess(lessElementIsShown = this.getMinimumNumberOfValuesToDisplay() &lt; this.numberOfValues, moreValuesAvailable = this.nbAvailableValues &gt; this.numberOfValues) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (lessElementIsShown) {
<span class="cstat-no" title="statement not covered" >      $$(this.lessElement).addClass('coveo-active');</span>
    } else {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  protected handleClickMore(): void {</span>
<span class="cstat-no" title="statement not covered" >    this.showMore();</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  protected handleClickLess() {</span>
<span class="cstat-no" title="statement not covered" >    this.showLess();</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private handleNuke() {</span>
...
&nbsp;
  private checkForComputedFieldAndSort() {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.sortCriteria.toLowerCase().indexOf('computedfield') != -1 &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >Utils.isNullOrUndefined(this.options.computedField))</span> {
<span class="cstat-no" title="statement not covered" >      this.logger.warn('Sort criteria is specified as ComputedField, but the facet uses no computed field. Facet will always be empty !', this);</span>
    }
  }
&nbsp;
  private checkForValueCaptionType() {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.valueCaption &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof this.options.valueCaption == 'function')</span> {
<span class="cstat-no" title="statement not covered" >      this.options.enableFacetSearch = false;</span>
<span class="cstat-no" title="statement not covered" >      this.options.includeInOmnibox = false;</span>
<span class="cstat-no" title="statement not covered" >      this.logger.warn('Using a function as valueCaption is now deprecated. Use a json key value pair instead. Facet search and omnibox has been disabled for this facet', this);</span>
    }
  }
&nbsp;
...
&nbsp;
  private initBottomAndTopSpacer() {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.options.preservePosition) {
      $$(this.options.paddingContainer).on('mouseleave', <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.unpinFacetPosition())</span>;
&nbsp;
...
&nbsp;
  private updateLookupValueQueryStateModel() {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.lookupField) {
<span class="cstat-no" title="statement not covered" >      let valueToSet = {};</span>
<span class="cstat-no" title="statement not covered" >      _.each(this.values.getSelected().concat(this.values.getExcluded()), <span class="fstat-no" title="function not covered" >(value)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        valueToSet[value.value] = value.lookupValue;</span>
      });
<span class="cstat-no" title="statement not covered" >      this.queryStateModel.set(this.lookupValueAttributeId, valueToSet);</span>
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private handleQueryStateChangedOperator(operator: string)</span> {
<span class="cstat-no" title="statement not covered" >    if (operator == 'and') {</span>
<span class="cstat-no" title="statement not covered" >      this.switchToAnd();</span>
    } else <span class="cstat-no" title="statement not covered" >if (operator == 'or') {</span>
<span class="cstat-no" title="statement not covered" >      this.switchToOr();</span>
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private handleQueryStateChangedIncluded(includedChanged)</span> {
<span class="cstat-no" title="statement not covered" >    let toUnSelect = _.difference(this.getSelectedValues(), includedChanged);</span>
<span class="cstat-no" title="statement not covered" >    if (Utils.isNonEmptyArray(toUnSelect)) {</span>
<span class="cstat-no" title="statement not covered" >      this.deselectMultipleValues(toUnSelect);</span>
    }
<span class="cstat-no" title="statement not covered" >    if (!Utils.arrayEqual(this.getSelectedValues(), includedChanged, false)) {</span>
<span class="cstat-no" title="statement not covered" >      this.selectMultipleValues(includedChanged);</span>
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private handleQueryStateChangedExcluded(excludedChanged)</span> {
<span class="cstat-no" title="statement not covered" >    let toUnExclude = _.difference(this.getExcludedValues(), excludedChanged);</span>
<span class="cstat-no" title="statement not covered" >    if (Utils.isNonEmptyArray(toUnExclude)) {</span>
<span class="cstat-no" title="statement not covered" >      this.unexcludeMultipleValues(toUnExclude);</span>
    }
<span class="cstat-no" title="statement not covered" >    if (!Utils.arrayEqual(this.getExcludedValues(), excludedChanged, false)) {</span>
<span class="cstat-no" title="statement not covered" >      this.excludeMultipleValues(excludedChanged);</span>
    }
  }
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  private handleLookupvalueChanged(lookupFieldChanged: { [value: string]: string })</span> {</span>
<span class="cstat-no" title="statement not covered" >    _.each(lookupFieldChanged, <span class="fstat-no" title="function not covered" >(lookupvalue, value)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      this.facetValuesList.get(decodeURIComponent(value)).facetValue.lookupValue = decodeURIComponent(lookupvalue);</span>
    });
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private handleQueryStateChanged(data: IAttributesChangedEventArg)</span> {
<span class="cstat-no" title="statement not covered" >    Assert.exists(data);</span>
<span class="cstat-no" title="statement not covered" >    this.ensureDom();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    let queryStateAttributes = data.attributes;</span>
<span class="cstat-no" title="statement not covered" >    let includedChanged = queryStateAttributes[this.includedAttributeId];</span>
<span class="cstat-no" title="statement not covered" >    let excludedChanged = queryStateAttributes[this.excludedAttributeId];</span>
<span class="cstat-no" title="statement not covered" >    let operator = queryStateAttributes[this.operatorAttributeId];</span>
<span class="cstat-no" title="statement not covered" >    let lookupValueChanged = queryStateAttributes[this.lookupValueAttributeId];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.listenToQueryStateChange) {</span>
<span class="cstat-no" title="statement not covered" >      if (!Utils.isNullOrEmptyString(operator)) {</span>
<span class="cstat-no" title="statement not covered" >        this.handleQueryStateChangedOperator(operator);</span>
      }
<span class="cstat-no" title="statement not covered" >      if (!Utils.isNullOrUndefined(includedChanged)) {</span>
<span class="cstat-no" title="statement not covered" >        this.handleQueryStateChangedIncluded(includedChanged);</span>
      }
<span class="cstat-no" title="statement not covered" >      if (!Utils.isNullOrUndefined(excludedChanged)) {</span>
<span class="cstat-no" title="statement not covered" >        this.handleQueryStateChangedExcluded(excludedChanged);</span>
      }
<span class="cstat-no" title="statement not covered" >      if (!Utils.isNullOrUndefined(lookupValueChanged)) {</span>
<span class="cstat-no" title="statement not covered" >        this.handleLookupvalueChanged(lookupValueChanged);</span>
      }
    }
  }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.canFetchMore) {
<span class="cstat-no" title="statement not covered" >      this.handleOmniboxWithSearchInFacet(data);</span>
    } else {
      this.handleOmniboxWithStaticValue(data);
    }
  }
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  private handleOmniboxWithSearchInFacet(eventArg: IPopulateOmniboxEventArgs)</span> {</span>
<span class="cstat-no" title="statement not covered" >    let regex = new RegExp('^' + eventArg.completeQueryExpression.regex.source, 'i');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    let promise = new Promise&lt;IOmniboxDataRow&gt;(<span class="fstat-no" title="function not covered" >(resolve, reject)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      let searchParameters = new FacetSearchParameters(this);</span>
<span class="cstat-no" title="statement not covered" >      searchParameters.setValueToSearch(eventArg.completeQueryExpression.word);</span>
<span class="cstat-no" title="statement not covered" >      searchParameters.nbResults = this.options.numberOfValuesInOmnibox;</span>
<span class="cstat-no" title="statement not covered" >      this.facetQueryController.search(searchParameters).then(<span class="fstat-no" title="function not covered" >(fieldValues)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        let facetValues = _.map(_.filter(fieldValues, <span class="fstat-no" title="function not covered" >(fieldValue: IIndexFieldValue)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          return regex.test(fieldValue.lookupValue);</span>
        }), <span class="fstat-no" title="function not covered" >(fieldValue)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >          return this.values.get(fieldValue.lookupValue) || FacetValue.create(fieldValue);</span>
        });
<span class="cstat-no" title="statement not covered" >        let element = new OmniboxValuesList(this, facetValues, eventArg, OmniboxValueElement).build();</span>
<span class="cstat-no" title="statement not covered" >        resolve({</span>
          element: element,
          zIndex: this.omniboxZIndex
        });
      }).catch(<span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        resolve({ element: undefined });</span>
      });
    });
<span class="cstat-no" title="statement not covered" >    eventArg.rows.push({ deferred: promise });</span>
  }
&nbsp;
  private handleDuringQuery() {
    this.ensureDom();
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.keepDisplayedValuesNextTime) {
...
&nbsp;
  private updateValues(facetValues: FacetValues) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.keepDisplayedValuesNextTime) {
<span class="cstat-no" title="statement not covered" >      this.values.updateCountsFromNewValues(facetValues);</span>
    } else {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private ensureFacetValueIsInList(facetValue: FacetValue)</span> {
<span class="cstat-no" title="statement not covered" >    Assert.exists(facetValue);</span>
<span class="cstat-no" title="statement not covered" >    if (!this.values.contains(facetValue.value)) {</span>
<span class="cstat-no" title="statement not covered" >      this.values.add(facetValue);</span>
    }
  }
&nbsp;
...
&nbsp;
  private buildFacetContent() {
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (this.moreElement &amp;&amp; this.lessElement) {
      this.footerElement.appendChild(this.moreElement);
      this.footerElement.appendChild(this.lessElement);
    }
  }
&nbsp;
  private buildHeader() {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.searchInterface.isNewDesign() &amp;&amp; this.options.headerIcon == this.options.field) {
<span class="cstat-no" title="statement not covered" >      icon = undefined;</span>
    }
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private unpinFacetPosition() {</span>
<span class="cstat-no" title="statement not covered" >    if (this.shouldFacetUnpin() &amp;&amp; this.options.preservePosition) {</span>
<span class="cstat-no" title="statement not covered" >      $$(this.pinnedTopSpace).addClass('coveo-with-animation');</span>
<span class="cstat-no" title="statement not covered" >      $$(this.pinnedBottomSpace).addClass('coveo-with-animation');</span>
<span class="cstat-no" title="statement not covered" >      this.pinnedTopSpace.style.height = '0px';</span>
<span class="cstat-no" title="statement not covered" >      this.pinnedBottomSpace.style.height = '0px';</span>
    }
<span class="cstat-no" title="statement not covered" >    this.unpinnedViewportPosition = undefined;</span>
<span class="cstat-no" title="statement not covered" >    this.pinnedViewportPosition = undefined;</span>
  }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private shouldFacetUnpin(): boolean {</span>
<span class="cstat-no" title="statement not covered" >    return Utils.exists(this.unpinnedViewportPosition);</span>
  }
&nbsp;
  private ensurePinnedFacetHasntMoved(): void {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.isFacetPinned()) {
<span class="cstat-no" title="statement not covered" >      Assert.exists(this.pinnedViewportPosition);</span>
<span class="cstat-no" title="statement not covered" >      $$(this.pinnedTopSpace).removeClass('coveo-with-animation');</span>
<span class="cstat-no" title="statement not covered" >      $$(this.pinnedBottomSpace).removeClass('coveo-with-animation');</span>
<span class="cstat-no" title="statement not covered" >      this.pinnedTopSpace.style.height = '0px';</span>
<span class="cstat-no" title="statement not covered" >      this.pinnedBottomSpace.style.height = '0px';</span>
&nbsp;
      // Under firefox scrolling the body doesn't work, but window does
      // on all browser, so we substitute those here when needed.
<span class="cstat-no" title="statement not covered" >      let elementToScroll: any = this.options.scrollContainer == document.body ? window : this.options.scrollContainer;</span>
<span class="cstat-no" title="statement not covered" >      let currentViewportPosition = this.element.getBoundingClientRect().top;</span>
<span class="cstat-no" title="statement not covered" >      let offset = currentViewportPosition - this.pinnedViewportPosition;</span>
<span class="cstat-no" title="statement not covered" >      let scrollToOffset = <span class="fstat-no" title="function not covered" >() =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >        if (elementToScroll instanceof Window) {</span>
<span class="cstat-no" title="statement not covered" >          window.scrollTo(0, window.scrollY + offset);</span>
        } else {
          (&lt;HTMLElement&gt;<span class="cstat-no" title="statement not covered" >elementToScroll).scrollTop = elementToScroll.scrollTop + offset;</span>
        }
      };
      // First try to adjust position by scrolling the page
<span class="cstat-no" title="statement not covered" >      scrollToOffset();</span>
<span class="cstat-no" title="statement not covered" >      currentViewportPosition = this.element.getBoundingClientRect().top;</span>
<span class="cstat-no" title="statement not covered" >      offset = currentViewportPosition - this.pinnedViewportPosition;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        this.pinnedTopSpace.style.height = (offset * -1) + 'px';</span>
      } else {
...
<span class="cstat-no" title="statement not covered" >          let heightBottom = 0;</span>
<span class="cstat-no" title="statement not covered" >          let attempts = 0;</span>
<span class="cstat-no" title="statement not covered" >          while (offset &gt; 0 &amp;&amp; attempts++ &lt; 100) {</span>
<span class="cstat-no" title="statement not covered" >            heightBottom += 100;</span>
<span class="cstat-no" title="statement not covered" >            this.pinnedBottomSpace.style.height = heightBottom + 'px';</span>
<span class="cstat-no" title="statement not covered" >            currentViewportPosition = this.element.getBoundingClientRect().top;</span>
<span class="cstat-no" title="statement not covered" >            offset = currentViewportPosition - this.pinnedViewportPosition;</span>
<span class="cstat-no" title="statement not covered" >            scrollToOffset();</span>
          }
...
<span class="cstat-no" title="statement not covered" >      this.unpinnedViewportPosition = this.pinnedViewportPosition;</span>
<span class="cstat-no" title="statement not covered" >      this.pinnedViewportPosition = null;</span>
    }
  }
&nbsp;
...
&nbsp;
  private buildMore(): HTMLElement {
    ...
    const moreAction = <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.handleClickMore();</span>
...
&nbsp;
  private buildLess(): HTMLElement {
    ...
    const lessAction = <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.handleClickLess();</span>
...
&nbsp;
  private triggerMoreQuery() {
    ...
    this.facetQueryController.fetchMore(this.numberOfValues + 1).then(<span class="fstat-no" title="function not covered" >(queryResults?)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      let facetValues = new FacetValues(queryResults.groupByResults[0]);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      facetValues.importActiveValuesFromOtherList(this.values);</span>
<span class="cstat-no" title="statement not covered" >      facetValues.sortValuesDependingOnStatus(this.numberOfValues);</span>
<span class="cstat-no" title="statement not covered" >      this.values = facetValues;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.nbAvailableValues = this.values.size();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.updateNumberOfValues();</span>
<span class="cstat-no" title="statement not covered" >      this.canFetchMore = this.numberOfValues &lt; this.nbAvailableValues;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (this.values.hasSelectedOrExcludedValues() &amp;&amp; !this.options.useAnd &amp;&amp; this.options.isMultiValueField) {</span>
<span class="cstat-no" title="statement not covered" >        this.triggerUpdateDeltaQuery(_.filter(this.values.getAll(), <span class="fstat-no" title="function not covered" >(facetValue: FacetValue)</span> =&gt; <span class="cstat-no" title="statement not covered" >!facetValue.selected &amp;&amp; !facetValue.excluded)</span>);</span>
      } else {
<span class="cstat-no" title="statement not covered" >        if (this.values.hasSelectedOrExcludedValues() &amp;&amp; !this.options.useAnd) {</span>
<span class="cstat-no" title="statement not covered" >          this.values.updateDeltaWithFilteredFacetValues(new FacetValues());</span>
<span class="cstat-no" title="statement not covered" >          this.hideWaitingAnimation();</span>
        } else {
<span class="cstat-no" title="statement not covered" >          this.hideWaitingAnimation();</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.rebuildValueElements();</span>
    ...
    }).catch(<span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.hideWaitingAnimation())</span>;
  }
&nbsp;
  protected triggerUpdateDeltaQuery(facetValues: FacetValue[]): void {
    this.showWaitingAnimation();
    this.facetQueryController.searchInFacetToUpdateDelta(facetValues).then(<span class="fstat-no" title="function not covered" >(queryResults?)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      let values: FacetValues = new FacetValues();</span>
<span class="cstat-no" title="statement not covered" >      _.each(queryResults.groupByResults, <span class="fstat-no" title="function not covered" >(groupByResult: IGroupByResult)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        _.each(groupByResult.values, <span class="fstat-no" title="function not covered" >(groupByValue: IGroupByValue)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          if (!values.contains(groupByValue.value)) {</span>
<span class="cstat-no" title="statement not covered" >            values.add(FacetValue.createFromGroupByValue(groupByValue));</span>
          }
        });
      });
<span class="cstat-no" title="statement not covered" >      this.values.updateDeltaWithFilteredFacetValues(values);</span>
<span class="cstat-no" title="statement not covered" >      this.rebuildValueElements();</span>
<span class="cstat-no" title="statement not covered" >      this.hideWaitingAnimation();</span>
    });
  }
...
&nbsp;
  private doesParentFacetHasSelectedValue(): boolean {
    ...
    return values != null &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >values.length != 0;</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    let info: any = {};</span>
<span class="cstat-no" title="statement not covered" >    info[this['constructor']['ID']] = {</span>
      component: this,
