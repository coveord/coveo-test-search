...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/Facet/FacetSettings.ts</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">src/ui/Facet/FacetSettings.ts</span></h1>
    <h2>
        Statements: <span class="metric">77.06% <small>(262 / 340)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">54.76% <small>(46 / 84)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">50.77% <small>(33 / 65)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">79.68% <small>(247 / 310)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/Facet/</a> &#187; FacetSettings.ts</div>
</div>
<div class="body">
...
547
548
549</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  ...
  public loadSavedState() {
    if (this.facetStateLocalStorage) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!Utils.isNullOrUndefined(state)
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.facet.options.enableSettingsFacetState) {
<span class="cstat-no" title="statement not covered" >      $$(this.clearStateSection).toggle(!Utils.isNullOrUndefined(this.facetStateLocalStorage.load()));</span>
    }
    _.each(this.enabledSorts, <span class="fstat-no" title="function not covered" >(criteria: IFacetSortDescription, i)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      if (!Utils.isNullOrUndefined(this.sortSection.sortItems[i])) {</span>
<span class="cstat-no" title="statement not covered" >        if (this.activeSort.name == criteria.name.toLowerCase() || this.activeSort.relatedSort == criteria.name.toLowerCase()) {</span>
<span class="cstat-no" title="statement not covered" >          this.selectItem(this.sortSection.sortItems[i]);</span>
        } else {
<span class="cstat-no" title="statement not covered" >          this.unselectItem(this.sortSection.sortItems[i]);</span>
        }
      }
    });
  }
  ...
  private buildSortSectionItems() {
    var elems = _.map(this.enabledSorts, (enabledSort) =&gt; {
      if (_.contains(this.enabledSortsIgnoreRenderBecauseOfPairs, enabledSort)) {
        ...
        $$(elem).on('click', <span class="fstat-no" title="function not covered" >(e: Event)</span> =&gt; <span class="cstat-no" title="statement not covered" >this.handleClickSortButton(e, enabledSort))</span>;
        return elem;
      }
    });
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private closePopupAndUpdateSort() {</span>
<span class="cstat-no" title="statement not covered" >    this.close();</span>
<span class="cstat-no" title="statement not covered" >    if (this.activeSort.name != 'custom') {</span>
<span class="cstat-no" title="statement not covered" >      this.facet.updateSort(this.activeSort.name);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      this.facet.updateSort('nosort');</span>
<span class="cstat-no" title="statement not covered" >      if (this.customSortDirectionChange) {</span>
<span class="cstat-no" title="statement not covered" >        this.customSortDirectionChange = false;</span>
<span class="cstat-no" title="statement not covered" >        this.facet.queryController.executeQuery();</span>
      }
    }
  }
&nbsp;
...
&nbsp;
      ...
      $$(directionAscendingSection).on('click', <span class="fstat-no" title="function not covered" >(e: Event)</span> =&gt; <span class="cstat-no" title="statement not covered" >this.handleDirectionClick(e, 'ascending'))</span>;
&nbsp;
...
&nbsp;
      ...
      $$(directionDescendingSection).on('click', <span class="fstat-no" title="function not covered" >(e: Event)</span> =&gt; <span class="cstat-no" title="statement not covered" >this.handleDirectionClick(e, 'descending'))</span>;
&nbsp;
...
&nbsp;
      ...
      var ascending = this.buildAscendingOrDescending('Ascending');
      $$(ascending).on('click', <span class="fstat-no" title="function not covered" >(e: Event)</span> =&gt; <span class="cstat-no" title="statement not covered" >this.handleDirectionClick(e, 'ascending'))</span>;
&nbsp;
      var descending = this.buildAscendingOrDescending('Descending');
      $$(descending).on('click', <span class="fstat-no" title="function not covered" >(e: Event)</span> =&gt; <span class="cstat-no" title="statement not covered" >this.handleDirectionClick(e, 'descending'))</span>;
&nbsp;
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.activeSort.directionToggle) {
        $$(directionSection).addClass('coveo-facet-settings-disabled');
      } else {
<span class="cstat-no" title="statement not covered" >        this.selectItem(this.getCurrentDirectionItem([directionSection]));</span>
      }
...
&nbsp;
    ...
    $$(saveStateSection).on('click', <span class="fstat-no" title="function not covered" >(e: Event)</span> =&gt; <span class="cstat-no" title="statement not covered" >this.handleSaveStateClick())</span>;
...
&nbsp;
  private buildClearStateSection() {
    ...
    $$(clearStateSection).on('click', <span class="fstat-no" title="function not covered" >(e: Event)</span> =&gt; <span class="cstat-no" title="statement not covered" >this.handleClearStateClick())</span>;
...
&nbsp;
    ...
    $$(hideSection).on('click', <span class="fstat-no" title="function not covered" >(e: Event)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      this.facet.facetHeader.collapseFacet();</span>
<span class="cstat-no" title="statement not covered" >      this.close();</span>
    });
    return hideSection;
  }
...
&nbsp;
    ...
    $$(showSection).on('click', <span class="fstat-no" title="function not covered" >(e: Event)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      this.facet.facetHeader.expandFacet();</span>
<span class="cstat-no" title="statement not covered" >      this.close();</span>
    });
    return showSection;
  }
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private handleClickSettingsButtons(event: Event, sortSection?: { element: HTMLElement; sortItems: HTMLElement[] })</span> {
<span class="cstat-no" title="statement not covered" >    if (!Utils.isNullOrUndefined(this.settingsPopup.parentElement)) {</span>
<span class="cstat-no" title="statement not covered" >      this.close();</span>
    } else {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private handleClickSortButton(e: Event, enabledSort: IFacetSortDescription)</span> {
<span class="cstat-no" title="statement not covered" >    if (this.activeSort != enabledSort &amp;&amp; this.activeSort.relatedSort != enabledSort.name) {</span>
<span class="cstat-no" title="statement not covered" >      this.activeSort = enabledSort;</span>
<span class="cstat-no" title="statement not covered" >      if (enabledSort.directionToggle &amp;&amp; _.contains(this.enabledSorts, FacetSettings.availableSorts[this.activeSort.relatedSort])) {</span>
<span class="cstat-no" title="statement not covered" >        this.activateDirectionSection();</span>
      } else {
<span class="cstat-no" title="statement not covered" >        this.disableDirectionSection();</span>
      }
<span class="cstat-no" title="statement not covered" >      this.selectItem(&lt;HTMLElement&gt;e.target);</span>
<span class="cstat-no" title="statement not covered" >      this.closePopupAndUpdateSort();</span>
    }
  }
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  private handleDirectionClick(e: Event, direction: string)</span> {</span>
<span class="cstat-no" title="statement not covered" >    if (!$$((&lt;HTMLElement&gt;e.target).parentElement.parentElement).hasClass('coveo-facet-settings-disabled') &amp;&amp; this.activeSort.name.indexOf(direction) == -1) {</span>
<span class="cstat-no" title="statement not covered" >      this.activeSort = FacetSettings.availableSorts[this.activeSort.relatedSort];</span>
<span class="cstat-no" title="statement not covered" >      _.each(this.directionSection, <span class="fstat-no" title="function not covered" >(d)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        this.unselectSection(d);</span>
      });
<span class="cstat-no" title="statement not covered" >      this.selectItem(&lt;HTMLElement&gt;e.target);</span>
<span class="cstat-no" title="statement not covered" >      if (this.activeSort.name == 'custom' &amp;&amp; this.customSortDirection != direction) {</span>
<span class="cstat-no" title="statement not covered" >        this.customSortDirection = direction;</span>
<span class="cstat-no" title="statement not covered" >        this.customSortDirectionChange = true;</span>
      }
<span class="cstat-no" title="statement not covered" >      this.closePopupAndUpdateSort();</span>
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private handleSaveStateClick() {</span>
<span class="cstat-no" title="statement not covered" >    this.saveState();</span>
<span class="cstat-no" title="statement not covered" >    this.close();</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  private handleClearStateClick() {</span></span>
<span class="cstat-no" title="statement not covered" >    this.facetStateLocalStorage.remove();</span>
<span class="cstat-no" title="statement not covered" >    this.facet.reset();</span>
<span class="cstat-no" title="statement not covered" >    this.close();</span>
<span class="cstat-no" title="statement not covered" >    this.facet.triggerNewQuery(<span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.facet.usageAnalytics.logSearchEvent&lt;IAnalyticsFacetMeta&gt;(analyticsActionCauseList.facetClearAll, {</span></span>
...
&nbsp;
  private handleMouseEventOnButton(sortSection: { element: HTMLElement; sortItems: HTMLElement[] }) {
    ...
    $$(this.settingsButton).on('click', <span class="fstat-no" title="function not covered" >(e: Event)</span> =&gt; <span class="cstat-no" title="statement not covered" >this.handleClickSettingsButtons(e, sortSection))</span>;
&nbsp;
    var mouseLeave = <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      closeTimeout = setTimeout(<span class="fstat-no" title="function not covered" >() =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >        this.close();</span>
      }, 300);
    };
    var mouseEnter = <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      clearTimeout(closeTimeout);</span>
    };
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  public getCurrentDirectionItem(<span class="cstat-no" title="statement not covered" >directionSection = this.directionSection)</span></span> {</span>
<span class="cstat-no" title="statement not covered" >    var found: HTMLElement;</span>
<span class="cstat-no" title="statement not covered" >    _.each(directionSection, <span class="fstat-no" title="function not covered" >(direction)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      if (!found) {</span>
<span class="cstat-no" title="statement not covered" >        found = _.find(this.getItems(direction), <span class="fstat-no" title="function not covered" >(direction: HTMLElement)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          return this.activeSort.name.indexOf(direction.getAttribute('data-direction')) != -1;</span>
        });
      }
    });
<span class="cstat-no" title="statement not covered" >    if (!found) {</span>
<span class="cstat-no" title="statement not covered" >      found = directionSection[0];</span>
    }
<span class="cstat-no" title="statement not covered" >    return found;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  private activateDirectionSection() {</span></span>
<span class="cstat-no" title="statement not covered" >    _.each(this.directionSection, <span class="fstat-no" title="function not covered" >(direction)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      $$(direction).removeClass('coveo-facet-settings-disabled');</span>
<span class="cstat-no" title="statement not covered" >      this.unselectSection(direction);</span>
    });
<span class="cstat-no" title="statement not covered" >    this.selectItem(this.getCurrentDirectionItem());</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  private disableDirectionSection() {</span></span>
<span class="cstat-no" title="statement not covered" >    _.each(this.directionSection, <span class="fstat-no" title="function not covered" >(direction)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      $$(direction).addClass('coveo-facet-settings-disabled');</span>
<span class="cstat-no" title="statement not covered" >      this.unselectSection(direction);</span>
    });
&nbsp;
  }
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private unselectSection(section: HTMLElement)</span> {
<span class="cstat-no" title="statement not covered" >    _.each(this.getItems(section), <span class="fstat-no" title="function not covered" >(i)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      $$(i).removeClass('coveo-selected');</span>
    });
  }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private unselectItem(item: HTMLElement)</span> {
<span class="cstat-no" title="statement not covered" >    $$(item).removeClass('coveo-selected');</span>
  }
&nbsp;
  private getPopupAlignment() {
    var alignmentHorizontal = DeviceUtils.isMobileDevice() ? <span class="branch-0 cbranch-no" title="branch not covered" >HorizontalAlignment.CENTER </span>: HorizontalAlignment.INNERLEFT;
