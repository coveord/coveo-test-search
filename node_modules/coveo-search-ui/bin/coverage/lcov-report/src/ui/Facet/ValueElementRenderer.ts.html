...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">94.74% <small>(108 / 114)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">85% <small>(34 / 40)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">88.24% <small>(15 / 17)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">94.55% <small>(104 / 110)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cstat-no" title="statement not covered" >        $$(this.listElement).addClass('coveo-facet-value-will-exclude');</span>
      });
&nbsp;
      $$(this.excludeIcon).on('mouseout', <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        $$(this.listElement).removeClass('coveo-facet-value-will-exclude');</span>
      });
    }
