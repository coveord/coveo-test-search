...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/Facet/FacetValuesList.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/Facet/FacetValuesList.ts</span></h1>
    <h2>
        Statements: <span class="metric">92.16% <small>(94 / 102)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">69.23% <small>(18 / 26)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">85% <small>(17 / 20)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">91.84% <small>(90 / 98)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/Facet/</a> &#187; FacetValuesList.ts</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  public getAll(): ValueElement[] {</span>
<span class="cstat-no" title="statement not covered" >    return _.toArray&lt;ValueElement&gt;(this.valueList);</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  public getAllFacetValue(): FacetValue[] {</span>
<span class="cstat-no" title="statement not covered" >    return _.map(this.getAll(), <span class="fstat-no" title="function not covered" >(v: ValueElement)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      return v.facetValue</span>
    })
  }
&nbsp;
...
&nbsp;
  public rebuild(numberOfValues: number): void {
    ...
    _.each(allValues, (facetValue: FacetValue, index?: number, list?) =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.facetValueShouldBeRemoved(facetValue)) {
<span class="cstat-no" title="statement not covered" >        this.facet.values.remove(facetValue.value);</span>
<span class="cstat-no" title="statement not covered" >        toCompare += 1</span>
...
&nbsp;
  protected getValuesToBuildWith() {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.facet.facetSort) {
      return new FacetValuesOrder(this.facet, this.facet.facetSort).reorderValues(this.facet.values.getAll());
    } else {
<span class="cstat-no" title="statement not covered" >      return this.facet.values.getAll();</span>
    }
  }
&nbsp;
  private facetValueShouldBeRemoved(facetValue: FacetValue): boolean {
    return facetValue.occurrences == 0 &amp;&amp;
      (<span class="branch-1 cbranch-no" title="branch not covered" >facetValue.delta == 0 </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >facetValue.delta == undefined)</span> &amp;&amp; <span class="branch-3 cbranch-no" title="branch not covered" >!facetValue.selected </span>&amp;&amp; <span class="branch-4 cbranch-no" title="branch not covered" >!facetValue.excluded </span>&amp;&amp; <span class="branch-5 cbranch-no" title="branch not covered" >!this.facet.keepDisplayedValuesNextTime</span>
  }
&nbsp;
  private ensureFacetValueIsInList(value: any) {
    ...
    if (value instanceof FacetValue) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (facetValue == null) {
<span class="cstat-no" title="statement not covered" >        this.facet.values.add(value);</span>
<span class="cstat-no" title="statement not covered" >        facetValue = value;</span>
      }
    } else {
