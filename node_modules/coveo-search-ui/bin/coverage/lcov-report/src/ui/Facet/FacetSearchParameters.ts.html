...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/Facet/FacetSearchParameters.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/Facet/FacetSearchParameters.ts</span></h1>
    <h2>
        Statements: <span class="metric">97.06% <small>(66 / 68)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">75% <small>(12 / 16)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(15 / 15)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">96.92% <small>(63 / 65)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/Facet/</a> &#187; FacetSearchParameters.ts</div>
</div>
<div class="body">
...
&nbsp;
    var request: IGroupByRequest = {
      ...
      completeFacetWithStandardValues: this.facet.options.lookupField ? <span class="branch-0 cbranch-no" title="branch not covered" >false </span>: true, // See : https://coveord.atlassian.net/browse/JSUI-728
      field: &lt;string&gt;this.facet.options.field,
      sortCriteria: this.facet.options.sortCriteria || this.sortCriteria,
      injectionDepth: this.facet.options.injectionDepth,
    };
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.facet.options.lookupField) {
<span class="cstat-no" title="statement not covered" >      request.lookupField = &lt;string&gt;this.facet.options.lookupField;</span>
    }
&nbsp;
...
&nbsp;
  public getQuery(): IQuery {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!lastQuery) {
      // There should normally always be a last query available
      // If not, just create an empty one.
<span class="cstat-no" title="statement not covered" >      lastQuery = new QueryBuilder().build();</span>
    }
