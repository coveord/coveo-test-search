...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/ResultLayout/ResultLayout.ts</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">src/ui/ResultLayout/ResultLayout.ts</span></h1>
    <h2>
        Statements: <span class="metric">74.5% <small>(111 / 149)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">43.18% <small>(19 / 44)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">64.71% <small>(22 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">74.24% <small>(98 / 132)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/ResultLayout/</a> &#187; ResultLayout.ts</div>
</div>
<div class="body">
...
&nbsp;
  ...
  constructor(public element: HTMLElement, public options?: IResultLayoutOptions, bindings?: IComponentBindings) {
    super(element, ResultLayout.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
&nbsp;
    ...
    this.bind.oneRootElement(InitializationEvents.afterInitialization, <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.handleQueryStateChanged())</span>;
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (layout !== this.currentLayout || <span class="branch-1 cbranch-no" title="branch not covered" >this.getModelValue() === '')</span> {
&nbsp;
      this.setModelValue(layout);
      const lastResults = this.queryController.getLastResults();
      this.setLayout(layout, lastResults);
      <span class="missing-if-branch" title="if path not taken" >I</span>if (lastResults) {
<span class="cstat-no" title="statement not covered" >        this.usageAnalytics.logCustomEvent&lt;IAnalyticsResultsLayoutChange&gt;(analyticsActionCauseList.resultsLayoutChange, {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  public disableLayouts(layouts: ValidLayout[])</span> {</span>
<span class="cstat-no" title="statement not covered" >    if (Utils.isNonEmptyArray(layouts)) {</span>
<span class="cstat-no" title="statement not covered" >      _.each(layouts, <span class="fstat-no" title="function not covered" >(layout)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        this.disableLayout(layout);</span>
      });
&nbsp;
<span class="cstat-no" title="statement not covered" >      let remainingValidLayouts = _.difference(_.keys(this.currentActiveLayouts), layouts);</span>
<span class="cstat-no" title="statement not covered" >      if (remainingValidLayouts &amp;&amp; remainingValidLayouts[0]) {</span>
<span class="cstat-no" title="statement not covered" >        this.changeLayout(&lt;ValidLayout&gt;remainingValidLayouts[0]);</span>
      } else {
<span class="cstat-no" title="statement not covered" >        this.logger.error('Cannot disable the last valid layout ... Re-enabling the first one possible');</span>
<span class="cstat-no" title="statement not covered" >        let firstPossibleValidLayout = &lt;ValidLayout&gt;_.keys(this.currentActiveLayouts)[0];</span>
<span class="cstat-no" title="statement not covered" >        this.enableLayout(firstPossibleValidLayout);</span>
<span class="cstat-no" title="statement not covered" >        this.setLayout(firstPossibleValidLayout);</span>
      }
    }
  }
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  public enableLayouts(layouts: ValidLayout[])</span> {</span>
<span class="cstat-no" title="statement not covered" >    _.each(layouts, <span class="fstat-no" title="function not covered" >(layout)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      this.enableLayout(layout);</span>
    });
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private disableLayout(layout: ValidLayout)</span> {
<span class="cstat-no" title="statement not covered" >    if (this.isLayoutDisplayedByButton(layout)) {</span>
<span class="cstat-no" title="statement not covered" >      this.hideButton(layout);</span>
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private enableLayout(layout: ValidLayout)</span> {
<span class="cstat-no" title="statement not covered" >    if (this.isLayoutDisplayedByButton(layout)) {</span>
<span class="cstat-no" title="statement not covered" >      this.showButton(layout);</span>
<span class="cstat-no" title="statement not covered" >      this.updateSelectorAppearance();</span>
    }
  }
&nbsp;
&nbsp;
<span class="fstat-no" title="function not covered" >  private hideButton(layout: ValidLayout)</span> {
<span class="cstat-no" title="statement not covered" >    if (this.isLayoutDisplayedByButton(layout)) {</span>
<span class="cstat-no" title="statement not covered" >      let btn = this.currentActiveLayouts[&lt;string&gt;layout].button;</span>
<span class="cstat-no" title="statement not covered" >      $$(btn.el).hide();</span>
<span class="cstat-no" title="statement not covered" >      btn.visible = false;</span>
<span class="cstat-no" title="statement not covered" >      this.updateSelectorAppearance();</span>
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private showButton(layout: ValidLayout)</span> {
<span class="cstat-no" title="statement not covered" >    if (this.isLayoutDisplayedByButton(layout)) {</span>
<span class="cstat-no" title="statement not covered" >      let btn = this.currentActiveLayouts[&lt;string&gt;layout].button;</span>
<span class="cstat-no" title="statement not covered" >      $$(btn.el).show();</span>
<span class="cstat-no" title="statement not covered" >      btn.visible = true;</span>
    }
  }
&nbsp;
  private setLayout(layout: ValidLayout, results?: IQueryResults) {
    this.isLayoutDisplayedByButton(layout);
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.currentLayout) {
<span class="cstat-no" title="statement not covered" >      $$(this.currentActiveLayouts[this.currentLayout].button.el).removeClass('coveo-selected');</span>
    }
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private updateSelectorAppearance() {</span>
<span class="cstat-no" title="statement not covered" >    if (this.shouldShowSelector()) {</span>
...
&nbsp;
  private populate() {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!_.isEmpty(populateArgs.layouts)) {
...
&nbsp;
  private addButton(layout?: string) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (layout === this.currentLayout) {
<span class="cstat-no" title="statement not covered" >      btn.addClass('coveo-selected');</span>
    }
    const activateAction = <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.changeLayout(&lt;ValidLayout&gt;layout);</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private show() {</span>
<span class="cstat-no" title="statement not covered" >    const elem = this.resultLayoutSection || this.element;</span>
<span class="cstat-no" title="statement not covered" >    $$(elem).removeClass('coveo-result-layout-hidden');</span>
  }
&nbsp;
