...
<div class="header medium">
    ...
    <h2>
        ...
        Branches: <span class="metric">65.49% <small>(93 / 142)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">69.01% <small>(49 / 71)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
816
817
818</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >    let content = this.options.previewTemplate.instantiateToElement(result, false);</span>
...
<span class="cstat-no" title="statement not covered" >    let rowFieldExpression = '(' + QueryUtils.buildFieldExpression(this.options.rowField, '=', [this.getRowValue(rowNumber)]) + ')';</span>
<span class="cstat-no" title="statement not covered" >    let columnFieldExpression = '(' + QueryUtils.buildFieldExpression(this.options.columnField, '=', [this.getColumnValue(columnNumber)]) + ')';</span>
...
<span class="cstat-no" title="statement not covered" >    query.sortField = this.options.previewSortField;</span>
...
<span class="cstat-no" title="statement not covered" >    if (!fieldExists) {</span>
