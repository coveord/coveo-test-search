...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/Matrix/Matrix.ts</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">src/ui/Matrix/Matrix.ts</span></h1>
    <h2>
        Statements: <span class="metric">79.61% <small>(289 / 363)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">64.38% <small>(94 / 146)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">68.57% <small>(48 / 70)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">79.89% <small>(278 / 348)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/Matrix/</a> &#187; Matrix.ts</div>
</div>
<div class="body">
...
911
912
913</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1930</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">270</span>
<span class="cline-any cline-yes">1485</span>
<span class="cline-any cline-yes">270</span>
<span class="cline-any cline-yes">270</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  ...
  constructor(public element: HTMLElement, public options?: IMatrixOptions, bindings?: IComponentBindings) {
    super(element, Matrix.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
    this.options = ComponentOptions.initComponentOptions(element, Matrix, options);
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.options.previewTemplate) {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.options.previewSortField) {
...
&nbsp;
    this.buildMatrix();
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.rowField == null) {
<span class="cstat-no" title="statement not covered" >      this.logger.error('\'rowField\' option is required in the Matrix component');</span>
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.columnField == null) {
<span class="cstat-no" title="statement not covered" >      this.logger.error('\'columnField\' option is required in the Matrix component');</span>
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.computedField == null) {
<span class="cstat-no" title="statement not covered" >      this.logger.error('\'computedField\' option is required in the Matrix component');</span>
    } else {
      this.bindEvents();
      this.initQueryState();
    }
...
&nbsp;
  ...
  public selectCell(rowNumber: number, columnNumber: number): void {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (rowNumber !== 0 &amp;&amp; rowNumber !== this.numberOfRows - 1) {
      rowValue = this.getRowValue(rowNumber);
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (columnNumber !== 0 &amp;&amp; columnNumber !== this.numberOfColumns - 1) {
      columnValue = this.getColumnValue(columnNumber);
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (rowValue &amp;&amp; this.isRowFacetPresent()) {
<span class="cstat-no" title="statement not covered" >      this.queryStateModel.set(this.rowId, [rowValue]);</span>
    } else {
      this.selectedRowValue = rowValue;
      this.queryStateModel.set(this.rowId, []);
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (columnValue &amp;&amp; this.isColumnFacetPresent()) {
<span class="cstat-no" title="statement not covered" >      this.queryStateModel.set(this.columnId, [columnValue]);</span>
    } else {
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  public getSelectedColumnValue(): string {</span>
<span class="cstat-no" title="statement not covered" >    return this.selectedColumnValue;</span>
  }
&nbsp;
  /**
   * Returns the currently selected row value.
   */
<span class="fstat-no" title="function not covered" >  public getSelectedRowValue(): string {</span>
<span class="cstat-no" title="statement not covered" >    return this.selectedRowValue;</span>
  }
&nbsp;
  /**
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.cellFontSize !== '') {
<span class="cstat-no" title="statement not covered" >      let cells = $$(this.element).findAll('.coveo-matrix-cell');</span>
<span class="cstat-no" title="statement not covered" >      _.each(cells, <span class="fstat-no" title="function not covered" >(c: HTMLElement)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        c.style.fontSize = this.options.cellFontSize;</span>
      });
    }
  }
&nbsp;
...
&nbsp;
  private handleBuildingQuery(args: IBuildingQueryEventArgs) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.areFacetsPresent()) {
...
<span class="cstat-no" title="statement not covered" >      totalQuery += ' ' + expression;</span>
    }
    if (advancedExpression) {
      totalQuery += ' ' + advancedExpression;
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (constantExpression) {
<span class="cstat-no" title="statement not covered" >      totalQuery += ' ' + constantExpression;</span>
    }
    return totalQuery;
  }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.isAColumnSelected() &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!this.isColumnSelected(columnValue))</span> {
<span class="cstat-no" title="statement not covered" >      cellResult = 0;</span>
    }
&nbsp;
    return cellResult;
  }
&nbsp;
  private addTotals() {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.options.enableRowTotals) {
      this.addRowTotals();
    }
    if (this.options.enableColumnTotals) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.options.sortCriteria.toLowerCase() == 'computedfielddescending') {
      this.data.sort((a: Cell[], b: Cell[]): number =&gt; {
        return b[this.numberOfColumns - 1].getValue() - a[this.numberOfColumns - 1].getValue();
      });
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.sortCriteria.toLowerCase() == 'computedfieldascending') {
<span class="cstat-no" title="statement not covered" >      this.data.sort(<span class="fstat-no" title="function not covered" >(a: Cell[], b: Cell[])</span>: number =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        return a[this.numberOfColumns - 1].getValue() - b[this.numberOfColumns - 1].getValue();</span>
      });
    }
  }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.isCellSelected(this.getRowValue(rowNumber), this.getColumnValue(columnNumber))) {
<span class="cstat-no" title="statement not covered" >      $$(cell).addClass('coveo-matrix-selected');</span>
    }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private handleClick(rowNumber: number, columnNumber: number)</span> {
<span class="cstat-no" title="statement not covered" >    this.selectCell(rowNumber, columnNumber);</span>
...
&nbsp;
  private isColumnSelected(columnValue: string): boolean {
    if (this.isAColumnSelected() &amp;&amp; columnValue) {
      let selectedColumnValues = this.queryStateModel.attributes[this.columnId] || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
      for (let i = 0; i &lt; selectedColumnValues.length; i++) {
<span class="cstat-no" title="statement not covered" >        if (selectedColumnValues[i].toLowerCase() === columnValue.toLowerCase()) {</span>
...
<span class="cstat-no" title="statement not covered" >        if (selectedRowValues[i].toLowerCase() === rowValue.toLowerCase()) {</span>
<span class="cstat-no" title="statement not covered" >          return true;</span>
        }
      }
    }
...
&nbsp;
  private isCellSelected(rowValue: string, columnValue: string): boolean {
    if (this.isAColumnSelected() &amp;&amp; this.isARowSelected()) {
      return this.isRowSelected(rowValue) &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.isColumnSelected(columnValue);</span>
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.isAColumnSelected()) {
<span class="cstat-no" title="statement not covered" >      return this.isColumnSelected(columnValue);</span>
    }
&nbsp;
    return false;
  }
&nbsp;
  private areFacetsPresent() {
    return this.isRowFacetPresent() &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.isColumnFacetPresent();</span>
  }
&nbsp;
  private isRowFacetPresent() {
    let facet = this.componentStateModel.get(this.rowId);
    return facet &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!facet[0].disabled;</span>
  }
&nbsp;
...
&nbsp;
  private parseResults(results: IQueryResults) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (results) {
...
&nbsp;
  private drawRow(row: HTMLElement, rowNumber: number) {
    ...
    for (let i = 0; i &lt; this.numberOfColumns; i++) {
      ...
      $$(cell).on('click', <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        let handler = <span class="fstat-no" title="function not covered" >(num)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          this.handleClick(rowNumber, num);</span>
        };
<span class="cstat-no" title="statement not covered" >        handler(i);</span>
      });
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.options.enableHoverPreview) {
        ((num: number) =&gt; {
          $$(cell).on('mouseover', <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.handleHoverIn(rowNumber, num))</span>;
          $$(cell).on('mouseout', <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.handleHoverOut(rowNumber, num))</span>;
        })(i);
      }
...
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  private handleHoverIn(rowNumber: number, columnNumber: number)</span> {</span>
<span class="cstat-no" title="statement not covered" >    if (this.isHoverWorkingOnRow(rowNumber) &amp;&amp; this.isHoverWorkingOnColumn(columnNumber)) {</span>
<span class="cstat-no" title="statement not covered" >      this.previewTimeout = setTimeout(<span class="fstat-no" title="function not covered" >() =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >        this.displayResultsPreview(rowNumber, columnNumber);</span>
      }, this.options.previewDelay);
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private handleHoverOut(rowNumber: number, columnNumber: number)</span> {
<span class="cstat-no" title="statement not covered" >    clearTimeout(this.previewTimeout);</span>
<span class="cstat-no" title="statement not covered" >    let cell = this.data[rowNumber][columnNumber];</span>
<span class="cstat-no" title="statement not covered" >    cell.removePreview();</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  private displayResultsPreview(rowNumber: number, columnNumber: number)</span> {</span>
<span class="cstat-no" title="statement not covered" >    let query = this.createPreviewQuery(rowNumber, columnNumber);</span>
<span class="cstat-no" title="statement not covered" >    let cell = this.data[rowNumber][columnNumber];</span>
<span class="cstat-no" title="statement not covered" >    cell.addPreview(this.options.previewMinWidth, this.options.previewMaxWidth);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    let endpoint = this.queryController.getEndpoint();</span>
<span class="cstat-no" title="statement not covered" >    endpoint.search(query).then(<span class="fstat-no" title="function not covered" >(data: IQueryResults)</span> =&gt; {</span>
...
<span class="cstat-no" title="statement not covered" >      if (!this.isDataAvailable(rowNumber, columnNumber)) {</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
<span class="cstat-no" title="statement not covered" >      let cell = this.data[rowNumber][columnNumber];</span>
<span class="cstat-no" title="statement not covered" >      let instantiatedResults = _.map(data.results, <span class="fstat-no" title="function not covered" >(r: IQueryResult)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        return this.instantiateTemplate(r);</span>
      });
<span class="cstat-no" title="statement not covered" >      let html = '';</span>
<span class="cstat-no" title="statement not covered" >      _.each(instantiatedResults, <span class="fstat-no" title="function not covered" >(result)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        html += result.outerHTML;</span>
      });
<span class="cstat-no" title="statement not covered" >      cell.updatePreview(html);</span>
    });
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private instantiateTemplate(result: IQueryResult)</span>: HTMLElement {
<span class="cstat-no" title="statement not covered" >    let content = this.options.previewTemplate.instantiateToElement(result, {</span>
      checkCondition: false,
      responsiveComponents: this.searchInterface.responsiveComponents
    });
<span class="cstat-no" title="statement not covered" >    let initParameters: IInitializationParameters = {</span>
      options: this.options,
      bindings: this.getBindings(),
      result: result
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    Initialization.automaticallyCreateComponentsInside(content, initParameters);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return content;</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private createPreviewQuery(rowNumber: number, columnNumber: number)</span>: IQuery {
<span class="cstat-no" title="statement not covered" >    let rowFieldExpression = '(' + QueryUtils.buildFieldExpression(&lt;string&gt;this.options.rowField, '=', [this.getRowValue(rowNumber)]) + ')';</span>
<span class="cstat-no" title="statement not covered" >    let columnFieldExpression = '(' + QueryUtils.buildFieldExpression(&lt;string&gt;this.options.columnField, '=', [this.getColumnValue(columnNumber)]) + ')';</span>
<span class="cstat-no" title="statement not covered" >    let query = this.queryController.getLastQuery();</span>
<span class="cstat-no" title="statement not covered" >    query.aq = rowFieldExpression;</span>
<span class="cstat-no" title="statement not covered" >    query.aq += columnFieldExpression;</span>
<span class="cstat-no" title="statement not covered" >    query.sortCriteria = this.options.previewSortCriteria;</span>
<span class="cstat-no" title="statement not covered" >    query.sortField = &lt;string&gt;this.options.previewSortField;</span>
<span class="cstat-no" title="statement not covered" >    let fieldSliced = this.options.computedField.slice(1);</span>
<span class="cstat-no" title="statement not covered" >    let fieldExists = _.find(query.fieldsToInclude, <span class="fstat-no" title="function not covered" >(field: string)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      return field == fieldSliced;</span>
    });
<span class="cstat-no" title="statement not covered" >    if (!fieldExists &amp;&amp; query.fieldsToInclude) {</span>
<span class="cstat-no" title="statement not covered" >      query.fieldsToInclude.push(fieldSliced);</span>
    }
<span class="cstat-no" title="statement not covered" >    return query;</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private isHoverWorkingOnRow(rowNumber: number)</span> {
<span class="cstat-no" title="statement not covered" >    if (this.options.enableColumnTotals) {</span>
<span class="cstat-no" title="statement not covered" >      return rowNumber !== 0 &amp;&amp; rowNumber !== this.numberOfRows - 1;</span>
    }
<span class="cstat-no" title="statement not covered" >    return rowNumber !== 0;</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private isHoverWorkingOnColumn(columnNumber: number)</span> {
<span class="cstat-no" title="statement not covered" >    if (this.options.enableRowTotals) {</span>
<span class="cstat-no" title="statement not covered" >      return columnNumber !== 0 &amp;&amp; columnNumber !== this.numberOfColumns - 1;</span>
    }
<span class="cstat-no" title="statement not covered" >    return columnNumber !== 0;</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private isDataAvailable(row: number, column: number)</span> {
<span class="cstat-no" title="statement not covered" >    return this.data[row] !== undefined &amp;&amp; this.data[row][column] !== undefined;</span>
  }
&nbsp;
}
&nbsp;
