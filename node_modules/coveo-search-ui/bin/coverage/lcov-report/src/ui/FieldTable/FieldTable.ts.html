...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/FieldTable/FieldTable.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/FieldTable/FieldTable.ts</span></h1>
    <h2>
        Statements: <span class="metric">98.31% <small>(116 / 118)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">78.85% <small>(41 / 52)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">94.12% <small>(16 / 17)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">99.02% <small>(101 / 102)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/FieldTable/</a> &#187; FieldTable.ts</div>
</div>
<div class="body">
...
263
264
265</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
&nbsp;
  ...
  constructor(public element: HTMLElement, public options?: IFieldTableOptions, bindings?: IComponentBindings, public result?: IQueryResult) {
    super(element, ValueRow.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
&nbsp;
   ...
   */
  public toggle(<span class="missing-if-branch" title="else path not taken" >E</span>anim = false) {
    if (this.isTogglable()) {
...
&nbsp;
  ...
  public expand(anim = false) {
    if (this.isTogglable()) {
      ...
      anim ? <span class="branch-0 cbranch-no" title="branch not covered" >this.slideToggle(true) </span>: this.slideToggle(true, false);
    }
  }
&nbsp;
  /**
  ...
  public minimize(anim = false) {
    if (this.isTogglable()) {
      ...
      anim ? <span class="branch-0 cbranch-no" title="branch not covered" >this.slideToggle(false) </span>: this.slideToggle(false, false);
    }
  }
&nbsp;
  /**
...
&nbsp;
  protected isTogglable() {
    if (this.searchInterface.isNewDesign() &amp;&amp; this.options.allowMinimization) {
      return true;
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.searchInterface.isNewDesign()) {
<span class="cstat-no" title="statement not covered" >      this.logger.trace('Cannot open or close the field table with older design', this);</span>
    }
    return false;
  }
&nbsp;
...
&nbsp;
    const toggleAction = <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.toggle(true);</span>
...
&nbsp;
  private slideToggle(<span class="missing-if-branch" title="if path not taken" >I</span>visible: boolean = true, <span class="missing-if-branch" title="if path not taken" >I</span>anim: boolean = true) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!anim) {
...
class ValueRow extends FieldValue {
  ...
  static options: IValueRowOptions = {
    caption: ComponentOptions.buildStringOption({ postProcessing: (value, options) =&gt; value || <span class="branch-1 cbranch-no" title="branch not covered" >options.field.substr(1) </span>})
  };
&nbsp;
...
&nbsp;
  constructor(public element: HTMLElement, public options: IValueRowOptions, bindings?: IComponentBindings, public result?: IQueryResult) {
    super(element, options, bindings, result, ValueRow.ID)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
