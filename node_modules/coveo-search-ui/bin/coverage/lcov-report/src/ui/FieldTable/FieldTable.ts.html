...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">98.25% <small>(112 / 114)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">82.61% <small>(38 / 46)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">88.24% <small>(15 / 17)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">100% <small>(97 / 97)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
230
231
232</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
&nbsp;
    $$(this.toggleButton).on('click', <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.toggle(true))</span>;
    $$(this.toggleButtonInsideTable).on('click', <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.toggle(true))</span>;
  }
&nbsp;
