...
<div class="header high">
    ...
    <h2>
        ...
        Branches: <span class="metric">76.67% <small>(23 / 30)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">88.89% <small>(8 / 9)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">93.44% <small>(57 / 61)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
  ...
  constructor(element: HTMLElement, public options: IBadgeOptions, bindings?: IComponentBindings, result?: IQueryResult) {
    super(element, ComponentOptions.initComponentOptions(element, Badge, options), bindings, result, Badge.ID)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
<span class="fstat-no" title="function not covered" >  protected prependTextCaptionToDom(): void {</span>
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
}
&nbsp;
