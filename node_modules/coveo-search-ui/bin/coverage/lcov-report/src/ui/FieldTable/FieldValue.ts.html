...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">92.19% <small>(118 / 128)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">81.67% <small>(49 / 60)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">82.61% <small>(19 / 23)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">93.22% <small>(110 / 118)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
    if (this.options.helper != null) {
      ...
      let toKeep = _.filter(toFilter, (optionKey) =&gt; {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (optionDefinition) {
