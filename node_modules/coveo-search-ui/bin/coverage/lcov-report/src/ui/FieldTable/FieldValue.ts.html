...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/FieldTable/FieldValue.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/FieldTable/FieldValue.ts</span></h1>
    <h2>
        Statements: <span class="metric">92.44% <small>(110 / 119)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">81.48% <small>(44 / 54)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">80.95% <small>(17 / 21)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">93.52% <small>(101 / 108)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/FieldTable/</a> &#187; FieldValue.ts</div>
</div>
<div class="body">
...
&nbsp;
  ...
  constructor(public element: HTMLElement, public options: IFieldValueOptions, bindings?: IComponentBindings, public result?: IQueryResult, fieldValueClassId: string = FieldValue.ID) {
    super(element, fieldValueClassId, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
&nbsp;
...
&nbsp;
    ...
    if (loadedValueFromComponent == null) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.element.parentElement != null) {
...
&nbsp;
      if (_.isArray(loadedValueFromComponent)) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (_.isString(loadedValueFromComponent)) {
...
&nbsp;
  private getHelperOptions() {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Utils.isNonEmptyString(inlineOptions)) {
<span class="cstat-no" title="statement not covered" >      return _.extend({}, this.options.helperOptions, eval('(' + inlineOptions + ')'));</span>
    }
...
&nbsp;
    if (atLeastOneFacetIsEnabled) {
      ...
      $$(element).on('click', <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        if (selected != null) {</span>
<span class="cstat-no" title="statement not covered" >          _.each(facets, <span class="fstat-no" title="function not covered" >(facet: Facet)</span> =&gt; <span class="cstat-no" title="statement not covered" >facet.deselectValue(value))</span>;</span>
        } else {
<span class="cstat-no" title="statement not covered" >          _.each(facets, <span class="fstat-no" title="function not covered" >(facet: Facet)</span> =&gt; <span class="cstat-no" title="statement not covered" >facet.selectValue(value))</span>;</span>
        }
<span class="cstat-no" title="statement not covered" >        this.queryController.deferExecuteQuery({</span>
          beforeExecuteQuery: <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.usageAnalytics.logSearchEvent&lt;IAnalyticsFieldValueMeta&gt;(analyticsActionCauseList.documentField, {</span>
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (selected) {
