...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/Excerpt/Excerpt.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/Excerpt/Excerpt.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/Excerpt/</a> &#187; Excerpt.ts</div>
</div>
<div class="body">
...
&nbsp;
  ...
  constructor(public element: HTMLElement, public options?: any, public bindings?: IComponentBindings, public result?: IQueryResult) {
    super(element, Excerpt.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
