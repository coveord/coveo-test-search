...
<div class="header medium">
    ...
    <h2>
        Statements: <span class="metric">55.56% <small>(20 / 36)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">25% <small>(2 / 8)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">50% <small>(2 / 4)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">48.28% <small>(14 / 29)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cstat-no" title="statement not covered" >      _.each(parents, <span class="fstat-no" title="function not covered" >(parent)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        var parentHTML = $(parent).clone().children().remove().end().get(0).outerHTML;</span>
<span class="cstat-no" title="statement not covered" >        Assert.check(parentHTML.indexOf(this.element.outerHTML) === -1, 'TemplateLoader cannot load a template into itself.')</span>
      })
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.element.innerHTML = this.options.template.instantiateToString(this.result, false);</span>
