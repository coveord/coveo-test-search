...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">90.48% <small>(76 / 84)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
   ...
   * @param bindings
   */
  constructor(public element: HTMLElement, <span class="missing-if-branch" title="if path not taken" >I</span>public options: IAuthenticationProviderOptions = {}, bindings?: IComponentBindings, public _window?: Window) {
