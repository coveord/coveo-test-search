...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/AuthenticationProvider/AuthenticationProvider.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/AuthenticationProvider/AuthenticationProvider.ts</span></h1>
    <h2>
        Statements: <span class="metric">90.36% <small>(75 / 83)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/AuthenticationProvider/</a> &#187; AuthenticationProvider.ts</div>
</div>
<div class="body">
...
&nbsp;
   ...
   */
  constructor(public element: HTMLElement, public <span class="missing-if-branch" title="if path not taken" >I</span>options: IAuthenticationProviderOptions = {}, bindings?: IComponentBindings, public _window?: Window) {
    super(element, AuthenticationProvider.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
&nbsp;
...
&nbsp;
    this.bind.onRootElement(SettingsEvents.settingsPopulateMenu, (args: ISettingsPopulateMenuArgs) =&gt; {
      args.menuData.push({
        ...
        onOpen: <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.authenticateWithProvider()</span>
      });
    });
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      modalbox.close();</span>
<span class="cstat-no" title="statement not covered" >      $$(iframe).detach();</span>
<span class="cstat-no" title="statement not covered" >      this.logger.info(`Got authentication for provider ${this.options.name}; retrying query.`);</span>
<span class="cstat-no" title="statement not covered" >      this.queryController.executeQuery();</span>
    };
  }
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  private handleNuke() {</span></span>
<span class="cstat-no" title="statement not covered" >    _.each(this.handlers, <span class="fstat-no" title="function not covered" >handler </span>=&gt; <span class="cstat-no" title="statement not covered" >$$(&lt;any&gt;this._window).off('message', handler))</span>;</span>
  }
&nbsp;
