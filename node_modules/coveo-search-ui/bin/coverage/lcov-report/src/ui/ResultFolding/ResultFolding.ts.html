...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">97.9% <small>(140 / 143)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">92.5% <small>(37 / 40)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">92% <small>(23 / 25)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">99.24% <small>(131 / 132)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
  ...
  constructor(public element: HTMLElement, public options?: IResultFoldingOptions, bindings?: IComponentBindings, public result?: IQueryResult) {
    super(element, ResultFolding.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
&nbsp;
...
&nbsp;
  private bindOverlayEvents() {
    this.bind.one(this.element.parentElement, 'openCardOverlay', () =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.result.moreResults) {
