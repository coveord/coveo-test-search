...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">87.5% <small>(35 / 40)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
  ...
  public getContextKeys(): string[] {
    return this.content ? _.keys(this.content) : <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
  }
&nbsp;
  /**
  ...
  public getContextValue(key: string): string {
    return this.content[key].replace(/\{\!([^\}]+)\}/g, <span class="fstat-no" title="function not covered" >(all: string, contextKey: string)</span> =&gt; {
